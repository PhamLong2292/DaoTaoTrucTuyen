...
namespace OneTSQ.Call.Bussiness.Ws
{
    public class DM_TenKhoaHocProcessBll : DM_TenKhoaHocTemplate
    {
        ...
        public override DM_TenKhoaHocCls[] Reading(RenderInfoCls ORenderInfo, DM_TenKhoaHocFilterCls OTenKhoaHocFilter)
        {
        ...
        public override long Count(RenderInfoCls ORenderInfo, DM_TenKhoaHocFilterCls OTenKhoaHocFilter)
        {
            ActionSqlParamCls ActionSqlParam = WebEnvironments.CreateActionSqlParam(ORenderInfo);
            return OneTSQBussinessUtility.CreateBussinessProcess().CreateDM_TenKhoaHocProcess().Count(ActionSqlParam, OTenKhoaHocFilter);
        }

        public override DM_TenKhoaHocCls[] ReadingWithPaging(RenderInfoCls ORenderInfo, DM_TenKhoaHocFilterCls OTenKhoaHocFilter)
        {
            ActionSqlParamCls ActionSqlParam = WebEnvironments.CreateActionSqlParam(ORenderInfo);
