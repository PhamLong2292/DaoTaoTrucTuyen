...
namespace OneTSQ.WebParts
{
    ...
    {        
        protected override FlexCelReport OnFlexcelBuild(RenderInfoCls ORenderInfo, string BaoCaoSuCoId)
        {
            ...
            flexCelReport.SetValue("MoTaNgan", string.IsNullOrEmpty(BaoCaoSuCo.MOTASUCO) ? null : BaoCaoSuCo.MOTASUCO.Replace("\n", "\r\n"));
            flexCelReport.SetValue("DeXuatGiaiPhap", string.IsNullOrEmpty(BaoCaoSuCo.DEXUATGIAIPHAP) ? null : BaoCaoSuCo.DEXUATGIAIPHAP.Replace("\n", "\r\n"));
            flexCelReport.SetValue("DieuTri", string.IsNullOrEmpty(BaoCaoSuCo.DIEUTRIXULYDUOCTHUCHIEN) ? null : BaoCaoSuCo.DIEUTRIXULYDUOCTHUCHIEN.Replace("\n", "\r\n"));
