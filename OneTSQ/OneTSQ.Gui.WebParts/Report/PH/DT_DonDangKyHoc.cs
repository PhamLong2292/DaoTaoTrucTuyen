...
namespace OneTSQ.WebParts
{
    ...
    public class DT_DonDangKyHoc : ObjectReport<DT_DangKy>
    {
        ...
        protected override FlexCelReport OnFlexcelBuild(RenderInfoCls ORenderInfo, string ketQuaDaoTaoId)
        {
            ...
            flexCelReport.SetValue("NgayCapCMND",  hocVien.CMTND_NGAYCAP!= null ? hocVien.CMTND_NGAYCAP.Value.ToString("dd/MM/yyyy"):"");
            flexCelReport.SetValue("NoiCapCMND", hocVien.CMTND_NOICAP!=null? hocVien.CMTND_NOICAP:"");
            ...
            flexCelReport.SetValue("DiaChiLienHe", hocVien.DIACHISONHA);
