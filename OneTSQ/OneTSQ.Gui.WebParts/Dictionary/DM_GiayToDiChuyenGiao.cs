...
{
    public class DM_GiayToDiChuyenGiao : WebPartTemplate
    {
        public override string WebPartId
        {
            get
            {
                return "DM_GiayToDiChuyenGiao";
            }
        }
        public override string WebPartTitle
        {
            get
            {
                return "Danh mục Giấy tờ đi chuyển giao";
            }
        }
        ...
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(DM_GiayToDiChuyenGiao), Page);
        }
        ...
        public override AjaxOut Draw(SiteParam OSiteParam, RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                XemPermission = user.IsSystemAdmin == 1 || PermissionUtility.CheckPermission(ORenderInfo, new DM_GiayToDiChuyenGiaoPermission().PermissionFunctionCode,
                    DM_GiayToDiChuyenGiaoCls.ePermission.Xem.ToString(), new DM_GiayToDiChuyenGiaoPermission().PermissionFunctionCode,
                    DM_GiayToDiChuyenGiaoPermission.StaticPermissionFunctionId, userId, null, false);
                if (!XemPermission)
                {
                ...
                string filtemplate = WebConfig.GetWebHttpRoot() + "/temp/ImportDM_GIAYTODICHUYENGIAO.xlsx";
                RetAjaxOut.HtmlContent =
                      WebEnvironments.ProcessHtml(
                        ...
                        "         <h5>" + WebLanguage.GetLanguage(OSiteParam, "Giấy tờ đi chuyển giao") + "</h5> \r\n" +
                        "     </div> \r\n" +
                        ...
                        "         <div id=\"divDM_GiayToDiChuyenGiaoContent\">" + ServerSideDrawSearchResult(ORenderInfo, "", null, 0).HtmlContent + "</div>\r\n" +
                        "     </div> \r\n" +
                      ...
                      WebEnvironments.ProcessJavascript(
                        ...
                        "       AjaxOut  = OneTSQ.WebParts.DM_GiayToDiChuyenGiao.ServerSidePrint(CreateRenderInfo()).value;\r\n" +
                        "       if(AjaxOut.Error)\r\n" +
                        "       {\r\n" +
                        ...
                        "       OneTSQ.WebParts.DM_GiayToDiChuyenGiao.ServerSideDrawSearchResult(CreateRenderInfo(), Keyword, HieuLuc, _currentPageIndex, CallBackReading);\r\n" +
                        "   }\r\n" +

                        "   function CallBackReading(res)\r\n" +
                        "   {\r\n" +
                        "       document.getElementById('divProcessing').innerHTML='';\r\n" +
                        "       document.getElementById('divDM_GiayToDiChuyenGiaoContent').innerHTML = res.value.HtmlContent;\r\n" +
                        "       $('.confirm').focus(); " +
                        "   }\r\n" +
                        ...
                        "   {\r\n" +
                        "       AjaxOut = OneTSQ.WebParts.DM_GiayToDiChuyenGiao.ServerSideDrawAddForm(CreateRenderInfo()).value;\r\n" +
                        "       if(AjaxOut.Error) { \r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "           return;\r\n" +
                        "       }\r\n" +
                        "       document.getElementById('ModalTitle').innerHTML = '<span class=\"fa fa-pencil-square-o\">" + WebLanguage.GetLanguage(OSiteParam, " Thêm mới Giấy tờ đi chuyển giao") + " </span>';\r\n" +
                        ...
                        "   {\r\n" +
                        "       AjaxOut = OneTSQ.WebParts.DM_GiayToDiChuyenGiao.ServerSideDrawUpdateForm(CreateRenderInfo(), Id).value;\r\n" +
                        "       if(AjaxOut.Error) { \r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "           return;\r\n" +
                        "       }\r\n" +
                        "       document.getElementById('ModalTitle').innerHTML = '<span class=\"fa fa-pencil-square-o\">" + WebLanguage.GetLanguage(OSiteParam, " Sửa thông tin Giấy tờ đi chuyển giao") + " </span>';\r\n" +
                        "       document.getElementById('divModalContent').innerHTML = AjaxOut.HtmlContent; \r\n" +
                        "       $('#divFormModal').modal('show');\r\n" +
                        "       document.getElementById('txtMa').focus();\r\n" +
                        "   }\r\n" +
                        ...
                        "       AjaxOut = OneTSQ.WebParts.DM_GiayToDiChuyenGiao.ServerSideAdd(CreateRenderInfo(), Ma, Ten, Stt, MoTa, HieuLuc).value;\r\n" +
                        "       if(AjaxOut.Error) {\r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "           return;\r\n" +
                        "       }\r\n" +
                        "       callSweetAlert(\"" + WebLanguage.GetLanguage(OSiteParam, "Thêm mới Giấy tờ đi chuyển giao thành công!") + "\");\r\n" +
                        ...
                        "       AjaxOut = OneTSQ.WebParts.DM_GiayToDiChuyenGiao.ServerSideUpdate(CreateRenderInfo(), Id, Ma, Ten, Stt, MoTa, HieuLuc).value;\r\n" +
                        "       if(AjaxOut.Error) {\r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "           return;\r\n" +
                        "       }\r\n" +
                        "       callSweetAlert(\"" + WebLanguage.GetLanguage(OSiteParam, "Sửa thông tin Giấy tờ đi chuyển giao thành công!") + "\");\r\n" +
                        "       NextPage(_currentPageIndex);\r\n" +
                        "       CloseModal();\r\n" +
                        "   }\r\n" +
                        ...
                        "           }, function () { \r\n" +
                        "           AjaxOut = OneTSQ.WebParts.DM_GiayToDiChuyenGiao.ServerSideDelete(RenderInfo, id).value;\r\n" +
                        "           if(AjaxOut.Error) { \r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "               return;\r\n" +
                        "           }\r\n" +
                        "       callSweetAlert(\"" + WebLanguage.GetLanguage(OSiteParam, "Xóa thông tin Giấy tờ đi chuyển giao thành công") + "!\");\r\n" +
                        "       NextPage(_currentPageIndex);\r\n" +
                        "       }); \r\n" +
                        "   }\r\n" +
                ...
                #region Import
                    ...
                    "               xhr.open(\"POST\", \"" + WebConfig.GetImportHandler(OSiteParam, SessionId, userId, LoginName, (int)ProcessImportHandlerUtility.eFileType.DM_GIAYTODICHUYENGIAO) + "\");\r\n" +
                    "               xhr.send(fd);\r\n" +
                    "           }\r\n" +
                    "       ); \r\n" +
                    "   }\r\n" +
 ...
 "</script>\r\n");
        ...
        public static AjaxOut ServerSideDrawSearchResult(RenderInfoCls ORenderInfo, string Keyword, string HieuLuc, int currentPageIndex)
        {
            ...
            try
            {
                ...
                DM_GiayToDiChuyenGiaoFilterCls OPositionFilter = new DM_GiayToDiChuyenGiaoFilterCls()
                {
                    Keyword = Keyword,
                ...
                DM_GiayToDiChuyenGiaoCls[] Positions = CallBussinessUtility.CreateBussinessProcess().CreateDM_GiayToDiChuyenGiaoProcess().ReadingWithPaging(ORenderInfo, OPositionFilter);
                var countPosition = CallBussinessUtility.CreateBussinessProcess().CreateDM_GiayToDiChuyenGiaoProcess().Count(ORenderInfo, OPositionFilter);
                ...
                else
                {
                    ...
                    for (int iIndex = 0; iIndex < Positions.Length; iIndex++)
                    {
                        Html.Append(
                            ...
                            "                     <td class=\"td-center\" style=\"text-align:center;\"><a title=\"" + "" + WebLanguage.GetLanguage(OSiteParam, "Sửa Giấy tờ đi chuyển giao") + "" + "\" href=\"javascript:ServerSideDrawUpdateForm('" + Positions[iIndex].Id + "');\"><i class=\"" + WebScreen.GetEditGridIcon() + "\"></i></a> &nbsp; <a title=\"" + "Xóa Giấy tờ đi chuyển giao" + "\" href=\"javascript:ServerSideDelete('" + Positions[iIndex].Id + "');\"><i class=\"" + WebScreen.GetDeleteGridIcon() + "\"></i></a></td> \r\n" +
                            //"                     <td class=\"td-center\"><a title=\"" + "Xóa Giấy tờ đi chuyển giao" + "\" href=\"javascript:ServerSideDelete('" + Positions[iIndex].Id + "');\"><i class=\"" + WebScreen.GetDeleteGridIcon() + "\"></i></a></td> \r\n" +
                            "                 </tr> \r\n");
                    }
                    Html.Append(
                        "                 </tbody> \r\n" +
        ...
        public static AjaxOut ServerSideDrawUpdateForm(RenderInfoCls ORenderInfo, string Id)
        {
            ...
            try
            {
                ...
                var OPosition = CallBussinessUtility.CreateBussinessProcess().CreateDM_GiayToDiChuyenGiaoProcess().CreateModel(ORenderInfo, Id);
                if (OPosition == null) throw new Exception(WebLanguage.GetLanguage(OSiteParam, "Giấy tờ đi chuyển giao đã bị xóa hoặc không tìm thấy"));
        ...
        public static AjaxOut ServerSideAdd(RenderInfoCls ORenderInfo, string Ma, string Ten, int Stt, string MoTa, string HieuLuc)
        {
            ...
            try
            {
                ...
                DM_GiayToDiChuyenGiaoCls OPosition = new DM_GiayToDiChuyenGiaoCls();
                ...
                CallBussinessUtility.CreateBussinessProcess().CreateDM_GiayToDiChuyenGiaoProcess().Add(ORenderInfo, OPosition);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
        ...
        public static AjaxOut ServerSideUpdate(RenderInfoCls ORenderInfo, string Id, string Ma, string Ten, int Stt, string MoTa, string HieuLuc)
        {
            ...
            try
            {
                ...
                var OPositionOld = CallBussinessUtility.CreateBussinessProcess().CreateDM_GiayToDiChuyenGiaoProcess().CreateModel(ORenderInfo, Id);
                if (OPositionOld == null) throw new Exception(WebLanguage.GetLanguage(OSiteParam, "Giấy tờ đi chuyển giao đã bị xóa hoặc không tìm thấy"));

                if (!OPositionOld.Ma.ToUpper().Equals(Ma.ToUpper()))
                    if (CallBussinessUtility.CreateBussinessProcess().CreateDM_GiayToDiChuyenGiaoProcess().CreateModel(ORenderInfo, Ma) != null) throw new Exception(WebLanguage.GetLanguage(OSiteParam, "Mã đã tồn tại không thể sửa được bản ghi!"));

                DM_GiayToDiChuyenGiaoCls OPositionNew = new DM_GiayToDiChuyenGiaoCls();
                OPositionNew.Ma = Ma;
                ...
                CallBussinessUtility.CreateBussinessProcess().CreateDM_GiayToDiChuyenGiaoProcess().Save(ORenderInfo, Id, OPositionNew);
        ...
        public static AjaxOut ServerSideDelete(RenderInfoCls ORenderInfo, string Id)
        {
            ...
            try
            {
                SiteParam OSiteParam = WebEnvironments.CreateSiteParam(ORenderInfo);
                WebSession.CheckSessionTimeOut(ORenderInfo);
                CallBussinessUtility.CreateBussinessProcess().CreateDM_GiayToDiChuyenGiaoProcess().Delete(ORenderInfo, Id);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
        ...
        public static string ConditionGhiChu(DM_GiayToDiChuyenGiaoCls OPosition, string Ma, string Ten, int Stt, int HieuLuc, ref int ConditionAdd)
        {
        ...
        public static AjaxOut ServerSidePrint(RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                List<DM_GiayToDiChuyenGiaoView> Datas = new List<DM_GiayToDiChuyenGiaoView>();

                SiteParam
                      OSiteParam = WebEnvironments.CreateSiteParam(ORenderInfo);
                WebSession.CheckSessionTimeOut(ORenderInfo);

                DM_GiayToDiChuyenGiaoFilterCls ODM_GiayToDiChuyenGiao = new DM_GiayToDiChuyenGiaoFilterCls() { HieuLuc = (int)eSearch.SearchAll };
                DM_GiayToDiChuyenGiaoCls[] DM_GiayToDiChuyenGiaos = CallBussinessUtility.CreateBussinessProcess().CreateDM_GiayToDiChuyenGiaoProcess().Reading(ORenderInfo, ODM_GiayToDiChuyenGiao);

                for (int i = 0; i < DM_GiayToDiChuyenGiaos.Length; i++)
                {
                    var view = new DM_GiayToDiChuyenGiaoView();
                    view.Ma = DM_GiayToDiChuyenGiaos[i].Ma;
                    view.Ten = DM_GiayToDiChuyenGiaos[i].Ten;
                    view.Stt = DM_GiayToDiChuyenGiaos[i].Stt;
                    view.MoTa = DM_GiayToDiChuyenGiaos[i].MoTa;
                    view.HieuLuc = DM_GiayToDiChuyenGiaos[i].HieuLuc.ToString();
                    view.NgayTao = DM_GiayToDiChuyenGiaos[i].NgayTao.ToString("dd/MM/yyyy");
                    view.TuNgay = DM_GiayToDiChuyenGiaos[i].TuNgay.Value.ToString("dd/MM/yyyy");
                    if (!string.IsNullOrEmpty(DM_GiayToDiChuyenGiaos[i].DenNgay.ToString()))
                    {
                        view.DenNgay = DM_GiayToDiChuyenGiaos[i].DenNgay.Value.ToString("dd/MM/yyyy");
                    }
                    view.GhiChu = DM_GiayToDiChuyenGiaos[i].GhiChu;

                    Datas.Add(view);
                }
                flexCelReport.AddTable("GiayToDiChuyenGiao", Datas);

                //flexCelReport.SetValue("NgayLap", DateTime.Now);

                string XmlFile = OSiteParam.PathRoot + "\\ReportTemplates\\DM_GiayToDiChuyenGiao.xlsx";

                string Id = "DM_GiayToDiChuyenGiao_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xlsx";
                string LoginName = WebSessionUtility.GetCurrentLoginUser(OSiteParam).LoginName;
                ...
                RetAjaxOut = new OneTSQ.ReportUtility.FlexcelReportUtility().ExportEx(ORenderInfo, LoginName, XmlFile, "DM_GiayToDiChuyenGiao", flexCelReport, SaveFile);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
        ...
        public sealed class DM_GiayToDiChuyenGiaoView
        {
