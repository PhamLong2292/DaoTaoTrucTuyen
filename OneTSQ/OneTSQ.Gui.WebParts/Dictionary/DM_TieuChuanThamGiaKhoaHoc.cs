...
{
    public class DM_TieuChuanThamGiaKhoaHoc : WebPartTemplate
    {
        public override string WebPartId
        {
            get
            {
                return "DM_TieuChuanThamGiaKhoaHoc";
            }
        }
        public override string WebPartTitle
        {
            get
            {
                return "Danh mục Tiêu chuẩn tham gia khóa học";
            }
        }
        ...
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(DM_TieuChuanThamGiaKhoaHoc), Page);
        }
        ...
        public override AjaxOut Draw(SiteParam OSiteParam, RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                XemPermission = user.IsSystemAdmin == 1 || PermissionUtility.CheckPermission(ORenderInfo, new DM_TieuChuanThamGiaKhoaHocPermission().PermissionFunctionCode,
                    DM_TieuChuanThamGiaKhoaHocCls.ePermission.Xem.ToString(), new DM_TieuChuanThamGiaKhoaHocPermission().PermissionFunctionCode,
                    DM_TieuChuanThamGiaKhoaHocPermission.StaticPermissionFunctionId, userId, null, false);
                if (!XemPermission)
                {
                ...
                string filtemplate = WebConfig.GetWebHttpRoot() + "/temp/ImportDM_TIEUCHUANTHAMGIAKHOAHOC.xlsx";
                RetAjaxOut.HtmlContent =
                      WebEnvironments.ProcessHtml(
                        ...
                        "         <h5>" + WebLanguage.GetLanguage(OSiteParam, "Tiêu chuẩn tham gia khóa học") + "</h5> \r\n" +
                        "     </div> \r\n" +
                        ...
                        "         <div id=\"divDM_TieuChuanThamGiaKhoaHocContent\">" + ServerSideDrawSearchResult(ORenderInfo, "", null, 0).HtmlContent + "</div>\r\n" +
                        "     </div> \r\n" +
                      ...
                      WebEnvironments.ProcessJavascript(
                        ...
                        "       AjaxOut  = OneTSQ.WebParts.DM_TieuChuanThamGiaKhoaHoc.ServerSidePrint(CreateRenderInfo()).value;\r\n" +
                        "       if(AjaxOut.Error)\r\n" +
                        "       {\r\n" +
                        ...
                        "       OneTSQ.WebParts.DM_TieuChuanThamGiaKhoaHoc.ServerSideDrawSearchResult(CreateRenderInfo(), Keyword, HieuLuc, _currentPageIndex, CallBackReading);\r\n" +
                        "   }\r\n" +

                        "   function CallBackReading(res)\r\n" +
                        "   {\r\n" +
                        "       document.getElementById('divProcessing').innerHTML='';\r\n" +
                        "       document.getElementById('divDM_TieuChuanThamGiaKhoaHocContent').innerHTML = res.value.HtmlContent;\r\n" +
                        "       $('.confirm').focus(); " +
                        "   }\r\n" +
                        ...
                        "   {\r\n" +
                        "       AjaxOut = OneTSQ.WebParts.DM_TieuChuanThamGiaKhoaHoc.ServerSideDrawAddForm(CreateRenderInfo()).value;\r\n" +
                        "       if(AjaxOut.Error) { \r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "           return;\r\n" +
                        "       }\r\n" +
                        "       document.getElementById('ModalTitle').innerHTML = '<span class=\"fa fa-pencil-square-o\">" + WebLanguage.GetLanguage(OSiteParam, " Thêm mới Tiêu chuẩn tham gia khóa học") + " </span>';\r\n" +
                        ...
                        "   {\r\n" +
                        "       AjaxOut = OneTSQ.WebParts.DM_TieuChuanThamGiaKhoaHoc.ServerSideDrawUpdateForm(CreateRenderInfo(), Id).value;\r\n" +
                        "       if(AjaxOut.Error) { \r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "           return;\r\n" +
                        "       }\r\n" +
                        "       document.getElementById('ModalTitle').innerHTML = '<span class=\"fa fa-pencil-square-o\">" + WebLanguage.GetLanguage(OSiteParam, " Sửa thông tin Tiêu chuẩn tham gia khóa học") + " </span>';\r\n" +
                        "       document.getElementById('divModalContent').innerHTML = AjaxOut.HtmlContent; \r\n" +
                        "       $('#divFormModal').modal('show');\r\n" +
                        "       document.getElementById('txtMa').focus();\r\n" +
                        "   }\r\n" +
                        ...
                        "       AjaxOut = OneTSQ.WebParts.DM_TieuChuanThamGiaKhoaHoc.ServerSideAdd(CreateRenderInfo(), Ma, Ten, Stt, MoTa, HieuLuc).value;\r\n" +
                        "       if(AjaxOut.Error) {\r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "           return;\r\n" +
                        "       }\r\n" +
                        "       callSweetAlert(\"" + WebLanguage.GetLanguage(OSiteParam, "Thêm mới Tiêu chuẩn tham gia khóa học thành công!") + "\");\r\n" +
                        ...
                        "       AjaxOut = OneTSQ.WebParts.DM_TieuChuanThamGiaKhoaHoc.ServerSideUpdate(CreateRenderInfo(), Id, Ma, Ten, Stt, MoTa, HieuLuc).value;\r\n" +
                        "       if(AjaxOut.Error) {\r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "           return;\r\n" +
                        "       }\r\n" +
                        "       callSweetAlert(\"" + WebLanguage.GetLanguage(OSiteParam, "Sửa thông tin Tiêu chuẩn tham gia khóa học thành công!") + "\");\r\n" +
                        "       NextPage(_currentPageIndex);\r\n" +
                        "       CloseModal();\r\n" +
                        "   }\r\n" +
                        ...
                        "           }, function () { \r\n" +
                        "           AjaxOut = OneTSQ.WebParts.DM_TieuChuanThamGiaKhoaHoc.ServerSideDelete(RenderInfo, id).value;\r\n" +
                        "           if(AjaxOut.Error) { \r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "               return;\r\n" +
                        "           }\r\n" +
                        "       callSweetAlert(\"" + WebLanguage.GetLanguage(OSiteParam, "Xóa thông tin Tiêu chuẩn tham gia khóa học thành công") + "!\");\r\n" +
                        "       NextPage(_currentPageIndex);\r\n" +
                        "       }); \r\n" +
                        "   }\r\n" +
                ...
                #region Import
                    ...
                    "               text: \"" + WebLanguage.GetLanguage(OSiteParam, "Bạn có chắc chắn import những danh mục này vào hệ thống không?") + "\", \r\n" +
                    "               type: \"warning\", \r\n" +
                    "               showCancelButton: true, \r\n" +
                    "               confirmButtonColor: \"#DD6B55\", \r\n" +
                    ...
                    "               xhr.open(\"POST\", \"" + WebConfig.GetImportHandler(OSiteParam, SessionId, userId, LoginName, (int)ProcessImportHandlerUtility.eFileType.DM_TIEUCHUANTHAMGIAKHOAHOC) + "\");\r\n" +
                    "               xhr.send(fd);\r\n" +
                    "           }\r\n" +
                    "       ); \r\n" +
                    "   }\r\n" +
 ...
 "</script>\r\n");
        ...
        public static AjaxOut ServerSideDrawSearchResult(RenderInfoCls ORenderInfo, string Keyword, string HieuLuc, int currentPageIndex)
        {
            ...
            try
            {
                ...
                DM_TieuChuanThamGiaKhoaHocFilterCls OPositionFilter = new DM_TieuChuanThamGiaKhoaHocFilterCls()
                {
                    Keyword = Keyword,
                ...
                DM_TieuChuanThamGiaKhoaHocCls[] Positions = CallBussinessUtility.CreateBussinessProcess().CreateDM_TieuChuanThamGiaKhoaHocProcess().ReadingWithPaging(ORenderInfo, OPositionFilter);
                var countPosition = CallBussinessUtility.CreateBussinessProcess().CreateDM_TieuChuanThamGiaKhoaHocProcess().Count(ORenderInfo, OPositionFilter);
                ...
                else
                {
                    ...
                    for (int iIndex = 0; iIndex < Positions.Length; iIndex++)
                    {
                        Html.Append(
                            ...
                            "                     <td class=\"td-center\" style=\"text-align:center;\"><a title=\"" + "" + WebLanguage.GetLanguage(OSiteParam, "Sửa") + "" + "\" href=\"javascript:ServerSideDrawUpdateForm('" + Positions[iIndex].Id + "');\"><i class=\"" + WebScreen.GetEditGridIcon() + "\"></i></a> &nbsp; <a title=\"" + "Xóa tiêu chuẩn tham gia khóa học" + "\" href=\"javascript:ServerSideDelete('" + Positions[iIndex].Id + "');\"><i class=\"" + WebScreen.GetDeleteGridIcon() + "\"></i></a></td> \r\n" +
                            //"                     <td class=\"td-center\"><a title=\"" + "Xóa Tiêu chuẩn tham gia khóa học" + "\" href=\"javascript:ServerSideDelete('" + Positions[iIndex].Id + "');\"><i class=\"" + WebScreen.GetDeleteGridIcon() + "\"></i></a></td> \r\n" +
                            "                 </tr> \r\n");
                    }
                    Html.Append(
                        "                 </tbody> \r\n" +
        ...
        public static AjaxOut ServerSideDrawUpdateForm(RenderInfoCls ORenderInfo, string Id)
        {
            ...
            try
            {
                ...
                var OPosition = CallBussinessUtility.CreateBussinessProcess().CreateDM_TieuChuanThamGiaKhoaHocProcess().CreateModel(ORenderInfo, Id);
                if (OPosition == null) throw new Exception(WebLanguage.GetLanguage(OSiteParam, "Tiêu chuẩn tham gia khóa học đã bị xóa hoặc không tìm thấy"));
        ...
        #region action
        [AjaxPro.AjaxMethod(AjaxPro.HttpSessionStateRequirement.ReadWrite)]
        public static AjaxOut ServerSideAdd(RenderInfoCls ORenderInfo, string Ma, string Ten, int Stt, string MoTa, string HieuLuc)
        {
            AjaxOut RetAjaxOut = new AjaxOut();
            try
            {
                ...
                DM_TieuChuanThamGiaKhoaHocCls OPosition = new DM_TieuChuanThamGiaKhoaHocCls();
                ...
                CallBussinessUtility.CreateBussinessProcess().CreateDM_TieuChuanThamGiaKhoaHocProcess().Add(ORenderInfo, OPosition);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
        ...
        [AjaxPro.AjaxMethod(AjaxPro.HttpSessionStateRequirement.ReadWrite)]
        public static AjaxOut ServerSideUpdate(RenderInfoCls ORenderInfo, string Id, string Ma, string Ten, int Stt, string MoTa, string HieuLuc)
        {
            AjaxOut RetAjaxOut = new AjaxOut();
            try
            {
                ...
                var OPositionOld = CallBussinessUtility.CreateBussinessProcess().CreateDM_TieuChuanThamGiaKhoaHocProcess().CreateModel(ORenderInfo, Id);
                if (OPositionOld == null) throw new Exception(WebLanguage.GetLanguage(OSiteParam, "Tiêu chuẩn tham gia khóa học đã bị xóa hoặc không tìm thấy"));

                if (!OPositionOld.Ma.ToUpper().Equals(Ma.ToUpper()))
                    if (CallBussinessUtility.CreateBussinessProcess().CreateDM_TieuChuanThamGiaKhoaHocProcess().CreateModel(ORenderInfo, Ma) != null) throw new Exception(WebLanguage.GetLanguage(OSiteParam, "Mã đã tồn tại không thể sửa được bản ghi!"));

                DM_TieuChuanThamGiaKhoaHocCls OPositionNew = new DM_TieuChuanThamGiaKhoaHocCls();
                OPositionNew.Ma = Ma;
                ...
                //// Biến để kiếm tra xem người dùng thay đổi thông tin : giá trị 0, 1
                //// Nếu người dùng thay đổi thông tin là mã hoặc tên thì tạo bản ghi mới và update bản ghi cũ có hiệu lực
                //// bằng 0 và đến ngày bằng ngày hiện tại
                //// Nếu người dùng thay đổi hiệu lực về không có hiệu lực thì update trực tiếp bản ghi đó
                //// Còn lại cũng update trực tiếp vào bản ghi đó
                //int ConditionAdd = (int)OneTSQ.Model.Common.eHieuLuc.Co;
                //// Hàm kiểm tra xem người dùng có thay đổi thông tin không nếu có thì lưu thông tin thay đổi vào ghi chú
                //var result = ConditionGhiChu(OPositionOld, Ma, Ten, Stt, OPositionNew.HieuLuc, ref ConditionAdd); // Hàm kiểm tra xem người dùng có thay đổi thông tin không
                //if (!string.IsNullOrEmpty(result) && ConditionAdd == (int)OneTSQ.Model.Common.eHieuLuc.Co)
                //{
                //    OPositionNew.Id = Guid.NewGuid().ToString();
                //    OPositionNew.NgayTao = DateTime.Now;
                //    OPositionNew.HieuLuc = (int)OneTSQ.Model.Common.eHieuLuc.Co;
                //    OPositionNew.TuNgay = DateTime.Now;
                //    OPositionNew.ChaId = Id.Trim();

                //    CallBussinessUtility.CreateBussinessProcess().CreateDM_TieuChuanThamGiaKhoaHocProcess().Add(ORenderInfo, OPositionNew);

                //    // Cập nhật dữ liệu bản ghi cũ 
                //    OPositionOld.GhiChu = result;
                //    OPositionOld.HieuLuc = (int)OneTSQ.Model.Common.eHieuLuc.Khong;
                //    OPositionOld.DenNgay = DateTime.Now;
                //    CallBussinessUtility.CreateBussinessProcess().CreateDM_TieuChuanThamGiaKhoaHocProcess().Save(ORenderInfo, Id, OPositionOld);
                //}
                //// Th sửa hết hiệu lực thì không tạo bản ghi mới mà update trực tiếp bản ghi đó
                //else if (ConditionAdd == (int)OneTSQ.Model.Common.eHieuLuc.Khong)
                //{
                //    OPositionNew.HieuLuc = (int)OneTSQ.Model.Common.eHieuLuc.Khong;
                //    OPositionNew.NgayTao = OPositionOld.NgayTao;
                //    OPositionNew.TuNgay = OPositionOld.TuNgay;
                //    OPositionNew.DenNgay = DateTime.Now;
                //    OPositionNew.GhiChu = OPositionOld.GhiChu;
                //    OPositionNew.ChaId = OPositionOld.ChaId;
                //    CallBussinessUtility.CreateBussinessProcess().CreateDM_TieuChuanThamGiaKhoaHocProcess().Save(ORenderInfo, Id, OPositionNew);
                //}
                //// Trường hợp chỉ sửa các thông tin không phải là mã và tên
                //else
                //{
                OPositionNew.NgayTao = OPositionOld.NgayTao;
                OPositionNew.TuNgay = OPositionOld.TuNgay;
        ...
        public static AjaxOut ServerSideDelete(RenderInfoCls ORenderInfo, string Id)
        {
            ...
            try
            {
                SiteParam OSiteParam = WebEnvironments.CreateSiteParam(ORenderInfo);
                WebSession.CheckSessionTimeOut(ORenderInfo);
                CallBussinessUtility.CreateBussinessProcess().CreateDM_TieuChuanThamGiaKhoaHocProcess().Delete(ORenderInfo, Id);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
        ...
        public static string ConditionGhiChu(DM_TieuChuanThamGiaKhoaHocCls OPosition, string Ma, string Ten, int Stt, int HieuLuc, ref int ConditionAdd)
        {
        ...
        public static AjaxOut ServerSidePrint(RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                List<DM_TieuChuanThamGiaKhoaHocView> Datas = new List<DM_TieuChuanThamGiaKhoaHocView>();

                SiteParam
                      OSiteParam = WebEnvironments.CreateSiteParam(ORenderInfo);
                WebSession.CheckSessionTimeOut(ORenderInfo);

                DM_TieuChuanThamGiaKhoaHocFilterCls ODM_TieuChuanThamGiaKhoaHoc = new DM_TieuChuanThamGiaKhoaHocFilterCls() { HieuLuc = (int)eSearch.SearchAll };
                DM_TieuChuanThamGiaKhoaHocCls[] DM_TieuChuanThamGiaKhoaHocs = CallBussinessUtility.CreateBussinessProcess().CreateDM_TieuChuanThamGiaKhoaHocProcess().Reading(ORenderInfo, ODM_TieuChuanThamGiaKhoaHoc);

                for (int i = 0; i < DM_TieuChuanThamGiaKhoaHocs.Length; i++)
                {
                    var view = new DM_TieuChuanThamGiaKhoaHocView();
                    view.Ma = DM_TieuChuanThamGiaKhoaHocs[i].Ma;
                    view.Ten = DM_TieuChuanThamGiaKhoaHocs[i].Ten;
                    view.Stt = DM_TieuChuanThamGiaKhoaHocs[i].Stt;
                    view.MoTa = DM_TieuChuanThamGiaKhoaHocs[i].MoTa;
                    view.HieuLuc = DM_TieuChuanThamGiaKhoaHocs[i].HieuLuc.ToString();
                    view.NgayTao = DM_TieuChuanThamGiaKhoaHocs[i].NgayTao.ToString("dd/MM/yyyy");
                    view.TuNgay = DM_TieuChuanThamGiaKhoaHocs[i].TuNgay.Value.ToString("dd/MM/yyyy");
                    if (!string.IsNullOrEmpty(DM_TieuChuanThamGiaKhoaHocs[i].DenNgay.ToString()))
                    {
                        view.DenNgay = DM_TieuChuanThamGiaKhoaHocs[i].DenNgay.Value.ToString("dd/MM/yyyy");
                    }
                    view.GhiChu = DM_TieuChuanThamGiaKhoaHocs[i].GhiChu;

                    Datas.Add(view);
                }
                flexCelReport.AddTable("TieuChuanThamGiaKhoaHoc", Datas);

                //flexCelReport.SetValue("NgayLap", DateTime.Now);

                string XmlFile = OSiteParam.PathRoot + "\\ReportTemplates\\DM_TieuChuanThamGiaKhoaHoc.xlsx";

                string Id = "DM_TieuChuanThamGiaKhoaHoc_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xlsx";
                string LoginName = WebSessionUtility.GetCurrentLoginUser(OSiteParam).LoginName;
                ...
                RetAjaxOut = new OneTSQ.ReportUtility.FlexcelReportUtility().ExportEx(ORenderInfo, LoginName, XmlFile, "DM_TieuChuanThamGiaKhoaHoc", flexCelReport, SaveFile);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
        ...
        public sealed class DM_TieuChuanThamGiaKhoaHocView
        {
