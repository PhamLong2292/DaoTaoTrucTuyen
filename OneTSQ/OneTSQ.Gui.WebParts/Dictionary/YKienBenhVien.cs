...
{
    public class YKienBenhVien : WebPartTemplate
    {
        public override string WebPartId
        {
            get
            {
                return "YKienBenhVien";
            }
        }
        public override string WebPartTitle
        {
            get
            {
                return "Biểu mẫu ý kiến bệnh viện";
            }
        }
        ...
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(YKienBenhVien), Page);
        }
        ...
        public override AjaxOut Draw(SiteParam OSiteParam, RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                //XemPermission = PermissionUtility.CheckPermission(ORenderInfo, new YKienBenhVienPermission().PermissionFunctionCode,
                //    DM_YKienBenhVienCls.ePermission.Xem.ToString(), new YKienBenhVienPermission().PermissionFunctionCode,
                //    YKienBenhVienPermission.StaticPermissionFunctionId, userId, null, false);
                //if (!XemPermission)
                //{
                ...
                string filtemplate = WebConfig.GetWebHttpRoot() + "/temp/ImportDM_YKienBenhVien.xlsx";
                RetAjaxOut.HtmlContent =
                      WebEnvironments.ProcessHtml(
                        ...
                        "         <h5>" + WebLanguage.GetLanguage(OSiteParam, "Biểu mẫu ý kiến bệnh viện") + "</h5> \r\n" +
                        "     </div> \r\n" +
                        ...
                        "         <div id=\"divYKienBenhVienContent\">" + ServerSideDrawSearchResult(ORenderInfo, "", null, 0).HtmlContent + "</div>\r\n" +
                        "     </div> \r\n" +
                      ...
                      WebEnvironments.ProcessJavascript(
                        ...
                        "       AjaxOut  = OneTSQ.WebParts.YKienBenhVien.ServerSidePrint(RenderInfo).value;\r\n" +
                        "       if(AjaxOut.Error)\r\n" +
                        "       {\r\n" +
                        ...
                        "       OneTSQ.WebParts.YKienBenhVien.ServerSideDrawSearchResult(CreateRenderInfo(), Keyword, HieuLuc, _currentPageIndex, CallBackReading);\r\n" +
                        "   }\r\n" +

                        "   function CallBackReading(res)\r\n" +
                        "   {\r\n" +
                        "       document.getElementById('divProcessing').innerHTML='';\r\n" +
                        "       document.getElementById('divYKienBenhVienContent').innerHTML = res.value.HtmlContent;\r\n" +
                        "       $('.confirm').focus(); " +
                        "   }\r\n" +
                        ...
                        "   {\r\n" +
                        "       AjaxOut = OneTSQ.WebParts.YKienBenhVien.ServerSideDrawAddForm(CreateRenderInfo()).value;\r\n" +
                        "       if(AjaxOut.Error) { \r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "           return;\r\n" +
                        "       }\r\n" +
                        "       document.getElementById('ModalTitle').innerHTML = '<span class=\"fa fa-pencil-square-o\">" + WebLanguage.GetLanguage(OSiteParam, " Thêm mới Ý kiến bệnh viện") + " </span>';\r\n" +
                        ...
                        "   {\r\n" +
                        "       AjaxOut = OneTSQ.WebParts.YKienBenhVien.ServerSideDrawUpdateForm(CreateRenderInfo(), Id).value;\r\n" +
                        "       if(AjaxOut.Error) { \r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "           return;\r\n" +
                        "       }\r\n" +
                        "       document.getElementById('ModalTitle').innerHTML = '<span class=\"fa fa-pencil-square-o\">" + WebLanguage.GetLanguage(OSiteParam, " Sửa thông tin Ý kiến bệnh viện") + " </span>';\r\n" +
                        "       document.getElementById('divModalContent').innerHTML = AjaxOut.HtmlContent; \r\n" +
                        "       $('#divFormModal').modal('show');\r\n" +
                        "       document.getElementById('txtMa').focus();\r\n" +
                        "   }\r\n" +
                        ...
                        "       AjaxOut = OneTSQ.WebParts.YKienBenhVien.ServerSideAdd(CreateRenderInfo(), Ma, Ten, NoiDung, Stt, MoTa, HieuLuc).value;\r\n" +
                        "       if(AjaxOut.Error) {\r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "           return;\r\n" +
                        "       }\r\n" +
                        "       callSweetAlert(\"" + WebLanguage.GetLanguage(OSiteParam, "Thêm mới Ý kiến bệnh viện thành công!") + "\");\r\n" +
                        ...
                        "       AjaxOut = OneTSQ.WebParts.YKienBenhVien.ServerSideUpdate(CreateRenderInfo(), Id, Ma, Ten, NoiDung, Stt, MoTa, HieuLuc).value;\r\n" +
                        "       if(AjaxOut.Error) {\r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "           return;\r\n" +
                        "       }\r\n" +
                        "       callSweetAlert(\"" + WebLanguage.GetLanguage(OSiteParam, "Sửa thông tin Ý kiến bệnh viện thành công!") + "\");\r\n" +
                        "       NextPage(_currentPageIndex);\r\n" +
                        "       CloseModal();\r\n" +
                        "   }\r\n" +
                        ...
                        "           }, function () { \r\n" +
                        "           AjaxOut = OneTSQ.WebParts.YKienBenhVien.ServerSideDelete(RenderInfo, id).value;\r\n" +
                        "           if(AjaxOut.Error) { \r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "               return;\r\n" +
                        "           }\r\n" +
                        "       callSweetAlert(\"" + WebLanguage.GetLanguage(OSiteParam, "Xóa thông tin Ý kiến bệnh viện thành công") + "!\");\r\n" +
                        "       NextPage(_currentPageIndex);\r\n" +
                        "       }); \r\n" +
                        "   }\r\n" +
                ...
                #region Import
                        ...
                        "               xhr.open(\"POST\", \"" + WebConfig.GetImportHandler(OSiteParam, SessionId, userId, LoginName, (int)ProcessImportHandlerUtility.eFileType.DM_YKIENBENHVIEN) + "\");\r\n" +
                        "               xhr.send(fd);\r\n" +
                        "           }\r\n" +
                        "       ); \r\n" +
                        "   }\r\n" +
        ...
        public static AjaxOut ServerSideDrawSearchResult(RenderInfoCls ORenderInfo, string Keyword, string HieuLuc, int currentPageIndex)
        {
            ...
            try
            {
                ...
                DM_YKienBenhVienFilterCls OPositionFilter = new DM_YKienBenhVienFilterCls()
                {
                    Keyword = Keyword,
                ...
                DM_YKienBenhVienCls[] Positions = CallBussinessUtility.CreateBussinessProcess().CreateYKienBenhVienProcess().ReadingWithPaging(ORenderInfo, OPositionFilter);
                var countPosition = CallBussinessUtility.CreateBussinessProcess().CreateYKienBenhVienProcess().Count(ORenderInfo, OPositionFilter);
                ...
                else
                {
                    ...
                    for (int iIndex = 0; iIndex < Positions.Length; iIndex++)
                    {
                        Html.Append(
                            ...
                            "                     <td title=\"" + Positions[iIndex].NoiDung + "\">" + Positions[iIndex].NoiDung + "</td> \r\n" +
                            ...
                            "                     <td class=\"td-center\" style=\"text-align:center;\"><a title=\"" + "" + WebLanguage.GetLanguage(OSiteParam, "Sửa Ý kiến bệnh viện") + "" + "\" href=\"javascript:ServerSideDrawUpdateForm('" + Positions[iIndex].Id + "');\"><i class=\"" + WebScreen.GetEditGridIcon() + "\"></i></a> &nbsp; <a title=\"" + "Xóa Ý kiến bệnh viện" + "\" href=\"javascript:ServerSideDelete('" + Positions[iIndex].Id + "');\"><i class=\"" + WebScreen.GetDeleteGridIcon() + "\"></i></a></td> \r\n" +
                            //"                     <td class=\"td-center\"><a title=\"" + "Xóa Ý kiến bệnh viện" + "\" href=\"javascript:ServerSideDelete('" + Positions[iIndex].Id + "');\"><i class=\"" + WebScreen.GetDeleteGridIcon() + "\"></i></a></td> \r\n" +
                            "                 </tr> \r\n");
                    }
                    Html.Append(
                        "                 </tbody> \r\n" +
        ...
        public static AjaxOut ServerSideDrawAddForm(RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                string Html =
                        ...
                        "                   <label for=\"inputTo\">" + WebLanguage.GetLanguage(OSiteParam, "Mã Ý kiến bệnh viện") + " <span style='color:red'>*</span></label>\r\n" +
                        ...
                        "           <div class=\"col-xs-12 col-sm-12 col-md-12\">\r\n" +
                        "               <div class=\"form-group\">\r\n" +
                        "                   <label for=\"inputSubject\">" + WebLanguage.GetLanguage(OSiteParam, "Tên Ý kiến bệnh viện") + " <span style='color:red'>*</span></label>\r\n" +
                        ...
                        "           <div class=\"col-xs-12 col-sm-12 col-md-12\">\r\n" +
                        "               <div class=\"form-group\">\r\n" +
                        "                   <label for=\"inputSubject\">" + WebLanguage.GetLanguage(OSiteParam, "Nội dung Ý kiến bệnh viện") + " <span style='color:red'>*</span></label>\r\n" +
                        "                   <textarea class=\"form-control\" id=\"txtNoiDung\" rows=\"10\" required placeholder=\"" + WebLanguage.GetLanguage(OSiteParam, "Nội dung Ý kiến bệnh viện") + "\"></textarea>\r\n" +
                        "               </div>\r\n" +
                        "           </div>\r\n" +
        ...
        public static AjaxOut ServerSideDrawUpdateForm(RenderInfoCls ORenderInfo, string Id)
        {
            ...
            try
            {
                ...
                var OPosition = CallBussinessUtility.CreateBussinessProcess().CreateYKienBenhVienProcess().CreateModel(ORenderInfo, Id);
                if (OPosition == null) throw new Exception(WebLanguage.GetLanguage(OSiteParam, "Ý kiến bệnh viện đã bị xóa hoặc không tìm thấy"));
                ...
                string Html =
                     "<form id=\"sendmail\" data-async  method=\"post\" onSubmit=\"return false;\" role=\"form\" class=\"contactForm\">\r\n" +
                        ...
                        "                   <div class=\"form-group\">\r\n" +
                        "                   <label for=\"inputSubject\">" + WebLanguage.GetLanguage(OSiteParam, "Nội dung Ý kiến bệnh viện") + " <span style='color:red'>*</span></label>\r\n" +
                        "                   <textarea class=\"form-control\" id=\"txtNoiDung\" rows=\"10\" required placeholder=\"" + WebLanguage.GetLanguage(OSiteParam, "Nội dung Ý kiến bệnh viện") + "\">" + OPosition.NoiDung + "</textarea>\r\n" +
                        "                   </div>\r\n" +
                        "               </div>\r\n" +
        ...
        #region action
        [AjaxPro.AjaxMethod(AjaxPro.HttpSessionStateRequirement.ReadWrite)]
        public static AjaxOut ServerSideAdd(RenderInfoCls ORenderInfo, string Ma, string Ten, string NoiDung, int Stt, string MoTa, string HieuLuc)
        {
            AjaxOut RetAjaxOut = new AjaxOut();
            try
            {
                ...
                DM_YKienBenhVienCls OPosition = new DM_YKienBenhVienCls();
                OPosition.Id = Guid.NewGuid().ToString();
                OPosition.Ma = Ma;
                OPosition.Ten = Ten;
                OPosition.NoiDung = NoiDung;
                OPosition.MoTa = MoTa;
                ...
                CallBussinessUtility.CreateBussinessProcess().CreateYKienBenhVienProcess().Add(ORenderInfo, OPosition);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
        ...
        [AjaxPro.AjaxMethod(AjaxPro.HttpSessionStateRequirement.ReadWrite)]
        public static AjaxOut ServerSideUpdate(RenderInfoCls ORenderInfo, string Id, string Ma, string Ten, string NoiDung, int Stt, string MoTa, string HieuLuc)
        {
            AjaxOut RetAjaxOut = new AjaxOut();
            try
            {
                ...
                var OPositionOld = CallBussinessUtility.CreateBussinessProcess().CreateYKienBenhVienProcess().CreateModel(ORenderInfo, Id);
                if (OPositionOld == null) throw new Exception(WebLanguage.GetLanguage(OSiteParam, "Ý kiến bệnh viện đã bị xóa hoặc không tìm thấy"));

                if (!OPositionOld.Ma.ToUpper().Equals(Ma.ToUpper()))
                    if (CallBussinessUtility.CreateBussinessProcess().CreateYKienBenhVienProcess().CreateModel(ORenderInfo, Ma) != null) throw new Exception(WebLanguage.GetLanguage(OSiteParam, "Mã đã tồn tại không thể sửa được bản ghi!"));

                DM_YKienBenhVienCls OPositionNew = new DM_YKienBenhVienCls();
                OPositionNew.Ma = Ma;
                OPositionNew.Ten = Ten;
                OPositionNew.NoiDung = NoiDung;
                ...
                CallBussinessUtility.CreateBussinessProcess().CreateYKienBenhVienProcess().Save(ORenderInfo, Id, OPositionNew);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
        ...
        public static AjaxOut ServerSideDelete(RenderInfoCls ORenderInfo, string Id)
        {
            ...
            try
            {
                SiteParam OSiteParam = WebEnvironments.CreateSiteParam(ORenderInfo);
                WebSession.CheckSessionTimeOut(ORenderInfo);
                CallBussinessUtility.CreateBussinessProcess().CreateYKienBenhVienProcess().Delete(ORenderInfo, Id);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
        ...
        public static string ConditionGhiChu(DM_YKienBenhVienCls OPosition, string Ma, string Ten, int Stt, int HieuLuc, ref int ConditionAdd)
        {
        ...
        public static AjaxOut ServerSidePrint(RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                List<YKienBenhVienView> Datas = new List<YKienBenhVienView>();

                SiteParam
                      OSiteParam = WebEnvironments.CreateSiteParam(ORenderInfo);
                WebSession.CheckSessionTimeOut(ORenderInfo);

                DM_YKienBenhVienFilterCls OYKienBenhVien = new DM_YKienBenhVienFilterCls();
                DM_YKienBenhVienCls[] YKienBenhViens = CallBussinessUtility.CreateBussinessProcess().CreateYKienBenhVienProcess().Reading(ORenderInfo, OYKienBenhVien);

                for (int i = 0; i < YKienBenhViens.Length; i++)
                {

                    var view = new YKienBenhVienView();
                    view.Ma = YKienBenhViens[i].Ma;
                    view.Ten = YKienBenhViens[i].Ten;
                    view.NoiDung = YKienBenhViens[i].NoiDung;
                    view.Stt = YKienBenhViens[i].Stt;
                    view.MoTa = YKienBenhViens[i].MoTa;
                    view.HieuLuc = YKienBenhViens[i].HieuLuc.ToString();
                    view.NgayTao = YKienBenhViens[i].NgayTao.ToString("dd/MM/yyyy");
                    view.TuNgay = YKienBenhViens[i].TuNgay.Value.ToString("dd/MM/yyyy");
                    if (!string.IsNullOrEmpty(YKienBenhViens[i].DenNgay.ToString()))
                    {
                        view.DenNgay = YKienBenhViens[i].DenNgay.Value.ToString("dd/MM/yyyy");
                    }
                    view.GhiChu = YKienBenhViens[i].GhiChu;

                    Datas.Add(view);
                }
                flexCelReport.AddTable("YKienBenhVien", Datas);

                //flexCelReport.SetValue("NgayLap", DateTime.Now);

                string XmlFile = OSiteParam.PathRoot + "\\ReportTemplates\\YKienBenhVien.xlsx";

                string Id = "DM_YKienBenhVien_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xlsx";
                string LoginName = WebSessionUtility.GetCurrentLoginUser(OSiteParam).LoginName;
                ...
                RetAjaxOut = new OneTSQ.ReportUtility.FlexcelReportUtility().ExportEx(ORenderInfo, LoginName, XmlFile, "DM_YKienBenhVien", flexCelReport, SaveFile);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
        ...
        public sealed class YKienBenhVienView
        {
