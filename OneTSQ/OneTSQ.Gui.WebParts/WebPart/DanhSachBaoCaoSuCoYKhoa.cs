...
{   
    public class DanhSachBaoCaoSuCoYKhoa : WebPartTemplate
    {
        ...
        public override AjaxOut Draw(SiteParam OSiteParam, RenderInfoCls ORenderInfo)
        {
            ...
            if (trangThai < 0)
                trangThai = null;
            int? doituongsuco = string.IsNullOrEmpty(WebEnvironments.Request("DoiTuongSuCo")) ? null : (int?)int.Parse(WebEnvironments.Request("DoiTuongSuCo"));
            try
            {
                ...
                RetAjaxOut.HtmlContent =
                    ...
                    "       });\r\n" +
                    "       $('#cbbDoiTuong').select2({\r\n" +
                    "          placeholder: 'Đối tượng xảy ra sự cố',\r\n" +
                    "          allowClear: true\r\n" +
                    "       });\r\n" +
                    "   });\r\n" +
                    ...
                    "       DoiTuong = parseInt(document.getElementById('cbbDoiTuong').value);\r\n" +
                    "       trangThai = parseInt(document.getElementById('cbbTrangThai').value);\r\n" +
                    "       AjaxOut = OneTSQ.WebParts.DanhSachBaoCaoSuCoYKhoa.DrawSearchResult(RenderInfo, CurrentPageIndex, keyword, HinhThuc, DoiTuong, trangThai).value;\r\n" +
                ...
                #region html
                    ...
                    "           <div id=\"divbaocaosucoykhoa\">" + DanhSachBaoCaoSuCoYKhoa.DrawSearchResult(ORenderInfo, pageIndex, keyword, HinhThuc_ID, doituongsuco, trangThai).HtmlContent + "</div>\r\n" +
                    "     </div> \r\n" +
                    " </div>\r\n" +
                    "</div>\r\n"
                        );
        ...
        public static AjaxOut DrawSearchResult(RenderInfoCls ORenderInfo, int PageIndex, string keyword, string HinhThuc_ID, int? DoiTuongSuCo, int? trangThai)
        {
            AjaxOut RetAjaxOut = new AjaxOut();
            try
            {
                ...
                for (int iIndex = 0; iIndex < dangKyTotal; iIndex++)
                {
                    ...
                    if (Users != null)
                    {
                        ...
                        "                     <td style='text-align: center; vertical-align: middle;'><a href='" + BaoCaoSuCoUrl + "' title='" + WebLanguage.GetLanguage(OSiteParam, "Mở phiếu") + "'>" + (baocaosucoykhoa[iIndex].DOITUONGSUCO == 0 || baocaosucoykhoa[iIndex].DOITUONGSUCO == null ? null : PhieuBaoCaoSuCoYKhoaParser.DoiTuongs[baocaosucoykhoa[iIndex].DOITUONGSUCO.Value]) + "</a></td> \r\n" +
                        "                     <td style='vertical-align: middle;'><a href='" + BaoCaoSuCoUrl + "' title='" + WebLanguage.GetLanguage(OSiteParam, "Mở phiếu") + "'>" + baocaosucoykhoa[iIndex].MABN+ "</a></td> \r\n" +
                                                "                     <td style='vertical-align: middle;'><a href='" + BaoCaoSuCoUrl + "' title='" + WebLanguage.GetLanguage(OSiteParam, "Mở phiếu") + "'>" + baocaosucoykhoa[iIndex].HOTEN + "</a></td> \r\n" +
                        ...
                        "                     <td style='text-align: center; vertical-align: middle;'><a href='" + BaoCaoSuCoUrl + "' title='" + WebLanguage.GetLanguage(OSiteParam, "Mở phiếu") + "'>" + (baocaosucoykhoa[iIndex].THOIGIANXAYRA == null ? null : baocaosucoykhoa[iIndex].THOIGIANXAYRA.Value.ToString("HH:mm dd/MM/yyyy")) + "</a></td> \r\n" +
        ...
        public override string divFilter
        {
            get
            {
                return "<div class=\"col-md-3\" style=\"padding-top: 6px; padding-bottom: 6px;\">\r\n" +
                       "    <input id=\"txtKeyword\" placeholder=\"Tìm kiếm theo mã số phiếu, mã bệnh nhân, họ tên \" onkeypress=\"timkiem(event);\" class=\"form-control valueForm\" style=\"border-radius: 4px;\">\r\n" +
                       "</div>\r\n" +
                       "<div class=\"col-md-2\" style=\"padding-top: 6px; padding-bottom: 6px;\">\r\n" +
                       "    <select id=\"cbbHinhThuc\" class=\"form-control valueForm\">\r\n" +
                       "        <option></option>\r\n" +
                       "        <option value=\"" + (int)PhieuBaoCaoSuCoYKhoaCls.eHinhThuc.TuNguyen + "\">Tự nguyện</option>\r\n" +
                       "        <option value=\"" + (int)PhieuBaoCaoSuCoYKhoaCls.eHinhThuc.BatBuoc + "\">Bắt buộc</option>\r\n" +
                       "    </select>\r\n" +
                       "</div>\r\n" +
                       "<div class=\"col-md-2\" style=\"padding-top: 6px; padding-bottom: 6px;\">\r\n" +
                       "    <select id=\"cbbDoiTuong\" class=\"form-control valueForm\">\r\n" +
                       "        <option></option>\r\n" +
                       "        <option value=\"" + (int)PhieuBaoCaoSuCoYKhoaCls.eDoiTuong.NguoiBenh + "\">Người bệnh</option>\r\n" +
                       "        <option value=\"" + (int)PhieuBaoCaoSuCoYKhoaCls.eDoiTuong.NguoiNha + "\">Người nhà/người đến thăm</option>\r\n" +
                       "        <option value=\"" + (int)PhieuBaoCaoSuCoYKhoaCls.eDoiTuong.NhanVienYTe + "\">Nhân viên y tế</option>\r\n" +
                       "        <option value=\"" + (int)PhieuBaoCaoSuCoYKhoaCls.eDoiTuong.TrangThietBi + "\">Trang thiết bị/cơ sở hạ tầng</option>\r\n" +
                       "    </select>\r\n" +
                       "</div>\r\n" +
