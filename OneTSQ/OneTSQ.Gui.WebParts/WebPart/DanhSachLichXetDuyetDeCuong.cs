...
{   
    public class DanhSachLichXetDuyetDeCuong : WebPartTemplate
    {
        public override string WebPartId { get { return StaticWebPartId; } }
        public static string StaticWebPartId = "DanhSachLichXetDuyetDeCuong";
        public override string WebPartTitle
        {
            get
            {
                return "Danh sách lịch xét duyệt dề cương";
            }
        }
        ...
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(DanhSachLichXetDuyetDeCuong), Page);
        }
        ...
        public override AjaxOut Draw(SiteParam OSiteParam, RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                RetAjaxOut.HtmlContent =
                    ...
                    "       document.title = '" + WebLanguage.GetLanguage(OSiteParam, "OneTSQ: Danh sách lịch xét duyệt dề cương") + "';\r\n" +                  
                    ...
                    "       AjaxOut = OneTSQ.WebParts.DanhSachLichXetDuyetDeCuong.DrawSearchResult(RenderInfo, CurrentPageIndex, keyword, LoaiHinh, CapDeTai, trangThai).value;\r\n" +
                    ...
                    "       trangThai = parseInt(document.getElementById('cbbTrangThai').value);\r\n" +
                    "       AjaxOut  = OneTSQ.WebParts.DanhSachLichXetDuyetDeCuong.Print(RenderInfo, keyword, LoaiHinh, CapDeTai, trangThai).value;\r\n" +
                    "       if(AjaxOut.Error)\r\n" +
                    "       {\r\n" +
                ...
                #region html
                    ...
                    "         <h5>" + WebLanguage.GetLanguage(OSiteParam, "Danh sách lịch xét duyệt dề cương") + " </h5> \r\n" +
                    "     </div> \r\n" +
                    "     <div class=\"ibox-content\"> \r\n" +
                    "           <div id=\"divLichXetDuyet\">" + DanhSachLichXetDuyetDeCuong.DrawSearchResult(ORenderInfo, pageIndex, keyword, LoaiHinh, CapDeTai, trangThai).HtmlContent + "</div>\r\n" +
                    "     </div> \r\n" +
                    " </div>\r\n" +
                    "</div>\r\n"
                        );
        ...
        public static AjaxOut DrawSearchResult(RenderInfoCls ORenderInfo, int PageIndex, string keyword, int? LoaiHinh, int? CapDeTai, int? trangThai)
        {
            ...
            try
            {
                ...
                long recordTotal = 0;
                LichXetDuyetCls[] LichXetDuyet = CallBussinessUtility.CreateBussinessProcess().CreateLichXetDuyetProcess().PageReadingDC(ORenderInfo, filter, ref recordTotal);
                ...
                {
                    var LichXetDuyetUrl = WebScreen.BuildUrl(OSiteParam, WebSessionUtility.GetCurrentLoginUser(OSiteParam).OwnerCode, "LichXetDuyetDeCuong",
                    ...
                    Html +=
                        ...
                        "                     <td style='text-align: center; vertical-align: middle;'><a href='" + LichXetDuyetUrl + "' title='" + WebLanguage.GetLanguage(OSiteParam, "Mở phiếu") + "'>" + (LichXetDuyet[iIndex].THOIGIAN == null ? null : LichXetDuyet[iIndex].THOIGIAN.Value.ToString("HH:mm dd/MM/yyyy")) + "</a></td> \r\n" +
                        ...
                        "                     <td style='text-align: center; vertical-align: middle;'><a href='" + LichXetDuyetUrl + "' title='" + WebLanguage.GetLanguage(OSiteParam, "Mở phiếu") + "'>" + (LichXetDuyet[iIndex].THOIGIANBATDAU == null ? null : LichXetDuyet[iIndex].THOIGIANBATDAU.Value.ToString("HH:mm dd/MM/yyyy")) + "</a></td> \r\n" +
                        "                     <td style='text-align: center; vertical-align: middle;'><a href='" + LichXetDuyetUrl + "' title='" + WebLanguage.GetLanguage(OSiteParam, "Mở phiếu") + "'>" + (LichXetDuyet[iIndex].THOIGIANKETTHUC == null ? null : LichXetDuyet[iIndex].THOIGIANKETTHUC.Value.ToString("HH:mm dd/MM/yyyy")) + "</a></td> \r\n" +
        ...
        public override string divFilter
        {
            get
            {
                return "<div class=\"col-md-3\" style=\"padding-top: 6px; padding-bottom: 6px;\">\r\n" +
                       "    <input id=\"txtKeyword\" placeholder=\"Tìm kiếm theo địa điểm lập lịch \" class=\"form-control valueForm\" style=\"border-radius: 4px;\">\r\n" +
                       "</div>\r\n" +
