    ...
    public class XetDuyetDeCuong : ObjectWebPartTemplate
    {
        ...
        public override AjaxOut Draw(SiteParam OSiteParam, RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                //DeCuongCls deCuong = string.IsNullOrEmpty(XetDuyetDeCuongId) ? new DeCuongCls() : CallBussinessUtility.CreateBussinessProcess().CreateDeCuongProcess().CreateModel(ORenderInfo, XetDuyetDeCuongId);            
                #region Html
                string html =
                    ...
                    "               <div class=\"ibox-content\" style=\"border: 0; \" id='divDrawDanhSachDeCuong'> \r\n" +                   
                                            DrawDanhSachDeCuong(ORenderInfo, pageIndex, keyword, LichXetDuyetId).HtmlContent +               
                    "               </div>\r\n" +
                    "           </div>\r\n" +
                    "       </div>\r\n" +
                    "       <div class='col-lg-9'>\r\n" +
                ...
                string js =
                    ...
                    "   var XetDuyetDeCuongId='"+ XetDuyetDeCuongId + "';\r\n" +
                ...
                #region Check Trạng Thái
                    ...
                    "       {\r\n" +
                    "           $(\"#divDrawThongTinDeCuong :input\").prop(\"disabled\", true);\r\n" +
                    "           $('#btnThuHoi').show();\r\n" +
                    "           $('#btnLuu').hide();\r\n" +
                    "           $('#btnHoanTat').hide();\r\n" +
                    ...
                    "       else \r\n" +
                    "       {\r\n" +
                    "           $(\"#divDrawThongTinDeCuong :input\").prop(\"disabled\", false);\r\n" +
                    "           $('#btnThuHoi').hide();\r\n" +
                    "           $('#btnLuu').show();\r\n" +
                    "           $('#btnHoanTat').show();\r\n" +
                ...
                #region Hoàn tất
                    "   function HoanTat(){\r\n" +                 
                    "        Ma = document.getElementById('txtMaDeCuong').value\r\n" +
                    "        if(Ma == '')\r\n" +
                    "        {\r\n" +
                    "            callGallAlert('" + WebLanguage.GetLanguage(OSiteParam, "Trường mã đề cương không được bỏ trống!") + "');\r\n" +
                    "            return true;\r\n" +
                    "        }\r\n" +
                    "       SaveThongTin()\r\n" +
                    "       RenderInfo=CreateRenderInfo();\r\n" +
                    "       XetDuyetDeCuongId = document.getElementById('hdXetDuyetDeCuongId').value;\r\n" +
                    "       AjaxOut = OneTSQ.WebParts.XetDuyetDeCuong.UpdateTrangThai(RenderInfo, XetDuyetDeCuongId, " + (int)DeCuongCls.eTrangThai.HoanTat + ").value;\r\n" +
                    "       if(AjaxOut.Error)\r\n" +
                    "       {\r\n" +
                    "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                    "           return;\r\n" +
                    ...
                    "           AddHistory(XetDuyetDeCuongId, '" + WebPartTitle + "', 'Hoàn tất xét duyệt đề cương', 'Tác vụ form');\r\n" +
                    "           CheckTrangThai();\r\n" +
                    "       }\r\n" +
                    "   }\r\n" +
                #endregion
                ...
                #region Thu hồi
                    ...
                    "               RenderInfo=CreateRenderInfo();\r\n" +
                    "               XetDuyetDeCuongId = document.getElementById('hdXetDuyetDeCuongId').value;\r\n" +
                    "               AjaxOut = OneTSQ.WebParts.XetDuyetDeCuong.UpdateTrangThai(RenderInfo, XetDuyetDeCuongId, " + (int)DeCuongCls.eTrangThai.DaLapLich + ").value;\r\n" +
                    "               if(AjaxOut.Error)\r\n" +
                    "               {\r\n" +
                    "                   callGallAlert(AjaxOut.InfoMessage);\r\n" +
                    "                   return;\r\n" +
                    ...
                    "                   $('#btnLuu').show();\r\n" +
                    "                   $('#btnHoanTat').show();\r\n" +
                    "                   AddHistory(XetDuyetDeCuongId, '" + WebPartTitle + "', 'Thu hồi hoàn tất xét duyệt đề cương', 'Tác vụ form');\r\n" +
                    "                   CheckTrangThai();\r\n" +
                    "               }\r\n" +
                    "       }); \r\n" +
                    "   }\r\n" +
                ...
                #region Save Thông tin
                    ...
                    "     AjaxOut = OneTSQ.WebParts.XetDuyetDeCuong.SaveThongTin(RenderInfo, XetDuyetDeCuongId, Ma, YKienChung, KetLuan, ThoiGianBatDau, ThoiGianKetThuc).value;\r\n" +
                    "     if(AjaxOut.Error)\r\n" +
                    "     {\r\n" +
                    "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                    "           return;\r\n" +
                ...
                #region onclickLoadDangKy
                    ...
                    "       _xetduyetid = id;\r\n" +
                    "       onLoad();\r\n"+
                    "       txtMaDeCuong.disabled=true;\r\n" +
                    "       txtTenDeCuong.disabled=true;\r\n" +
                    ...
                    "       if(_xetduyetid == \"\")\r\n" +
                    "           return false;\r\n" +
                    "       AjaxOut = OneTSQ.WebParts.XetDuyetDeCuong.DrawThongTinDeCuong(RenderInfo, _xetduyetid).value;\r\n" +
                    "       if(AjaxOut.Error)\r\n" +
                    "       {\r\n" +
                    "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                    "           return false;\r\n" +
                    "       }\r\n" +     
                    "       document.getElementById('txtMaDeCuong').value = AjaxOut.RetExtraParam1;\r\n" +
                    "       document.getElementById('txtTenDeCuong').value = AjaxOut.RetExtraParam2;\r\n" +
                    ...
                    "       document.getElementById('hdXetDuyetDeCuongId').value = AjaxOut.RetObject2;\r\n" +
                    "        AjaxOut = OneTSQ.WebParts.XetDuyetDeCuong.DrawTaiLieuDeCuong(RenderInfo,_xetduyetid).value;\r\n" +
                    "         if(AjaxOut.Error)\r\n" +
                    "         {\r\n" +
                    "             callGallAlert(AjaxOut.InfoMessage);\r\n" +
                    "             return false;\r\n" +
                    "         }\r\n" +
                    "           divTaiLieuDeCuong.innerHTML = AjaxOut.HtmlContent;\r\n" +
                    "        AjaxOut = OneTSQ.WebParts.XetDuyetDeCuong.DrawHoiDongXetDuyet(RenderInfo).value;\r\n" +
                    "         if(AjaxOut.Error)\r\n" +
                    "         {\r\n" +
                    "             callGallAlert(AjaxOut.InfoMessage);\r\n" +
                    "             return false;\r\n" +
                    ...
                    "        AjaxOut = OneTSQ.WebParts.XetDuyetDeCuong.DrawYKienHoiDong(RenderInfo).value;\r\n" +
                    "         if(AjaxOut.Error)\r\n" +
                    "         {\r\n" +
                    "             callGallAlert(AjaxOut.InfoMessage);\r\n" +
                    "             return false;\r\n" +
        ...
        public static AjaxOut DrawDanhSachDeCuong(RenderInfoCls ORenderInfo, int PageIndex, string keyword, string lichXetDuyetId)
        {
            AjaxOut RetAjaxOut = new AjaxOut();
            try
            {
                ...
                DeCuongFilterCls filter = new DeCuongFilterCls()
                {
                    ...
                    TrangThais = (int)DeCuongCls.eTrangThai.DaLapLich +"," +(int)DeCuongCls.eTrangThai.HoanTat,
                };
                long recordTotal = 0;
                ...
                for (int iIndex = 0; iIndex < dangKyTotal; iIndex++)
                {
                    ...
                    Html +=
                        "                 <tr> \r\n" +
                        "                     <td style='text-align: center; vertical-align: middle;'><a href=\"javascript:onclickLoadDangKy('" + DeCuong[iIndex].ID + "');\" title='" + WebLanguage.GetLanguage(OSiteParam, "Mở phiếu") + "'>" + (filter.PageIndex * filter.PageSize + iIndex + 1).ToString("#,##0") + "</a></td> \r\n" +
                        "                     <td style='vertical-align: middle;'><a href=\"javascript:onclickLoadDangKy('" + DeCuong[iIndex].ID + "');\" title='" + WebLanguage.GetLanguage(OSiteParam, "Mở phiếu") + "'>" + DeCuong[iIndex].TENDECUONG + "</a></td> \r\n" +
                        "                 </tr> \r\n";
                }
                Html +=
                    "                 </tbody> \r\n" +
        ...
        public static AjaxOut DrawThongTinDeCuong(RenderInfoCls ORenderInfo, string XetDuyetDeCuongId)
        {
            ...
            try
            {
                ...
                RetAjaxOut.RetExtraParam1 = XetDuyetDeCuong.MA;
                RetAjaxOut.RetExtraParam2 = XetDuyetDeCuong.TENDECUONG;          
                string cbbCapDeTai = "";
                string chunhiem = "";    
                ...
                cbbKetLuan += "</select>\r\n";
                RetAjaxOut.RetExtraParam5 = XetDuyetDeCuong.THOIGIANBATDAU == null ? null : XetDuyetDeCuong.THOIGIANBATDAU.Value.ToString("HH:mm dd/MM/yyyy");
                RetAjaxOut.RetExtraParam6 = XetDuyetDeCuong.THOIGIANKETTHUC == null ? null : XetDuyetDeCuong.THOIGIANKETTHUC.Value.ToString("HH:mm dd/MM/yyyy");
                RetAjaxOut.RetObject = cbbKetLuan;
                RetAjaxOut.RetObject1 = XetDuyetDeCuong.YKIENCHUNG;
                RetAjaxOut.RetObject2 = XetDuyetDeCuong.ID;
                string Html =
                ...
                "                                        <input id='txtMaDeCuong' type='text' style='z-index: 0;' required value='"+ XetDuyetDeCuong .MA + "'  class='form-control valueForm' disabled>\r\n" +
                "                                   </div> \r\n" +
                "                               </div> \r\n" +
                "                                <div class=\"col-md-6\">\r\n" +
                "                                    <div class=\"form-group\">\r\n" +
                                                         WebLanguage.GetLanguage(OSiteParam, "Tên đề cương: ") +
                "                                        <input id='txtTenDeCuong' type='text' style='z-index: 0;' value='" + XetDuyetDeCuong.TENDECUONG + "' class='form-control valueForm' disabled>\r\n" +
                "                                    </div>\r\n" +
                "                                </div>\r\n" +
                "                               <div class=\"col-md-2\">\r\n" +
                "                                   <div class=\"form-group\">\r\n" +
                ...
                "                                       <textarea  id='txtYKienChung'  maxlength=\"2000\" rows=\"4\" type='text' style='z-index: 0; height: 120px;' class='form-control valueForm'>" + XetDuyetDeCuong.YKIENCHUNG + "</textarea>\r\n" +
                "                                   </div> \r\n" +
                "                               </div>\r\n" +
                "                           </div>\r\n" +
                "                           <div class='row'>\r\n" +
                ...
                "                                       <input id='dtThoiGianBatDau' type='text' style='z-index: 0;' value='"+ (XetDuyetDeCuong.THOIGIANBATDAU == null ? null : XetDuyetDeCuong.THOIGIANBATDAU.Value.ToString("HH:mm dd/MM/yyyy")) + "' class='form-control valueForm datepicker'>\r\n" +
                "                                   </div>\r\n" +
                "                               </div>\r\n" +
                "                               <div class=\"col-md-3\">\r\n" +
                "                                   <div class=\"form-group\">\r\n" +
                                                        WebLanguage.GetLanguage(OSiteParam, "Thời gian kết thúc:") +
                "                                       <input id='dtThoiGianKetThuc' type='text' style='z-index: 0;' value='" + (XetDuyetDeCuong.THOIGIANKETTHUC == null ? null : XetDuyetDeCuong.THOIGIANKETTHUC.Value.ToString("HH:mm dd/MM/yyyy")) + "' class='form-control valueForm datepicker'>\r\n" +
                "                                   </div>\r\n" +
                "                               </div>\r\n" +
                "                           </div>\r\n" +
        ...
        public static AjaxOut DrawTaiLieuDeCuong(RenderInfoCls ORenderInfo, string DeCuongID)
        {
            ...
            try
            {
                ...
                string html =
                         "<table class=\"table table-striped table-bordered table-hover\" id='divTaiLieuDeCuong'> \r\n" +
                         "  <thead> \r\n" +
                         "      <tr> \r\n" +
                         "          <th width=30 style='text-align: center;'>" + WebLanguage.GetLanguage(OSiteParam, "STT") + " </th> \r\n" +
        ...
        [AjaxPro.AjaxMethod(AjaxPro.HttpSessionStateRequirement.ReadWrite)]
        public static AjaxOut SaveThongTin(RenderInfoCls ORenderInfo, string XetDuyetDeCuongId, string MaDeCuong, string YKienChung, int KetLuan, string ThoiGianBatDau, string ThoiGianKetThuc)
        {
            AjaxOut RetAjaxOut = new AjaxOut();
            try
            {
                ...
                {
                    ODeCuong = CallBussinessUtility.CreateBussinessProcess().CreateDeCuongProcess().CreateModel(ORenderInfo, XetDuyetDeCuongId);
                }
                else
                {
                    ODeCuong = CallBussinessUtility.CreateBussinessProcess().CreateDeCuongProcess().CreateModel(ORenderInfo, MaDeCuong);
                    if (ODeCuong == null)
                    {
                        ODeCuong = new DeCuongCls() { MA = MaDeCuong };
                    }
                }
                ...
                {
                    ODeCuong.YKIENCHUNG = YKienChung;
                    ODeCuong.KETLUAN = KetLuan;
                    ODeCuong.THOIGIANBATDAU = string.IsNullOrWhiteSpace(ThoiGianBatDau) ? null : (DateTime?)DateTime.ParseExact(ThoiGianBatDau, "HH:mm dd/MM/yyyy", null);
                    ODeCuong.THOIGIANKETTHUC = string.IsNullOrWhiteSpace(ThoiGianKetThuc) ? null : (DateTime?)DateTime.ParseExact(ThoiGianKetThuc, "HH:mm dd/MM/yyyy", null);
                    CallBussinessUtility.CreateBussinessProcess().CreateDeCuongProcess().Save(ORenderInfo, ODeCuong.ID, ODeCuong);
                }      
                ...
                List<DanhGiaDeCuong_DeTaiCls> oldDanhGias = CallBussinessUtility.CreateBussinessProcess().CreateDanhGiaDeCuong_DeTaiProcess().Reading(ORenderInfo, new DanhGiaDeCuong_DeTaiFilterCls() { DECUONG_ID = ODeCuong.ID }).ToList();
                foreach (var oldDanhGia in oldDanhGias)
                {
                    ...
                    foreach (var newHoiDong in newDanhGias)
                    {
                        ...
                        {
                            oldDanhGia.DECUONG_ID = ODeCuong.ID;
                ...
                {
                    addDanhGia.DECUONG_ID = ODeCuong.ID;
