...
{
    public class ThemMoiDeTai : ObjectWebPartTemplate
    {
        public override string WebPartId { get { return StaticWebPartId; } }
        public static string StaticWebPartId = "ThemMoiDeTai";
        public override string WebPartTitle { get { return "Thêm mới đề tài"; } }
        public override string Description { get { return "Thêm mới đề tài"; } }
        public override string[] CheckPermissionWebPartIds
        {
            get
            {
                return new string[] { StaticWebPartId, ThemMoiDeTai.StaticWebPartId };
            }
        }
        public override void RegAjaxPro(RenderInfoCls ORenderInfo, System.Web.UI.Page Page)
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(ThemMoiDeTai), Page);
        }
        #region Vẽ giao diện
        public override AjaxOut Draw(SiteParam OSiteParam, RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                string ThemMoiDeTaiId = WebEnvironments.Request("id");
                #region Html
                string html =
                    "<form action='javascript:SaveDeTai();'> \r\n" +
                    ...
                    "               <div class=\"ibox-content\" style=\"border: 0; \" id='divDeTai'> \r\n" +
                                            DrawDeTai(ORenderInfo, null, ThemMoiDeTaiId).HtmlContent +
                    "               </div>\r\n" +
                    "           </div>\r\n" +
                    "       </div>\r\n" +
                    "   </div>\r\n" +
                ...
                string js =
                    ...
                    "   var ThemMoiDeTaiId='" + ThemMoiDeTaiId + "';\r\n" +
                ...
                #region Truyền id đăng ký cho nút print
                    ...
                    "{\r\n" +
                    "   RenderInfo=CreateRenderInfo();\r\n" +
                    "    AjaxOut = OneTSQ.WebParts.ThemMoiDeTai.CheckTrangThai(RenderInfo, ThemMoiDeTaiId).value;\r\n" +
                    "    if(AjaxOut.Error)\r\n" +
                    "    {\r\n" +
                    "        callGallAlert(AjaxOut.InfoMessage);\r\n" +
                    "        return;\r\n" +
                    "    }\r\n" +
                    "   ThemMoiDeTaiId = document.getElementById('hdThemMoiDeTaiId').value;\r\n" +
                    "   if(ThemMoiDeTaiId == '')\r\n" +
                    "   {\r\n" +
                    ...
                    "            return true;\r\n" +
                    "        }\r\n" +
                    "   return ThemMoiDeTaiId;\r\n" +
                    "}\r\n" +
                #endregion 
                #region Show trạng thái 
                    "function ShowTrangThai(){\r\n" +
                    "     RenderInfo=CreateRenderInfo();\r\n" +
                    "     $('#aTrangThai').html(OneTSQ.WebParts.ThemMoiDeTai.ShowTrangThai(RenderInfo, ThemMoiDeTaiId).value);\r\n" +
                    "}\r\n" +
                ...
                #region Check trạng thái
                    ...
                    "       if(AjaxOut.RetExtraParam1 == 1)\r\n" +
                    "       {\r\n" +
                    "           $(\"#divDeTai :input\").prop(\"disabled\", true);\r\n" +
                    "           $('#btnLuu').hide();\r\n" +
                    "           $('#btnChuyenDuyet').hide();\r\n" +
                    "           $('#btnThuHoiDuyet').hide();\r\n" +
                    "           $('#btnDuyet').show();\r\n" +
                    ...
                    "       else \r\n" +
                    "       {\r\n" +
                    "           $(\"#divDeTai :input\").prop(\"disabled\", false);\r\n" +
                    "           $('#btnLuu').show();\r\n" +
                    "           $('#btnChuyenDuyet').show();\r\n" +
                    "           $('#btnThuHoiDuyet').hide();\r\n" +
                    "           $('#btnDuyet').hide();\r\n" +
                ...
                #region Thu hồi
                    ...
                    "       {\r\n" +
                    "       callGallAlert('" + WebLanguage.GetLanguage(OSiteParam, "Đề tài đã được lập lịch xét duyệt, không thể thu hồi!") + "');\r\n" +
                    "       return true;\r\n" +
                    "       }\r\n" +
                    "       if(AjaxOut.RetExtraParam1 == 3)\r\n" +
                    "       {\r\n" +
                    "       callGallAlert('" + WebLanguage.GetLanguage(OSiteParam, "Đề tài đã được hoàn tất, không thể thu hồi!") + "');\r\n" +
                    "       return true;\r\n" +
                    "       }\r\n" +
                    "       swal({ \r\n" +
                    "               title: \"Bạn có chắc chắn thu hồi chuyển duyệt đề tài này?\", \r\n" +
                    "               type: \"warning\", \r\n" +
                    ...
                    "               RenderInfo=CreateRenderInfo();\r\n" +
                    "               ThemMoiDeTaiId = document.getElementById('hdThemMoiDeTaiId').value;\r\n" +
                    "               AjaxOut = OneTSQ.WebParts.ThemMoiDeTai.UpdateTrangThai(RenderInfo, ThemMoiDeTaiId, " + (int)DeTaiCls.eTrangThai.Moi + ").value;\r\n" +
                    "               if(AjaxOut.Error)\r\n" +
                    "               {\r\n" +
                    "                   callGallAlert(AjaxOut.InfoMessage);\r\n" +
                    "                   return;\r\n" +
                    ...
                    "                   AddHistory(ThemMoiDeTaiId, '" + WebPartTitle + "', 'Thu hồi', 'Tác vụ form');\r\n" +
                    "                   ShowTrangThai();\r\n" +
                    "                   CheckTrangThai();\r\n" +
                    "               }\r\n" +
                    "       }); \r\n" +
                ...
                #region Thu hồi
                    ...
                    "       }\r\n" +
                    "       swal({ \r\n" +
                    "               title: \"Bạn có chắc chắn thu hồi duyệt đề tài này?\", \r\n" +
                    "               type: \"warning\", \r\n" +
                    "               showCancelButton: true, \r\n" +
                    "               confirmButtonColor: \"#DD6B55\", \r\n" +
                    "               confirmButtonText: \"" + "Thực hiện" + "\", \r\n" +
                    ...
                    "               closeOnCancel: true\r\n" +
                    "           }, function () { \r\n" +
                    "               AjaxOut = OneTSQ.WebParts.ThemMoiDeTai.UpdateTrangThai(RenderInfo, ThemMoiDeTaiId, " + (int)DeTaiCls.eTrangThai.ChoXetDuyet + ").value;\r\n" +
                    "               if(AjaxOut.Error)\r\n" +
                    "               {\r\n" +
                    "                   callGallAlert(AjaxOut.InfoMessage);\r\n" +
                    "                   return;\r\n" +
                    ...
                    "                   $('#btnThuHoi').show();\r\n" +
                    "                   toastr.info('" + WebLanguage.GetLanguage(OSiteParam, "Đã thu hồi!!") + "');\r\n" +
                    "                   AddHistory(ThemMoiDeTaiId, '" + WebPartTitle + "', 'Thu hồi duyệt', 'Tác vụ form');\r\n" +
                    "                   ShowTrangThai();\r\n" +
                    "                   CheckTrangThai();\r\n" +
                    "               }\r\n" +
                    "       }); \r\n" +
                ...
                #region Chuyển duyệt
                    ...
                    "       if(AjaxOut.RetExtraParam1 == 3)\r\n" +
                    "       {\r\n" +
                    "       callGallAlert('" + WebLanguage.GetLanguage(OSiteParam, "Đề tài đã được lập lịch xét duyệt, không thể chuyển duyệt!") + "');\r\n" +
                    "       return true;\r\n" +
                    "       }\r\n" +
                    "       if(AjaxOut.RetExtraParam1 == 4)\r\n" +
                    "       {\r\n" +
                    "       callGallAlert('" + WebLanguage.GetLanguage(OSiteParam, "Đề tài đã được hoàn tất, không thể chuyển duyệt!") + "');\r\n" +
                    "       return true;\r\n" +
                    "       }\r\n" +
                    "       SaveDeTai();\r\n" +
                    "       AjaxOut = OneTSQ.WebParts.ThemMoiDeTai.UpdateTrangThai(RenderInfo, ThemMoiDeTaiId, " + (int)DeTaiCls.eTrangThai.ChoXetDuyet + ").value;\r\n" +
                    ...
                    "           AddHistory(ThemMoiDeTaiId, '" + WebPartTitle + "', 'Hoàn tất', 'Tác vụ form');\r\n" +
                    "           ShowTrangThai();\r\n" +
                    "           CheckTrangThai();\r\n" +
                    "       }\r\n" +
                    "   }\r\n" +
                ...
                #region Duyệt
                    ...
                    "       if(AjaxOut.RetExtraParam1 == 3)\r\n" +
                    "       {\r\n" +
                    "       callGallAlert('" + WebLanguage.GetLanguage(OSiteParam, "Đề tài đã được lập lịch xét duyệt, không thể duyệt!") + "');\r\n" +
                    "       return true;\r\n" +
                    "       }\r\n" +
                    "       if(AjaxOut.RetExtraParam1 == 4)\r\n" +
                    "       {\r\n" +
                    "       callGallAlert('" + WebLanguage.GetLanguage(OSiteParam, "Đề tài đã được hoàn tất, không thể duyệt!") + "');\r\n" +
                    "       return true;\r\n" +
                    "       }\r\n" +
                    "       SaveDeTai();\r\n" +
                    "       AjaxOut = OneTSQ.WebParts.ThemMoiDeTai.UpdateTrangThai(RenderInfo, ThemMoiDeTaiId, " + (int)DeTaiCls.eTrangThai.LapLich + ").value;\r\n" +
                    "       if(AjaxOut.Error)\r\n" +
                    "       {\r\n" +
                    "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                    "           return;\r\n" +
                ...
                #region Save Thông tin
                    ...
                    "       if(AjaxOut.RetExtraParam1 == 3)\r\n" +
                    "       {\r\n" +
                    "           callGallAlert('" + WebLanguage.GetLanguage(OSiteParam, "Đề tài đã được hoàn tất!") + "');\r\n" +
                    "           return true;\r\n" +
                    "       }\r\n" +
                    "     MaDeTai = document.getElementById('txtMaDeTai').value;\r\n" +
                    "     DKDeTaiID = document.getElementById('cbbTenDeTai').value;\r\n" +
                    ...
                    "     AjaxOut = OneTSQ.WebParts.ThemMoiDeTai.SaveDeTai(RenderInfo, ThemMoiDeTaiId, MaDeTai, DKDeTaiID, TenDeTai, ThoiGianGui, NguoiGui).value;\r\n" +
                    "     if(AjaxOut.Error)\r\n" +
                    "     {\r\n" +
                    "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                    "           return;\r\n" +
                    ...
                    "     {\r\n" +
                    "           document.getElementById('hdThemMoiDeTaiId').value = ThemMoiDeTaiId = AjaxOut.RetExtraParam1;\r\n" +
                    "           AddHistory(ThemMoiDeTaiId, '" + WebPartTitle + "', 'Thêm mới', 'Tác vụ form');\r\n" +
                    "     }\r\n" +
                    "     else\r\n" +
                    "           AddHistory(ThemMoiDeTaiId, '" + WebPartTitle + "', 'Cập nhật', 'Tác vụ form');\r\n" +
                ...
                #region Xóa Thông tin đăng ký
                    ...
                    "           if (isConfirm) {\r\n" +
                    "               RenderInfo=CreateRenderInfo();\r\n" +
                    "               AjaxOut = OneTSQ.WebParts.ThemMoiDeTai.DeleteThongTin(RenderInfo, ThemMoiDeTaiId).value;\r\n" +
                    "               if(AjaxOut.Error)\r\n" +
                    "               {\r\n" +
                    "                   callGallAlert(AjaxOut.InfoMessage);\r\n" +
                    "                   return;\r\n" +
                    "               }\r\n" +
                    "               DeleteHistory(ThemMoiDeTaiId);\r\n" +
                ...
                #region Bắt sự kiện thay đổi textbox mã số
                    ...
                    "       ThemMoiDeTaiId = document.getElementById('hdThemMoiDeTaiId').value;\r\n" +
                    "       MaDeTai = sender.value;\r\n" +
                    "       if( MaDeTai != '')\r\n" +
                    "       {\r\n" +
                    "           RenderInfo=CreateRenderInfo();\r\n" +
                    "           AjaxOut = OneTSQ.WebParts.ThemMoiDeTai.DrawDeTai(RenderInfo, MaDeTai, null).value;\r\n" +
                    "           if(!AjaxOut.Error)\r\n" +
                    "           {\r\n" +
                    "               $('#divDeTai').html(AjaxOut.HtmlContent);\r\n" +
                    "               $('.datepicker').datetimepicker({ \r\n" +
                    "                   format: 'DD/MM/YYYY' \r\n" +
                    "               }); \r\n" +
                    "           }\r\n" +
                ...
                #region Bắt sự kiện thay đổi Combobox tên đề tài
                    ...
                    "       {\r\n" +
                    "           RenderInfo=CreateRenderInfo();\r\n" +
                    "           AjaxOut = OneTSQ.WebParts.ThemMoiDeTai.ShowTTDeTaiDangKy(RenderInfo, id).value;\r\n" +
                    "           if(AjaxOut.Error)\r\n" +
                    "           {\r\n" +
                    "               callGallAlert(AjaxOut.InfoMessage);\r\n" +
                    "               return;\r\n" +
                ...
                #region Thêm mới tài liệu
                    ...
                    "           AjaxOut = OneTSQ.WebParts.ThemMoiDeTai.SaveTaiLieu(RenderInfo, ThemMoiDeTaiId, GhiChu, xmlResult).value;\r\n" +
                    "           if(AjaxOut.Error)\r\n" +
                    "           {\r\n" +
                    "               callGallAlert(AjaxOut.InfoMessage);\r\n" +
                    "               return;\r\n" +
                ...
                #region Xóa tài liệu
                    ...
                    "           }, function () { \r\n" +
                    "               RenderInfo=CreateRenderInfo();\r\n" +
                    "               AjaxOut = OneTSQ.WebParts.ThemMoiDeTai.DeleteTaiLieu(RenderInfo, Id).value;\r\n" +
                    "               if(AjaxOut.Error)\r\n" +
                    "               {\r\n" +
                    "                   callGallAlert(AjaxOut.InfoMessage);\r\n" +
                    "                   return;\r\n" +
        ...
        public static AjaxOut DrawDeTai(RenderInfoCls ORenderInfo, string MaDeTai, string ThemMoiDeTaiId)
        {
            AjaxOut RetAjaxOut = new AjaxOut();
            try
            {
                ...
                DeTaiCls ThemMoiDeTai = null;
                if (!string.IsNullOrEmpty(ThemMoiDeTaiId))
                    ThemMoiDeTai = CallBussinessUtility.CreateBussinessProcess().CreateDeTaiProcess().CreateModel(ORenderInfo, ThemMoiDeTaiId);
                if (!string.IsNullOrEmpty(MaDeTai))
                    ThemMoiDeTai = CallBussinessUtility.CreateBussinessProcess().CreateDeTaiProcess().CreateModel(ORenderInfo, MaDeTai);
                if (ThemMoiDeTai == null)
                {
                    ThemMoiDeTai = new DeTaiCls();
                    if (string.IsNullOrEmpty(MaDeTai))
                    {
                        var boDemValueMaHV = GetBoDemValueAndMaHV(ORenderInfo);
                        ThemMoiDeTai.MA = boDemValueMaHV.RetExtraParam2;
                    }
                    else ThemMoiDeTai.MA = MaDeTai;
                }
                List<TaiLieuDinhKemCls> OTaiLieuDK = string.IsNullOrEmpty(ThemMoiDeTai.ID) ? new List<TaiLieuDinhKemCls>() : CallBussinessUtility.CreateBussinessProcess().CreateTaiLieuDinhKemProcess().Reading(ORenderInfo, new TaiLieuDinhKemFilterCls() { DOCUMENT_ID = ThemMoiDeTai.ID }).ToList();
                WebSessionUtility.SetSession(OSiteParam, "TaiLieuDinhKems", OTaiLieuDK);
                string cbbNguoiGui = "";
                if (!string.IsNullOrEmpty(ThemMoiDeTai.NGUOIGUI_ID))
                {
                    var nguoigui = OneTSQ.Core.Call.Bussiness.Utility.CoreCallBussinessUtility.CreateBussinessProcess().CreateOwnerUserProcess().CreateModel(ORenderInfo, ThemMoiDeTai.NGUOIGUI_ID);
                    if (nguoigui != null)
                    {
                ...
                string cbbTenDeTai = "";
                if (!string.IsNullOrEmpty(ThemMoiDeTai.DANGKYDETAI_ID))
                {
                    var Detaidangky = CallBussinessUtility.CreateBussinessProcess().CreateDangKyDeTaiProcess().CreateModel(ORenderInfo, ThemMoiDeTai.DANGKYDETAI_ID);
                    if (Detaidangky != null)
                    {
                ...
                string Html =
                "               <input id='hdThemMoiDeTaiId' type='hidden' value='" + ThemMoiDeTai.ID + "'>\r\n" +
                "               <div class=\"row\" id='divThemMoiDeTaiId'>\r\n" +
                ...
                "                                        <input id='txtMaDeTai' type='text' style='z-index: 0;' onchange='txtMa_onchange(this)' value='" + ThemMoiDeTai.MA + "' class='form-control valueForm' required>\r\n" +
                "                                    </div>\r\n" +
                "                                </div>\r\n" +
                "                                <div class=\"col-md-6\">\r\n" +
                "                                    <div class=\"form-group\">\r\n" +
                ...
                "                                    <div class=\"form-group\">\r\n" +
                                                         WebLanguage.GetLanguage(OSiteParam, "Tên đề tài: ") +
                "                                        <input id='txtTenDeTai' type='text' style='z-index: 0;' value='" + ThemMoiDeTai.TENDETAI + "' class='form-control valueForm' >\r\n" +
                "                                    </div>\r\n" +
                "                                </div>\r\n" +
                "                                  <div class=\"col-md-2\">\r\n" +
                "                                      <div class=\"form-group\">\r\n" +
                                                           WebLanguage.GetLanguage(OSiteParam, "Thời gian gửi đề tài:") + "<span style = 'color:red' >(*)</span >\r\n" +
                "                                          <input id='dtThoiGianGui' required type='text' style='z-index: 0;' value='" + (ThemMoiDeTai.THOIGIANGUI == null ? null : ThemMoiDeTai.THOIGIANGUI.Value.ToString(" dd/MM/yyyy")) + "' class='form-control valueForm datepicker'>\r\n" +
                "                                      </div>\r\n" +
                "                                  </div>\r\n" +
                "                               <div class=\"col-md-2\">\r\n" +
                "                                   <div class=\"form-group\">\r\n" +
                ...
                "                                            <span class=\"fileinput-exists\">Chọn lại</span><input type=\"file\" onchange='ShowSelectedFileNames(this);' name=\"...\" id=\"fileUploadTaiLieu\"/></span>\r\n" +
        ...
        public static AjaxOut GetBoDemValueAndMaHV(RenderInfoCls ORenderInfo)
        {
            ...
            string maHV = null;
            BoMaCls boMa = CoreCallBussinessUtility.CreateBussinessProcess().CreateBoMaProcess().Reading(ORenderInfo, new BoMaFilterCls() { TableName = "ThemMoiDeTai", FieldName = "MaDeTai" }).FirstOrDefault();
        ...
        [AjaxPro.AjaxMethod(AjaxPro.HttpSessionStateRequirement.ReadWrite)]
        public static AjaxOut SaveDeTai(RenderInfoCls ORenderInfo, string ThemMoiDeTaiId, string MaDeTai, string DKDeTaiID, string TenDeTai, string ThoiGianGui, string NguoiGui_ID)
        {
            AjaxOut RetAjaxOut = new AjaxOut();
            try
            {
                SiteParam OSiteParam = WebEnvironments.CreateSiteParam(ORenderInfo);
                WebSession.CheckSessionTimeOut(ORenderInfo);
                DeTaiCls ThemMoiDeTai = new DeTaiCls();
                if (!string.IsNullOrEmpty(ThemMoiDeTaiId))
                {
                    ThemMoiDeTai = CallBussinessUtility.CreateBussinessProcess().CreateDeTaiProcess().CreateModel(ORenderInfo, ThemMoiDeTaiId);
                }
                else
                {
                    ...
                    if (ThemMoiDeTai == null)
                    {
                        ThemMoiDeTai = new DeTaiCls() { MA = MaDeTai };
                    }
                }
                #region Thêm mới/cập nhật dề tài
                if (string.IsNullOrEmpty(ThemMoiDeTai.ID))
                {
                    ThemMoiDeTai.ID = ThemMoiDeTaiId = System.Guid.NewGuid().ToString();
                    ThemMoiDeTai.DANGKYDETAI_ID = DKDeTaiID;
                    ThemMoiDeTai.MA = MaDeTai;
                    ThemMoiDeTai.TENDETAI = TenDeTai;
                    ThemMoiDeTai.NGUOIGUI_ID = NguoiGui_ID;
                    ThemMoiDeTai.THOIGIANGUI = string.IsNullOrWhiteSpace(ThoiGianGui) ? null : (DateTime?)DateTime.ParseExact(ThoiGianGui, "dd/MM/yyyy", null);
                    ThemMoiDeTai.TRANGTHAI = (int)DeTaiCls.eTrangThai.Moi;
                    CallBussinessUtility.CreateBussinessProcess().CreateDeTaiProcess().Add(ORenderInfo, ThemMoiDeTai);
                    RetAjaxOut.RetExtraParam1 = ThemMoiDeTai.ID;
                }
                else
                {
                    ThemMoiDeTai.DANGKYDETAI_ID = DKDeTaiID;
                ...
                List<TaiLieuDinhKemCls> oldTaiLieus = CallBussinessUtility.CreateBussinessProcess().CreateTaiLieuDinhKemProcess().Reading(ORenderInfo, new TaiLieuDinhKemFilterCls() { DOCUMENT_ID = ThemMoiDeTai.ID }).ToList();
                foreach (var oldTaiLieu in oldTaiLieus)
                {
                    ...
                    foreach (var newThuocADR in newTaiLieus)
                    {
                        ...
                        {
                            oldTaiLieu.DOCUMENT_ID = ThemMoiDeTai.ID;
                ...
                {
                    addTaiLieu.DOCUMENT_ID = ThemMoiDeTai.ID;
        ...
        [AjaxPro.AjaxMethod(AjaxPro.HttpSessionStateRequirement.ReadWrite)]
        public static AjaxOut DeleteThongTin(RenderInfoCls ORenderInfo, string ThemMoiDeTaiId)
        {
            AjaxOut RetAjaxOut = new AjaxOut();
            try
            {
                SiteParam OSiteParam = WebEnvironments.CreateSiteParam(ORenderInfo);
                WebSession.CheckSessionTimeOut(ORenderInfo);
                CallBussinessUtility.CreateBussinessProcess().CreateDeTaiProcess().Delete(ORenderInfo, ThemMoiDeTaiId);
        ...
        [AjaxPro.AjaxMethod(AjaxPro.HttpSessionStateRequirement.ReadWrite)]
        public static string ShowTrangThai(RenderInfoCls ORenderInfo, string ThemMoiDeTaiId)
        {
            AjaxOut RetAjaxOut = new AjaxOut();
            try
            {
                ...
                DeTaiCls ThemMoiDeTai = CallBussinessUtility.CreateBussinessProcess().CreateDeTaiProcess().CreateModel(ORenderInfo, ThemMoiDeTaiId);
                if (ThemMoiDeTai != null)
                    return DeTaiParser.sColorTrangThai[ThemMoiDeTai.TRANGTHAI.Value];
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
        ...
        [AjaxPro.AjaxMethod(AjaxPro.HttpSessionStateRequirement.ReadWrite)]
        public static AjaxOut CheckTrangThai(RenderInfoCls ORenderInfo, string ThemMoiDeTaiId)
        {
            AjaxOut RetAjaxOut = new AjaxOut();
            try
            {
                ...
                if (!string.IsNullOrEmpty(ThemMoiDeTaiId))
                {
                    DeTaiCls ThemMoiDeTai = CallBussinessUtility.CreateBussinessProcess().CreateDeTaiProcess().CreateModel(ORenderInfo, ThemMoiDeTaiId);
                    if (ThemMoiDeTai != null)
                        RetAjaxOut.RetExtraParam1 = ThemMoiDeTai.TRANGTHAI.ToString();
                }
            }
            catch (Exception ex)
            {
        ...
        public class QCGiaoDienDeTaiNew
        {
        ...
        public static AjaxOut ShowTTDeTaiDangKy(RenderInfoCls ORenderInfo, string Id)
        {
            ...
            try
            {
                SiteParam OSiteParam = WebEnvironments.CreateSiteParam(ORenderInfo);
                WebSession.CheckSessionTimeOut(ORenderInfo);
                QCGiaoDienDeTaiNew qd = new QCGiaoDienDeTaiNew();
        ...
        [AjaxPro.AjaxMethod(AjaxPro.HttpSessionStateRequirement.ReadWrite)]
        public static AjaxOut SaveTaiLieu(RenderInfoCls ORenderInfo, string DeTaiID, string GhiChu, string xmlUploadFileResult)
        {
            AjaxOut RetAjaxOut = new AjaxOut();
            try
            {
