    ...
    public class CaseProfile : WebPartTemplate
    {
        ...
        public override AjaxOut Draw(SiteParam OSiteParam, RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                OwnerCls
                    OOwner = CoreCallBussinessUtility.CreateBussinessProcess().CreateOwnerProcess().CreateModel(ORenderInfo, WebSessionUtility.GetCurrentLoginUser(OSiteParam).frkOwnerId);
                ...
                OwnerCls[]
                    Owners = CoreCallBussinessUtility.CreateBussinessProcess().CreateOwnerProcess().Reading(ORenderInfo, OOwnerFilter);
                ...
                RetAjaxOut.HtmlContent =
                    ...
                    "       AjaxOut = OneTSQ.WebParts.CaseProfile.ServerSideAddCaseProfile(RenderInfo).value;\r\n" +
                    ...
                    "   {\r\n" +
                    "       RenderInfo=CreateRenderInfo();\r\n" +
                    "       AjaxOut = OneTSQ.WebParts.CaseProfile.ServerSideUpdateCaseProfile(RenderInfo, CaseProfileId).value;\r\n" +
                    "       window.open(AjaxOut.RetUrl,'_self');\r\n" +
                    "   }\r\n" +
                    ...
                    "           AjaxOut = OneTSQ.WebParts.CaseProfile.ServerSideDelete(RenderInfo, CaseProfileId).value;\r\n" +
                    "           if(AjaxOut.Error)\r\n" +
                    "           {\r\n" +
                    ...
                    "       OneTSQ.WebParts.CaseProfile.ServerSideDrawSearchResult(RenderInfo, OwnerId, Keyword, CallBackReading);\r\n" +
                    "   }\r\n" +
                    ...
                    WebEnvironments.EncryptHtml(
                        ...
                        "         <h5>" + WebLanguage.GetLanguage(OSiteParam, "Hồ sơ sự vụ") + " </h5> \r\n" +
                        "     </div> \r\n" +
                        ...
                        //"                 <div style=\"margin-bottom:5px\">" + WebLanguage.GetLanguage(OSiteParam, "Khách hàng") + "</div>\r\n" +
                        //"                 <div style=\"margin-bottom:5px\">" + SelectCustomerText + "</div>\r\n" +
            ...
            string Keyword)
        {
            ...
            try
            {
                ...
                OCaseProfileFilter.OwnerUserId = WebSessionUtility.GetCurrentLoginUser(OSiteParam).OwnerUserId;
                OCaseProfileFilter.EnabledPermission = 1;

                string OwnerCode=WebSessionUtility.GetCurrentLoginUser(OSiteParam).OwnerCode;
                CaseProfileCls[] 
                    CaseProfiles = CallBussinessUtility.CreateBussinessProcess().CreateCaseProfileProcess().Reading(ORenderInfo, OCaseProfileFilter);
                string Html = "";
                ...
                else
                {
                    Html +=
                        ...
                        "                     <th>" + WebLanguage.GetLanguage(OSiteParam, "Khách hàng") + " </th> \r\n" +
                        ...
                        "                     <th>" + WebLanguage.GetLanguage(OSiteParam, "Chia sẻ") + " </th> \r\n" +
                        "                     <th>" + WebLanguage.GetLanguage(OSiteParam, "NV.Quản lý") + " </th> \r\n" +
                    ...
                    for (int iIndex = 0; iIndex < CaseProfiles.Length; iIndex++)
                    {
                        Html +=
                            ...
                            "                     <td>" + CaseProfiles[iIndex].Company + "</td> \r\n" +
                            ...
                            "                     <td>" + CaseProfiles[iIndex].SharedOwnerText + "</td> \r\n" +
                            "                     <td>" + CaseProfiles[iIndex].SharedOwnerUserText + "</td> \r\n" +
            ...
            string CaseProfileId)
        {
            ...
            try
            {
                ...
                CallBussinessUtility.CreateBussinessProcess().CreateCaseProfileProcess().Delete(ORenderInfo, CaseProfileId);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
