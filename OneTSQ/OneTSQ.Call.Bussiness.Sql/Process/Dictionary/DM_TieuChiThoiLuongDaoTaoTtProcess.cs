...
namespace OneTSQ.Call.Bussiness.Sql
{
    public class DM_TieuChiThoiLuongDaoTaoTtProcessBll : DM_TieuChiThoiLuongDaoTaoTtTemplate
    {
        ...
        public override DM_TieuChiThoiLuongDaoTaoTtCls[] Reading(
            RenderInfoCls ORenderInfo,
            DM_TieuChiThoiLuongDaoTaoTtFilterCls OTieuChiThoiLuongDaoTaoTtFilter)
        {
            ActionSqlParamCls
        ...
        public override DM_TieuChiThoiLuongDaoTaoTtCls[] ReadingWithPaging(
            RenderInfoCls ORenderInfo,
            DM_TieuChiThoiLuongDaoTaoTtFilterCls OTieuChiThoiLuongDaoTaoTtFilter,
                int PageIndex,
                int PageSize)
        ...
        public override DM_TieuChiThoiLuongDaoTaoTtCls CheckCode(RenderInfoCls ORenderInfo, string MaTieuChiThoiLuongDaoTaoTt)
        {
            ActionSqlParamCls ActionSqlParam = WebEnvironments.CreateActionSqlParam(ORenderInfo);
            return OneTSQBussinessUtility.CreateBussinessProcess().CreateTieuChiThoiLuongDaoTaoTtProcess().CheckCode(ActionSqlParam, MaTieuChiThoiLuongDaoTaoTt);
        }
    }
}
