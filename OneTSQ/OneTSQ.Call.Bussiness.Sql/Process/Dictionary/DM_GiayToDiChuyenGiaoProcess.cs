...
namespace OneTSQ.Call.Bussiness.Sql
{
    public class DM_GiayToDiChuyenGiaoProcessBll : DM_GiayToDiChuyenGiaoTemplate
    {
        ...
        public override DM_GiayToDiChuyenGiaoCls[] Reading(
            RenderInfoCls ORenderInfo,
            DM_GiayToDiChuyenGiaoFilterCls OGiayToDiChuyenGiaoFilter)
        {
            ActionSqlParamCls
        ...
        public override DM_GiayToDiChuyenGiaoCls[] ReadingWithPaging(
            RenderInfoCls ORenderInfo,
            DM_GiayToDiChuyenGiaoFilterCls OGiayToDiChuyenGiaoFilter)
        {
            ActionSqlParamCls
        ...
        public override DM_GiayToDiChuyenGiaoCls CheckCode(RenderInfoCls ORenderInfo, string MaGiayToDiChuyenGiao)
        {
            ActionSqlParamCls ActionSqlParam = WebEnvironments.CreateActionSqlParam(ORenderInfo);
            return OneTSQBussinessUtility.CreateBussinessProcess().CreateDM_GiayToDiChuyenGiaoProcess().CheckCode(ActionSqlParam, MaGiayToDiChuyenGiao);
        }
    }
}
