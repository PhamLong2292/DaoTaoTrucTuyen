...
namespace OneTSQ.Call.Bussiness.Sql
{
    public class ButPheProcessBll : ButPheTemplate
    {
        ...
        public override ButPheCls[] Reading(RenderInfoCls ORenderInfo, ButPheFilterCls OButPheFilter)
        {
        ...
        public override ButPheCls[] PageReading(RenderInfoCls ORenderInfo, ButPheFilterCls OButPheFilter,ref long countTotal)
        {
            ActionSqlParamCls ActionSqlParam = WebEnvironments.CreateActionSqlParam(ORenderInfo);
            return OneTSQBussinessUtility.CreateBussinessProcess().CreateButPheProcess().PageReading(ActionSqlParam, OButPheFilter, ref countTotal);
        }
