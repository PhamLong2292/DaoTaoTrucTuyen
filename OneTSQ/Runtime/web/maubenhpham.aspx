...
<script runat="server">
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string thietbiid = OneTSQ.Utility.WebEnvironments.Request("thietbiid");
        ...
        OneTSQ.Core.Model.AjaxOut
            RetAjaxOut = OneTSQ.Utility.RemoteDataUtility.Find(ServiceId).Reading(ORenderInfo, iPage, q, thietbiid);
