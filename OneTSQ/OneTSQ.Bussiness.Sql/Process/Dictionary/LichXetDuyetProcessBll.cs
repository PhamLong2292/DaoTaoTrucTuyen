    ...
    public class LichXetDuyetProcessBll : LichXetDuyetTemplate
    {
        ...
        public override LichXetDuyetCls[] PageReadingDC(ActionSqlParamCls ActionSqlParam, LichXetDuyetFilterCls OLichXetDuyetFilter, ref long recordTotal)
        {
            ...
            try
            {
                ...
                Query = " select lxd.ID, lxd.THOIGIAN, lxd.NGUOIDUYET_ID, lxd.NGUOILAP_ID, lxd.CHUTRI_ID, lxd.THUKY_ID, lxd.THOIGIANBATDAU, lxd.THOIGIANKETTHUC, lxd.DIADIEMTHUCHIEN, lxd.TRANGTHAI from NCKH_LICHXETDUYET lxd INNER JOIN NCKH_DECUONG dc on dc.LICHXETDUYET_ID = lxd.ID Where dc.LICHXETDUYET_ID = lxd.ID";        
                recordTotalQuery = " select count(1) from NCKH_LICHXETDUYET lxd INNER JOIN NCKH_DECUONG dc on dc.LICHXETDUYET_ID = lxd.ID Where dc.LICHXETDUYET_ID = lxd.ID ";
                if (!string.IsNullOrEmpty(OLichXetDuyetFilter.NGUOILAP_ID))
                {
                ...
                Query += " GROUP BY  lxd.ID, lxd.THOIGIAN, lxd.NGUOIDUYET_ID, lxd.NGUOILAP_ID, lxd.CHUTRI_ID, lxd.THUKY_ID, lxd.THOIGIANBATDAU, lxd.THOIGIANKETTHUC,lxd.DIADIEMTHUCHIEN, lxd.TRANGTHAI";
        ...
        public override LichXetDuyetCls[] PageReadingDT(ActionSqlParamCls ActionSqlParam, LichXetDuyetFilterCls OLichXetDuyetFilter, ref long recordTotal)
        {
            ...
            try
            {
                ...
                Query = " select lxd.ID, lxd.THOIGIAN, lxd.NGUOIDUYET_ID, lxd.NGUOILAP_ID, lxd.CHUTRI_ID, lxd.THUKY_ID, lxd.THOIGIANBATDAU, lxd.THOIGIANKETTHUC, lxd.DIADIEMTHUCHIEN, lxd.TRANGTHAI from NCKH_LICHXETDUYET lxd INNER JOIN NCKH_DETAI dt on dt.LICHXETDUYET_ID = lxd.ID Where dt.LICHXETDUYET_ID = lxd.ID";
                recordTotalQuery = " select count(1) from NCKH_LICHXETDUYET lxd INNER JOIN NCKH_DETAI dt on dt.LICHXETDUYET_ID = lxd.ID Where dt.LICHXETDUYET_ID = lxd.ID ";
                if (!string.IsNullOrEmpty(OLichXetDuyetFilter.NGUOILAP_ID))
                {
                    ColDbParams.Add(new DbParam("lxd.NGUOILAP_ID", OLichXetDuyetFilter.NGUOILAP_ID));
                    Query += " and lxd.NGUOILAP_ID = " + ActionSqlParam.SpecialChar + "lxd.NGUOILAP_ID ";
