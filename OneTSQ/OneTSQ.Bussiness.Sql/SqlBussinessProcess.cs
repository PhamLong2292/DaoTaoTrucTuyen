...
namespace OneTSQ.Bussiness.Sql
{
    public class SqlBussinessProcess : BussinessProcessTemplate
    {
        ...
        public override IPhieuBaoCaoSuCoYKhoaProcess CreatePhieuBaoCaoSuCoYKhoaProcess()
        {
            return new PhieuBaoCaoSuCoYKhoaProcessBll();
        }
        public override IPhieuPhanTichNguyenNhanSuCoProcess CreatePhieuPhanTichNguyenNhanSuCoProcess()
        {
            return new PhieuPhanTichNguyenNhanSuCoProcessBll();
        }
        public override IPhieuBaoCaoPhanUngCoHaiADRProcess CreatePhieuBaoCaoPhanUngCoHaiADRProcess()
        {
            return new PhieuBaoCaoPhanUngCoHaiADRProcessBll();
        }
        public override IThuocADRProcess CreateThuocADRProcess()
        {
            return new ThuocADRProcessBll();
        }
        public override IPhieuKhaoSatBenhVienVeTinhProcess CreatePhieuKhaoSatBenhVienVeTinhProcess()
        {
            return new PhieuKhaoSatBenhVienVeTinhProcessBll();
        }
        public override IDaoTaoNhanLucProcess CreateDaoTaoNhanLucProcess()
        {
            return new DaoTaoNhanLucProcessBll();
        }
        #endregion

        #region Nghiệp vụ
        public override IDangKyDeTaiProcess CreateDangKyDeTaiProcess()
        {
            return new DangKyDeTaiProcessBll();
        }
        public override IDeTaiProcess CreateDeTaiProcess()
        {
            return new DeTaiProcessBll();
        }
        public override IDeCuongProcess CreateDeCuongProcess()
        {
            return new DeCuongProcessBll();
        }
        public override ILichXetDuyetProcess CreateLichXetDuyetProcess()
        {
            return new LichXetDuyetProcessBll();
        }     
        public override IDanhGiaDeCuong_DeTaiProcess CreateDanhGiaDeCuong_DeTaiProcess()
        {
            return new DanhGiaDeCuong_DeTaiProcessBll();
        }
        public override IHoiDongXetDuyetProcess CreateHoiDongXetDuyetProcess()
        {
            return new HoiDongXetDuyetProcessBll();
        }
        public override ICongTacVienDeTaiProcess CreateCongTacVienDeTaiProcess()
        {
            return new CongTacVienDeTaiProcessBll();
        }
        public override ITaiLieuDinhKemProcess CreateTaiLieuDinhKemProcess()
        {
            return new TaiLieuDinhKemProcessBll();
        }
        #endregion
    }
}
