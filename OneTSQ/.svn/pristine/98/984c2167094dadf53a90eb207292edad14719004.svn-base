...
{
    public class DanhSachDeTai : WebPartTemplate
    {
        public override string WebPartId { get { return StaticWebPartId; } }
        public static string StaticWebPartId = "DanhSachDeTai";
        ...
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(DanhSachDeTai), Page);
        }
        ...
        public override AjaxOut Draw(SiteParam OSiteParam, RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                string cbbTrangThai = "";
                foreach (var tt in DeTaiParser.TrangThais)
                ...
                RetAjaxOut.HtmlContent =
                    ...
                    "       document.title = '" + WebLanguage.GetLanguage(OSiteParam, "OneTSQ: Danh sách đề tài") + "';\r\n" +
                    ...
                    "       AjaxOut = OneTSQ.WebParts.DanhSachDeTai.DrawSearchResult(RenderInfo, CurrentPageIndex, keyword, LoaiHinh, CapDeTai, trangThai).value;\r\n" +
                    "       document.getElementById('divDeTai').innerHTML=AjaxOut.HtmlContent;\r\n" +
                    "   }\r\n" +
                    ...
                    "       trangThai = parseInt(document.getElementById('cbbTrangThai').value);\r\n" +
                    "       AjaxOut  = OneTSQ.WebParts.DanhSachDeTai.Print(RenderInfo, keyword, LoaiHinh, CapDeTai, trangThai).value;\r\n" +
                    "       if(AjaxOut.Error)\r\n" +
                    "       {\r\n" +
                ...
                #region html
                    ...
                    "           <div id=\"divDeTai\">" + DanhSachDeTai.DrawSearchResult(ORenderInfo, pageIndex, keyword, LoaiHinh, CapDeTai, trangThai).HtmlContent + "</div>\r\n" +
                    "     </div> \r\n" +
                    " </div>\r\n" +
                    "</div>\r\n"
                        );
        ...
        public static AjaxOut DrawSearchResult(RenderInfoCls ORenderInfo, int PageIndex, string keyword, int? LoaiHinh, int? CapDeTai, int? trangThai)
        {
            ...
            try
            {
                ...
                Html +=
                    ...
                    "                     <th>" + WebLanguage.GetLanguage(OSiteParam, "Tên đề tài") + " </th> \r\n" +
                ...
                {
                    var DeTaiUrl = WebScreen.BuildUrl(OSiteParam, WebSessionUtility.GetCurrentLoginUser(OSiteParam).OwnerCode, "ThemMoiDeTai",
                    ...
                    DangKyDeTaiCls TenDeTai = CallBussinessUtility.CreateBussinessProcess().CreateDangKyDeTaiProcess().CreateModel(ORenderInfo, DeTai[iIndex].DANGKYDETAI_ID);
                    string chunhiem = null;
                    string tendeTai = null;
                    if (TenDeTai != null)
                    {
                        tendeTai = TenDeTai.TENDETAI;
                    ...
                    Html +=
                        "                 <tr> \r\n" +
                        "                     <td style='text-align: center; vertical-align: middle;'><a href='" + DeTaiUrl + "' title='" + WebLanguage.GetLanguage(OSiteParam, "Mở phiếu") + "'>" + (filter.PageIndex * filter.PageSize + iIndex + 1).ToString("#,##0") + "</a></td> \r\n" +
                        "                     <td style='vertical-align: middle;'><a href='" + DeTaiUrl + "' title='" + WebLanguage.GetLanguage(OSiteParam, "Mở phiếu") + "'>" + DeTai[iIndex].MA + "</a></td> \r\n" +
                        "                     <td style='vertical-align: middle;'><a href='" + DeTaiUrl + "' title='" + WebLanguage.GetLanguage(OSiteParam, "Mở phiếu") + "'>" + DeTai[iIndex].TENDETAI + "</a></td> \r\n" +
                        "                     <td style='vertical-align: middle;'><a href='" + DeTaiUrl + "' title='" + WebLanguage.GetLanguage(OSiteParam, "Mở phiếu") + "'>" + (TenDeTai == null || TenDeTai.LOAIHINH.ToString() == null ? null : DangKyDeTaiParser.LoaiHinhs[TenDeTai.LOAIHINH]) + "</a></td> \r\n" +
                        "                     <td style='vertical-align: middle;'><a href='" + DeTaiUrl + "' title='" + WebLanguage.GetLanguage(OSiteParam, "Mở phiếu") + "'>" + (TenDeTai == null || TenDeTai.CAPDETAI == null ? null : DangKyDeTaiParser.CapDeTais[TenDeTai.CAPDETAI.Value]) + "</a></td> \r\n" +
                        "                     <td style='vertical-align: middle;'><a href='" + DeTaiUrl + "' title='" + WebLanguage.GetLanguage(OSiteParam, "Mở phiếu") + "'>" + chunhiem + "</a></td> \r\n" +
                        "                     <td style='text-align: center; vertical-align: middle;'><a href='" + DeTaiUrl + "' title='" + WebLanguage.GetLanguage(OSiteParam, "Mở phiếu") + "'>" + (DeTai[iIndex].THOIGIANGUI == null ? null : DeTai[iIndex].THOIGIANGUI.Value.ToString("HH:mm dd/MM/yyyy")) + "</a></td> \r\n" +
                        "                     <td style='text-align: center; vertical-align: middle;'><a href='" + DeTaiUrl + "' title='" + WebLanguage.GetLanguage(OSiteParam, "Mở phiếu") + "'></a>" + (DeTai[iIndex].THOIGIANBATDAU == null ? null : DeTai[iIndex].THOIGIANBATDAU.Value.ToString("HH:mm dd/MM/yyyy")) + "</td> \r\n" +
                        "                     <td style='vertical-align: middle;'><a href='" + DeTaiUrl + "' title='" + WebLanguage.GetLanguage(OSiteParam, "Mở phiếu") + "'>" + (DeTai[iIndex] == null || DeTai[iIndex].KETLUAN == null ? null : DeTaiParser.KetLuans[DeTai[iIndex].KETLUAN.Value]) + "</a></td> \r\n" +
                        "                     <td style='text-align: center; vertical-align: middle;'>" + DeTaiParser.sColorTrangThai[DeTai[iIndex].TRANGTHAI.Value] + "</td> \r\n" +
                        "                 </tr> \r\n";
                }
                Html +=
                    "                 </tbody> \r\n" +
        ...
        public override string divFilter
        {
            get
            {
                return "<div class=\"col-md-3\" style=\"padding-top: 6px; padding-bottom: 6px;\">\r\n" +
                       "    <input id=\"txtKeyword\" placeholder=\"Tìm kiếm theo mã, tên đề tài \" class=\"form-control valueForm\" style=\"border-radius: 4px;\">\r\n" +
                       "</div>\r\n" +
