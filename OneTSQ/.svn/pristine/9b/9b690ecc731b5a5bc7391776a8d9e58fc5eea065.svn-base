    ...
    public class DT_DangKies : WebPartTemplate
    {
            ...
            try
            {
                ...
                for (int iIndex = 0; iIndex < dangKyTotal; iIndex++)
                {
                    ...
                    Html +=
                        ...
                        "                     <td style='vertical-align: middle;'><a href='" + dangKyUrl + "' title='" + WebLanguage.GetLanguage(OSiteParam, "Mở đăng ký khóa học") + "'>" + (khoaHoc == null ? null: khoaHoc.TENKHOAHOC )+ "</a></td> \r\n" +
                        "                     <td style='text-align: center; vertical-align: middle;'>" + (dangKies[iIndex].NGAYDANGKY == null ? null: DT_KetQuaDaoTaoParser.sColorTrangThai[dangKies[iIndex].TRANGTHAI] )+ "</td> \r\n" +
                        "                 </tr> \r\n";
                }
                Html +=
                    "                 </tbody> \r\n" +
        ...
        public static AjaxOut Print(RenderInfoCls ORenderInfo, string keyword, string donViCongTacMa, string khoaHocId, int? trangThai)
        {
            ...
            try
            {
                ...
                DataTable dtResult = CallBussinessUtility.CreateBussinessProcess().CreateCommonProcess().GetData(ORenderInfo, null , query, param);
