...
namespace OneTSQ.Call.Bussiness.Sql
{
    public class DM_TieuChiThoiGianDaoTaoTtProcessBll : DM_TieuChiThoiGianDaoTaoTtTemplate
    {
        ...
        public override DM_TieuChiThoiGianDaoTaoTtCls[] Reading(
            RenderInfoCls ORenderInfo,
            DM_TieuChiThoiGianDaoTaoTtFilterCls OTieuChiThoiGianDaoTaoTtFilter)
        {
            ActionSqlParamCls
        ...
        public override DM_TieuChiThoiGianDaoTaoTtCls[] ReadingWithPaging(
            RenderInfoCls ORenderInfo,
            DM_TieuChiThoiGianDaoTaoTtFilterCls OTieuChiThoiGianDaoTaoTtFilter,
                int PageIndex,
                int PageSize)
        ...
        public override DM_TieuChiThoiGianDaoTaoTtCls CheckCode(RenderInfoCls ORenderInfo, string MaTieuChiThoiGianDaoTaoTt)
        {
            ActionSqlParamCls ActionSqlParam = WebEnvironments.CreateActionSqlParam(ORenderInfo);
            return OneTSQBussinessUtility.CreateBussinessProcess().CreateTieuChiThoiGianDaoTaoTtProcess().CheckCode(ActionSqlParam, MaTieuChiThoiGianDaoTaoTt);
        }
    }
}
