            ...
            try
            {
                ...
                for (int iIndex = 0; iIndex < dangKyTotal; iIndex++)
                {
                    ...
                    Html +=
                        ...
                        "                     <td style='text-align: center; vertical-align: middle;'><a href='" + DeCuongUrl + "' title='" + WebLanguage.GetLanguage(OSiteParam, "Mở phiếu") + "'>" + (DeCuong[iIndex].THOIGIANGUI == null ? null : DeCuong[iIndex].THOIGIANGUI.Value.ToString("HH:mm dd/MM/yyyy")) + "</a></td> \r\n" +
                        "                     <td style='text-align: center; vertical-align: middle;'><a href='" + DeCuongUrl + "' title='" + WebLanguage.GetLanguage(OSiteParam, "Mở phiếu") + "'></a>" + (DeCuong[iIndex].THOIGIANBATDAU == null ? null : DeCuong[iIndex].THOIGIANBATDAU.Value.ToString("HH:mm dd/MM/yyyy")) + "</td> \r\n" +
