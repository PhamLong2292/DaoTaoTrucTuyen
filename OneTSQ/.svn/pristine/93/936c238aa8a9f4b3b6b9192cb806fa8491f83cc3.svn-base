...
namespace OneTSQ.Call.Bussiness.Sql
{
    public class DM_NhomKhoaHocProcessBll : DM_NhomKhoaHocTemplate
    {
        ...
        public override DM_NhomKhoaHocCls[] Reading(
            RenderInfoCls ORenderInfo,
            DM_NhomKhoaHocFilterCls ONhomKhoaHocFilter)
        {
            ActionSqlParamCls
        ...
        public override DM_NhomKhoaHocCls[] ReadingWithPaging(
            RenderInfoCls ORenderInfo,
            DM_NhomKhoaHocFilterCls ONhomKhoaHocFilter)
        {
            ActionSqlParamCls
        ...
        public override DM_NhomKhoaHocCls CheckCode(RenderInfoCls ORenderInfo, string MaNhomKhoaHoc)
        {
            ActionSqlParamCls ActionSqlParam = WebEnvironments.CreateActionSqlParam(ORenderInfo);
            return OneTSQBussinessUtility.CreateBussinessProcess().CreateDM_NhomKhoaHocProcess().CheckCode(ActionSqlParam, MaNhomKhoaHoc);
        }
    }
}
