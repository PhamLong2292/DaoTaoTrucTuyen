...
namespace OneTSQ.WebParts
{
    public class DanhSachLichXetDuyetDeTai : WebPartTemplate
    {
        ...
        public override string WebPartTitle
        {
            get
            {
                return "Danh sách lịch xét duyệt đề tài";
            }
        }
        ...
        public static AjaxOut DrawSearchResult(RenderInfoCls ORenderInfo, int PageIndex, string keyword, int? LoaiHinh, int? CapDeTai, int? trangThai)
        {
            ...
            try
            {
                ...
                long recordTotal = 0;
                LichXetDuyetCls[] LichXetDuyet = CallBussinessUtility.CreateBussinessProcess().CreateLichXetDuyetProcess().PageReadingDT(ORenderInfo, filter, ref recordTotal);
