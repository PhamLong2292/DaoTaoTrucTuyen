...
namespace OneTSQ.Call.Bussiness.Ws
{
    public class DM_TieuChuanThamGiaKhoaHocProcessBll : DM_TieuChuanThamGiaKhoaHocTemplate
    {
        ...
        public override DM_TieuChuanThamGiaKhoaHocCls[] Reading(RenderInfoCls ORenderInfo, DM_TieuChuanThamGiaKhoaHocFilterCls OTieuChuanThamGiaKhoaHocFilter)
        {
        ...
        public override long Count(RenderInfoCls ORenderInfo, DM_TieuChuanThamGiaKhoaHocFilterCls OTieuChuanThamGiaKhoaHocFilter)
        {
            ActionSqlParamCls ActionSqlParam = WebEnvironments.CreateActionSqlParam(ORenderInfo);
        ...
        public override DM_TieuChuanThamGiaKhoaHocCls[] ReadingWithPaging(RenderInfoCls ORenderInfo, DM_TieuChuanThamGiaKhoaHocFilterCls OTieuChuanThamGiaKhoaHocFilter)
        {
            ActionSqlParamCls ActionSqlParam = WebEnvironments.CreateActionSqlParam(ORenderInfo);
