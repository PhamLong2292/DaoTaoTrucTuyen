...
//                bool xemPermission = PermissionUtility.CheckPermission(ORenderInfo, new DT_LichChuyenGiaoPermission().PermissionFunctionCode, DT_LichChuyenGiaoCls.ePermission.Xem.ToString(), new DT_LichChuyenGiaoPermission().PermissionFunctionCode, DT_LichChuyenGiaoPermission.StaticPermissionFunctionId, UserId);
//                bool themPermission = PermissionUtility.CheckPermission(ORenderInfo, new DT_LichChuyenGiaoPermission().PermissionFunctionCode, DT_LichChuyenGiaoCls.ePermission.Them.ToString(), new DT_LichChuyenGiaoPermission().PermissionFunctionCode, DT_LichChuyenGiaoPermission.StaticPermissionFunctionId, UserId);
//                bool suaPermission = PermissionUtility.CheckPermission(ORenderInfo, new DT_LichChuyenGiaoPermission().PermissionFunctionCode, DT_LichChuyenGiaoCls.ePermission.Sua.ToString(), new DT_LichChuyenGiaoPermission().PermissionFunctionCode, DT_LichChuyenGiaoPermission.StaticPermissionFunctionId, UserId);
//                bool xoaPermission = PermissionUtility.CheckPermission(ORenderInfo, new DT_LichChuyenGiaoPermission().PermissionFunctionCode, DT_LichChuyenGiaoCls.ePermission.Xoa.ToString(), new DT_LichChuyenGiaoPermission().PermissionFunctionCode, DT_LichChuyenGiaoPermission.StaticPermissionFunctionId, UserId);
//                bool guiDuyetPermission = PermissionUtility.CheckPermission(ORenderInfo, new DT_LichChuyenGiaoPermission().PermissionFunctionCode, DT_LichChuyenGiaoCls.ePermission.GuiDuyet.ToString(), new DT_LichChuyenGiaoPermission().PermissionFunctionCode, DT_LichChuyenGiaoPermission.StaticPermissionFunctionId, UserId);
//                bool pheDuyetPermission = PermissionUtility.CheckPermission(ORenderInfo, new DT_LichChuyenGiaoPermission().PermissionFunctionCode, DT_LichChuyenGiaoCls.ePermission.PheDuyet.ToString(), new DT_LichChuyenGiaoPermission().PermissionFunctionCode, DT_LichChuyenGiaoPermission.StaticPermissionFunctionId, UserId);
...
//                    "       document.title = '" + WebLanguage.GetLanguage(OSiteParam, "OneTMP: Danh sách lịch chuyển giao") + "';\r\n" +
...
//                    "                   xhr.open(\"POST\", \"" + WebConfig.GetImportHandler(OSiteParam, SessionId, UserId, LoginName, (int)Utilities.ProcessImportHandlerUtility.eFileType.DT_LICHCHUYENGIAO) + "\");\r\n" +
//                    "                   xhr.send(fd);\r\n" +
//                    "           }); \r\n" +
//                    "   }\r\n" +
...
//                    "    <div class=\"modal-dialog\" style='width:750px; height:750px; font-size: 20px;'>\r\n" +
...
//                    "                     <th style='width:70px;'><a href='javascript:ShowPopupLichChuyenGiao(\"\");' title='" + WebLanguage.GetLanguage(OSiteParam, "Thêm mới lịch chuyển giao") + "'><i class='fa fa-plus' style='font-size:20px; color: white;'></i></a></th> \r\n" +
//                    "                 </tr> \r\n" +
//                    "                 </thead> \r\n" +
//                    "                 <tbody> \r\n";
...
//                    {
//                        XmlCls XmlCommand = DmProcessWebServiceUtility.Utility.CreateCommand("benhvien.createmodel", ORenderInfo, lichChuyenGiaos[iIndex].BENHVIEN_MA, "");
//                        AjaxOut ajaxOut = DmProcessWebServiceUtility.Utility.ProcessComand("BenhVienWsProcessCommand", XmlCommand.XmlData, XmlCommand.XmlDataSchema);
//                        benhVien = BenhVienParser.ParseFromXml(ajaxOut.XmlDataResult, ajaxOut.XmlDataResultSchema);
//                    }
...
//                    if (suaPermission)
//                        Html +=
//                            "                   <a id='btnEdit" + iIndex + "' class='CssDisplayItemThanhVien' href='javascript:ShowPopupLichChuyenGiao(\"" + lichChuyenGiaos[iIndex].ID + "\");' title='" + WebLanguage.GetLanguage(OSiteParam, "Sửa") + "' ><i class='fa fa-pencil-square-o' style='font-size:20px;'></i></a>\r\n";
//                    if (xoaPermission)
//                        Html +=
//                            "                   <a id='btnDelete" + iIndex + "' class='CssDisplayItemThanhVien' href='javascript:DeleteLichChuyenGiao(\"" + lichChuyenGiaos[iIndex].ID + "\");' title='" + WebLanguage.GetLanguage(OSiteParam, "Xóa") + "' ><i class='fa fa-times' style='font-size:20px;'></i></a>\r\n";
//                    Html +=
//                        "                    </td> \r\n" +
//                        "                 </tr> \r\n";
//                }
...
//                string cbbKyThuatChuyenGiao = "<select class='form-control' id='cbbKyThuatChuyenGiao' required style='font-size: 20px;'>\r\n";
...
//                string cbbKhoaHoc = "<select class='form-control' id='cbbKhoaHoc' style='font-size: 20px;'>\r\n";
...
//                string cbbBenhVien = "<select class='form-control' id='cbbBenhVien' style='font-size: 20px;'>\r\n";
//                if (!string.IsNullOrEmpty(lichChuyenGiao.BENHVIEN_MA))
//                {
//                    XmlCls XmlCommand = DmProcessWebServiceUtility.Utility.CreateCommand("benhvien.createmodel", ORenderInfo, lichChuyenGiao.BENHVIEN_MA, "");
//                    AjaxOut ajaxOut = DmProcessWebServiceUtility.Utility.ProcessComand("BenhVienWsProcessCommand", XmlCommand.XmlData, XmlCommand.XmlDataSchema);
//                    OneMES3.DM.Model.BenhVienCls benhVien = BenhVienParser.ParseFromXml(ajaxOut.XmlDataResult, ajaxOut.XmlDataResultSchema);
//                    if (benhVien != null)
...
//                string cbbBacSy = "<select class='form-control' id='cbbBacSy' required style='font-size: 20px;'>\r\n";
...
//                                        "<input style='font-size: 20px;' type='text' data-mask='99/99/9999' required class='form-control datepicker' id='dtBatDau' value='" + (string.IsNullOrEmpty(lichChuyenGiao.ID) ? null : lichChuyenGiao.BATDAU.ToString("dd/MM/yyyy")) + "'>\r\n" +
//                                    "</div>\r\n" +
//                                "</div>\r\n" +
//                                "<div class='col-md-6 col-xs-6'>\r\n" +
//                                    "<div class=\"form-group\">\r\n" +
//                                        WebLanguage.GetLanguage(OSiteParam, "Kết thúc chuyển giao:") + " <span style='color:red'>*</span>\r\n" +
//                                        "<input style='font-size: 20px;' type='text' data-mask='99/99/9999' required class='form-control datepicker' id='dtKetThuc' value='" + (string.IsNullOrEmpty(lichChuyenGiao.ID) ? null : lichChuyenGiao.KETTHUC.ToString("dd/MM/yyyy")) + "'>\r\n" +
//                                    "</div>\r\n" +
//                                "</div>\r\n" +
//                    "         </div>\r\n" +
//                    "         <div class='row'>" +
...
//            bool pheDuyetPermission = PermissionUtility.CheckPermission(ORenderInfo, new DT_LichChuyenGiaoPermission().PermissionFunctionCode, DT_LichChuyenGiaoCls.ePermission.PheDuyet.ToString(), new DT_LichChuyenGiaoPermission().PermissionFunctionCode, DT_LichChuyenGiaoPermission.StaticPermissionFunctionId, user.OwnerUserId);
//            //Quyền dữ liệu
...
//                                    "  OR ( " +
//                                    "        select count(1) " +
//                                    "        from TablePermissionDataAccess join TablePermissionData on nvl(TablePermissionDataAccess.AllowAccess,0)=1 and TablePermissionData.frkOwnerUserId=DT_LichChuyenGiao.NGUOITAO_ID and PermissionDataId=frkPermissionDataId " +
...
//                    {
//                        XmlCls XmlCommand = DmProcessWebServiceUtility.Utility.CreateCommand("benhvien.createmodel", ORenderInfo, lichChuyenGiaos[i].BENHVIEN_MA, "");
//                        AjaxOut ajaxOut = DmProcessWebServiceUtility.Utility.ProcessComand("BenhVienWsProcessCommand", XmlCommand.XmlData, XmlCommand.XmlDataSchema);
//                        benhVien = BenhVienParser.ParseFromXml(ajaxOut.XmlDataResult, ajaxOut.XmlDataResultSchema);
//                    }
