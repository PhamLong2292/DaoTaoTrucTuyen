...
{
    public class TieuChiThoiGianDaoTaoTt : WebPartTemplate
    {
        public override string WebPartId
        {
            get
            {
                return "TieuChiThoiGianDaoTaoTt";
            }
        }
        public override string WebPartTitle
        {
            get
            {
                return "Tiêu chí đánh giá thời gian đào tạo trực tuyến";
            }
        }
        ...
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(TieuChiThoiGianDaoTaoTt), Page);
        }
        ...
        public override AjaxOut Draw(SiteParam OSiteParam, RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                XemPermission = user.IsSystemAdmin == 1 || PermissionUtility.CheckPermission(ORenderInfo, new TieuChiThoiGianDaoTaoTtPermission().PermissionFunctionCode,
                    DM_TieuChiThoiGianDaoTaoTtCls.ePermission.Xem.ToString(), new TieuChiThoiGianDaoTaoTtPermission().PermissionFunctionCode,
                    TieuChiThoiGianDaoTaoTtPermission.StaticPermissionFunctionId, userId, null, false);
                if (!XemPermission)
                {
                ...
                string filtemplate = WebConfig.GetWebHttpRoot() + "/temp/ImportDM_TIEUCHITHOIGIANDAOTAOTT.xlsx";
                RetAjaxOut.HtmlContent =
                      WebEnvironments.ProcessHtml(
                        ...
                        "         <h5>" + WebLanguage.GetLanguage(OSiteParam, "Tiêu chí đánh giá thời gian đào tạo trực tuyến") + "</h5> \r\n" +
                        "     </div> \r\n" +
                        ...
                        "         <div id=\"divTieuChiThoiGianDaoTaoTtContent\">" + ServerSideDrawSearchResult(ORenderInfo, "", null, 0).HtmlContent + "</div>\r\n" +
                        "     </div> \r\n" +
                      ...
                      WebEnvironments.ProcessJavascript(
                        ...
                        "       AjaxOut  = OneTSQ.WebParts.TieuChiThoiGianDaoTaoTt.ServerSidePrint(CreateRenderInfo()).value;\r\n" +
                        "       if(AjaxOut.Error)\r\n" +
                        "       {\r\n" +
                        ...
                        "       OneTSQ.WebParts.TieuChiThoiGianDaoTaoTt.ServerSideDrawSearchResult(CreateRenderInfo(), Keyword, HieuLuc, _currentPageIndex, CallBackReading);\r\n" +
                        "   }\r\n" +

                        "   function CallBackReading(res)\r\n" +
                        "   {\r\n" +
                        "       document.getElementById('divProcessing').innerHTML='';\r\n" +
                        "       document.getElementById('divTieuChiThoiGianDaoTaoTtContent').innerHTML = res.value.HtmlContent;\r\n" +
                        "       $('.confirm').focus(); " +
                        "   }\r\n" +
                        ...
                        "   {\r\n" +
                        "       AjaxOut = OneTSQ.WebParts.TieuChiThoiGianDaoTaoTt.ServerSideDrawAddForm(CreateRenderInfo()).value;\r\n" +
                        "       if(AjaxOut.Error) { \r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "           return;\r\n" +
                        "       }\r\n" +
                        "       document.getElementById('ModalTitle').innerHTML = '<span class=\"fa fa-pencil-square-o\">" + WebLanguage.GetLanguage(OSiteParam, " Thêm mới Tiêu chí đánh giá thời gian đào tạo trực tuyến") + " </span>';\r\n" +
                        ...
                        "   {\r\n" +
                        "       AjaxOut = OneTSQ.WebParts.TieuChiThoiGianDaoTaoTt.ServerSideDrawUpdateForm(CreateRenderInfo(), Id).value;\r\n" +
                        "       if(AjaxOut.Error) { \r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "           return;\r\n" +
                        "       }\r\n" +
                        "       document.getElementById('ModalTitle').innerHTML = '<span class=\"fa fa-pencil-square-o\">" + WebLanguage.GetLanguage(OSiteParam, " Sửa thông tin Tiêu chí đánh giá thời gian đào tạo trực tuyến") + " </span>';\r\n" +
                        "       document.getElementById('divModalContent').innerHTML = AjaxOut.HtmlContent; \r\n" +
                        "       $('#divFormModal').modal('show');\r\n" +
                        "       document.getElementById('txtMa').focus();\r\n" +
                        "   }\r\n" +
                        ...
                        "       AjaxOut = OneTSQ.WebParts.TieuChiThoiGianDaoTaoTt.ServerSideAdd(CreateRenderInfo(), Ma, Ten, Stt, MoTa, HieuLuc).value;\r\n" +
                        "       if(AjaxOut.Error) {\r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "           return;\r\n" +
                        "       }\r\n" +
                        "       callSweetAlert(\"" + WebLanguage.GetLanguage(OSiteParam, "Thêm mới Tiêu chí đánh giá thời gian đào tạo trực tuyến thành công!") + "\");\r\n" +
                        ...
                        "       AjaxOut = OneTSQ.WebParts.TieuChiThoiGianDaoTaoTt.ServerSideUpdate(CreateRenderInfo(), Id, Ma, Ten, Stt, MoTa, HieuLuc).value;\r\n" +
                        "       if(AjaxOut.Error) {\r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "           return;\r\n" +
                        "       }\r\n" +
                        "       callSweetAlert(\"" + WebLanguage.GetLanguage(OSiteParam, "Sửa thông tin Tiêu chí đánh giá thời gian đào tạo trực tuyến thành công!") + "\");\r\n" +
                        "       NextPage(_currentPageIndex);\r\n" +
                        "       CloseModal();\r\n" +
                        "   }\r\n" +
                        ...
                        "           }, function () { \r\n" +
                        "           AjaxOut = OneTSQ.WebParts.TieuChiThoiGianDaoTaoTt.ServerSideDelete(RenderInfo, id).value;\r\n" +
                        "           if(AjaxOut.Error) { \r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "               return;\r\n" +
                        "           }\r\n" +
                        "       callSweetAlert(\"" + WebLanguage.GetLanguage(OSiteParam, "Xóa thông tin Tiêu chí đánh giá thời gian đào tạo trực tuyến thành công") + "!\");\r\n" +
                        "       NextPage(_currentPageIndex);\r\n" +
                        "       }); \r\n" +
                        "   }\r\n" +
 ...
 "   function Import()\r\n" +
                    ...
                    "               xhr.open(\"POST\", \"" + WebConfig.GetImportHandler(OSiteParam, SessionId, userId, LoginName, (int)ProcessImportHandlerUtility.eFileType.DM_TIEUCHITHOIGIANDAOTAOTT) + "\");\r\n" +
                    "               xhr.send(fd);\r\n" +
                    "           }\r\n" +
                    "       ); \r\n" +
                    "   }\r\n" +
 ...
 "</script>\r\n");
        ...
        public static AjaxOut ServerSideDrawSearchResult(RenderInfoCls ORenderInfo, string Keyword, string HieuLuc, int currentPageIndex)
        {
            ...
            try
            {
                ...
                DM_TieuChiThoiGianDaoTaoTtFilterCls OPositionFilter = new DM_TieuChiThoiGianDaoTaoTtFilterCls()
                {
                    Keyword = Keyword,
                    HieuLuc = !string.IsNullOrEmpty(HieuLuc) && HieuLuc != null ? int.Parse(HieuLuc) :(int) eSearch.SearchAll
                };

                DM_TieuChiThoiGianDaoTaoTtCls[] Positions = CallBussinessUtility.CreateBussinessProcess().CreateTieuChiThoiGianDaoTaoTtProcess().ReadingWithPaging(ORenderInfo, OPositionFilter, currentPageIndex, 18);
                var countPosition = CallBussinessUtility.CreateBussinessProcess().CreateTieuChiThoiGianDaoTaoTtProcess().Count(ORenderInfo, OPositionFilter);
                ...
                else
                {
                    ...
                    for (int iIndex = 0; iIndex < Positions.Length; iIndex++)
                    {
                        Html.Append(
                            ...
                            "                     <td class=\"td-center\" style=\"text-align:center;\"><a title=\"" + "" + WebLanguage.GetLanguage(OSiteParam, "Sửa Tiêu chí đánh giá thời gian đào tạo trực tuyến") + "" + "\" href=\"javascript:ServerSideDrawUpdateForm('" + Positions[iIndex].Id + "');\"><i class=\"" + WebScreen.GetEditGridIcon() + "\"></i></a> &nbsp; <a title=\"" + "Xóa Tiêu chí đánh giá thời gian đào tạo trực tuyến" + "\" href=\"javascript:ServerSideDelete('" + Positions[iIndex].Id + "');\"><i class=\"" + WebScreen.GetDeleteGridIcon() + "\"></i></a></td> \r\n" +
                            //"                     <td class=\"td-center\"><a title=\"" + "Xóa Tiêu chí đánh giá thời gian đào tạo trực tuyến" + "\" href=\"javascript:ServerSideDelete('" + Positions[iIndex].Id + "');\"><i class=\"" + WebScreen.GetDeleteGridIcon() + "\"></i></a></td> \r\n" +
                            "                 </tr> \r\n");
                    }
                    Html.Append(
                        "                 </tbody> \r\n" +
        ...
        public static AjaxOut ServerSideDrawAddForm(RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                string Html =
                        ...
                        "                   <label for=\"inputTo\">" + WebLanguage.GetLanguage(OSiteParam, "Mã Tiêu chí đánh giá thời gian đào tạo trực tuyến") + " <span style='color:red'>*</span></label>\r\n" +
                        ...
                        "           <div class=\"col-xs-12 col-sm-12 col-md-12\">\r\n" +
                        "               <div class=\"form-group\">\r\n" +
                        "                   <label for=\"inputSubject\">" + WebLanguage.GetLanguage(OSiteParam, "Tên Tiêu chí đánh giá thời gian đào tạo trực tuyến") + " <span style='color:red'>*</span></label>\r\n" +
        ...
        public static AjaxOut ServerSideDrawUpdateForm(RenderInfoCls ORenderInfo, string Id)
        {
            ...
            try
            {
                ...
                var OPosition = CallBussinessUtility.CreateBussinessProcess().CreateTieuChiThoiGianDaoTaoTtProcess().CreateModel(ORenderInfo, Id);
                if (OPosition == null) throw new Exception(WebLanguage.GetLanguage(OSiteParam, "Tiêu chí đánh giá thời gian đào tạo trực tuyến đã bị xóa hoặc không tìm thấy"));
        ...
        public static AjaxOut ServerSideAdd(RenderInfoCls ORenderInfo, string Ma, string Ten, int Stt, string MoTa, string HieuLuc)
        {
            ...
            try
            {
                ...
                DM_TieuChiThoiGianDaoTaoTtCls OPosition = new DM_TieuChiThoiGianDaoTaoTtCls();
                ...
                CallBussinessUtility.CreateBussinessProcess().CreateTieuChiThoiGianDaoTaoTtProcess().Add(ORenderInfo, OPosition);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
        ...
        public static AjaxOut ServerSideUpdate(RenderInfoCls ORenderInfo, string Id, string Ma, string Ten, int Stt, string MoTa, string HieuLuc)
        {
            ...
            try
            {
                ...
                var OPositionOld = CallBussinessUtility.CreateBussinessProcess().CreateTieuChiThoiGianDaoTaoTtProcess().CreateModel(ORenderInfo, Id);
                if (OPositionOld == null) throw new Exception(WebLanguage.GetLanguage(OSiteParam, "Tiêu chí đánh giá thời gian đào tạo trực tuyến đã bị xóa hoặc không tìm thấy"));

                if (!OPositionOld.Ma.ToUpper().Equals(Ma.ToUpper()))
                    if (CallBussinessUtility.CreateBussinessProcess().CreateTieuChiThoiGianDaoTaoTtProcess().CreateModel(ORenderInfo, Ma) != null) throw new Exception(WebLanguage.GetLanguage(OSiteParam, "Mã đã tồn tại không thể sửa được bản ghi!"));

                DM_TieuChiThoiGianDaoTaoTtCls OPositionNew = new DM_TieuChiThoiGianDaoTaoTtCls();
                OPositionNew.Ma = Ma;
                ...
                CallBussinessUtility.CreateBussinessProcess().CreateTieuChiThoiGianDaoTaoTtProcess().Save(ORenderInfo, Id, OPositionNew);
        ...
        public static AjaxOut ServerSideDelete(RenderInfoCls ORenderInfo, string Id)
        {
            ...
            try
            {
                SiteParam OSiteParam = WebEnvironments.CreateSiteParam(ORenderInfo);
                WebSession.CheckSessionTimeOut(ORenderInfo);
                CallBussinessUtility.CreateBussinessProcess().CreateTieuChiThoiGianDaoTaoTtProcess().Delete(ORenderInfo, Id);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
        ...
        public static string ConditionGhiChu(DM_TieuChiThoiGianDaoTaoTtCls OPosition, string Ma, string Ten, int Stt, int HieuLuc, ref int ConditionAdd)
        {
        ...
        public static AjaxOut ServerSidePrint(RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                List<TieuChiThoiGianDaoTaoTtView> Datas = new List<TieuChiThoiGianDaoTaoTtView>();

                SiteParam
                      OSiteParam = WebEnvironments.CreateSiteParam(ORenderInfo);
                WebSession.CheckSessionTimeOut(ORenderInfo);

                DM_TieuChiThoiGianDaoTaoTtFilterCls OTieuChiThoiGianDaoTaoTt = new DM_TieuChiThoiGianDaoTaoTtFilterCls() { HieuLuc = (int)eSearch.SearchAll };

                DM_TieuChiThoiGianDaoTaoTtCls[] TieuChiThoiGianDaoTaoTts = CallBussinessUtility.CreateBussinessProcess().CreateTieuChiThoiGianDaoTaoTtProcess().Reading(ORenderInfo, OTieuChiThoiGianDaoTaoTt);

                for (int i = 0; i < TieuChiThoiGianDaoTaoTts.Length; i++)
                {

                    var view = new TieuChiThoiGianDaoTaoTtView();
                    view.Ma = TieuChiThoiGianDaoTaoTts[i].Ma;
                    view.Ten = TieuChiThoiGianDaoTaoTts[i].Ten;
                    view.Stt = TieuChiThoiGianDaoTaoTts[i].Stt;
                    view.MoTa = TieuChiThoiGianDaoTaoTts[i].MoTa;
                    view.HieuLuc = TieuChiThoiGianDaoTaoTts[i].HieuLuc.ToString();
                    view.NgayTao = TieuChiThoiGianDaoTaoTts[i].NgayTao.ToString("dd/MM/yyyy");
                    view.TuNgay = TieuChiThoiGianDaoTaoTts[i].TuNgay.Value.ToString("dd/MM/yyyy");
                    if (!string.IsNullOrEmpty(TieuChiThoiGianDaoTaoTts[i].DenNgay.ToString()))
                    {
                        view.DenNgay = TieuChiThoiGianDaoTaoTts[i].DenNgay.Value.ToString("dd/MM/yyyy");
                    }
                    view.GhiChu = TieuChiThoiGianDaoTaoTts[i].GhiChu;

                    Datas.Add(view);
                }
                flexCelReport.AddTable("TieuChiThoiGianDaoTaoTt", Datas);

                //flexCelReport.SetValue("NgayLap", DateTime.Now);

                string XmlFile = OSiteParam.PathRoot + "\\ReportTemplates\\TIEUCHITHOIGIANDAOTAOTT.xlsx";

                string Id = "DM_TieuChiThoiGianDaoTaoTt_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xlsx";
                string LoginName = WebSessionUtility.GetCurrentLoginUser(OSiteParam).LoginName;
                ...
                RetAjaxOut = new OneTSQ.ReportUtility.FlexcelReportUtility().ExportEx(ORenderInfo, LoginName, XmlFile, "DM_TieuChiThoiGianDaoTaoTt", flexCelReport, SaveFile);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
        ...
        public sealed class TieuChiThoiGianDaoTaoTtView
        {
