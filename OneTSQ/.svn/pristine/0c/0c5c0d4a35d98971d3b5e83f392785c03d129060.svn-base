...
public class PhieuBaoCaoSuCoYKhoaParser
{
    ...
    public readonly static Dictionary<int, string> PhanLoais = new Dictionary<int, string>()
        {
            { (int)PhieuBaoCaoSuCoYKhoaCls.ePhanLoai.ChuaXayRa, "Chưa xảy ra" },
            { (int)PhieuBaoCaoSuCoYKhoaCls.ePhanLoai.DaXayRa, "Đã xảy ra" },
        };
    public readonly static Dictionary<int, string> DanhGias = new Dictionary<int, string>()
        {
            { (int)PhieuBaoCaoSuCoYKhoaCls.eDanhGia.Nang, "Nặng" },
            { (int)PhieuBaoCaoSuCoYKhoaCls.eDanhGia.TrungBinh, "Trung bình" },
            { (int)PhieuBaoCaoSuCoYKhoaCls.eDanhGia.Nhe, "Nhẹ" }
        };
