...
{
    public class TieuChiThoiLuongDaoTaoTt : WebPartTemplate
    {
        public override string WebPartId
        {
            get
            {
                return "TieuChiThoiLuongDaoTaoTt";
            }
        }
        public override string WebPartTitle
        {
            get
            {
                return "Tiêu chí đánh giá thời lượng đào tạo trực tuyến";
            }
        }
        ...
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(TieuChiThoiLuongDaoTaoTt), Page);
        }
        ...
        public override AjaxOut Draw(SiteParam OSiteParam, RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                XemPermission = user.IsSystemAdmin == 1 || PermissionUtility.CheckPermission(ORenderInfo, new TieuChiThoiLuongDaoTaoTtPermission().PermissionFunctionCode,
                    DM_TieuChiThoiGianDaoTaoTtCls.ePermission.Xem.ToString(), new TieuChiThoiLuongDaoTaoTtPermission().PermissionFunctionCode,
                    TieuChiThoiLuongDaoTaoTtPermission.StaticPermissionFunctionId, userId, null, false);
                if (!XemPermission)
                {
                ...
                string filtemplate = WebConfig.GetWebHttpRoot() + "/temp/ImportDM_TIEUCHITHOILUONGDAOTAOTT.xlsx";
                RetAjaxOut.HtmlContent =
                      WebEnvironments.ProcessHtml(
                        ...
                        "         <h5>" + WebLanguage.GetLanguage(OSiteParam, "Tiêu chí đánh giá thời lượng đào tạo trực tuyến") + "</h5> \r\n" +
                        "     </div> \r\n" +
                        ...
                        "         <div id=\"divTieuChiThoiLuongDaoTaoTtContent\">" + ServerSideDrawSearchResult(ORenderInfo, "", null, 0).HtmlContent + "</div>\r\n" +
                        "     </div> \r\n" +
                      ...
                      WebEnvironments.ProcessJavascript(
                        ...
                        "       AjaxOut  = OneTSQ.WebParts.TieuChiThoiLuongDaoTaoTt.ServerSidePrint(CreateRenderInfo()).value;\r\n" +
                        "       if(AjaxOut.Error)\r\n" +
                        "       {\r\n" +
                        ...
                        "       OneTSQ.WebParts.TieuChiThoiLuongDaoTaoTt.ServerSideDrawSearchResult(CreateRenderInfo(), Keyword, HieuLuc, _currentPageIndex, CallBackReading);\r\n" +
                        "   }\r\n" +

                        "   function CallBackReading(res)\r\n" +
                        "   {\r\n" +
                        "       document.getElementById('divProcessing').innerHTML='';\r\n" +
                        "       document.getElementById('divTieuChiThoiLuongDaoTaoTtContent').innerHTML = res.value.HtmlContent;\r\n" +
                        "       $('.confirm').focus(); " +
                        "   }\r\n" +
                        ...
                        "   {\r\n" +
                        "       AjaxOut = OneTSQ.WebParts.TieuChiThoiLuongDaoTaoTt.ServerSideDrawAddForm(CreateRenderInfo()).value;\r\n" +
                        "       if(AjaxOut.Error) { \r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "           return;\r\n" +
                        "       }\r\n" +
                        "       document.getElementById('ModalTitle').innerHTML = '<span class=\"fa fa-pencil-square-o\">" + WebLanguage.GetLanguage(OSiteParam, " Thêm mới Tiêu chí đánh giá thời lượng đào tạo trực tuyến") + " </span>';\r\n" +
                        ...
                        "   {\r\n" +
                        "       AjaxOut = OneTSQ.WebParts.TieuChiThoiLuongDaoTaoTt.ServerSideDrawUpdateForm(CreateRenderInfo(), Id).value;\r\n" +
                        "       if(AjaxOut.Error) { \r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "           return;\r\n" +
                        "       }\r\n" +
                        "       document.getElementById('ModalTitle').innerHTML = '<span class=\"fa fa-pencil-square-o\">" + WebLanguage.GetLanguage(OSiteParam, " Sửa thông tin Tiêu chí đánh giá thời lượng đào tạo trực tuyến") + " </span>';\r\n" +
                        "       document.getElementById('divModalContent').innerHTML = AjaxOut.HtmlContent; \r\n" +
                        "       $('#divFormModal').modal('show');\r\n" +
                        "       document.getElementById('txtMa').focus();\r\n" +
                        "   }\r\n" +
                        ...
                        "       AjaxOut = OneTSQ.WebParts.TieuChiThoiLuongDaoTaoTt.ServerSideAdd(CreateRenderInfo(), Ma, Ten, Stt, MoTa, HieuLuc).value;\r\n" +
                        "       if(AjaxOut.Error) {\r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "           return;\r\n" +
                        "       }\r\n" +
                        "       callSweetAlert(\"" + WebLanguage.GetLanguage(OSiteParam, "Thêm mới Tiêu chí đánh giá thời lượng đào tạo trực tuyến thành công!") + "\");\r\n" +
                        ...
                        "       AjaxOut = OneTSQ.WebParts.TieuChiThoiLuongDaoTaoTt.ServerSideUpdate(CreateRenderInfo(), Id, Ma, Ten, Stt, MoTa, HieuLuc).value;\r\n" +
                        "       if(AjaxOut.Error) {\r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "           return;\r\n" +
                        "       }\r\n" +
                        "       callSweetAlert(\"" + WebLanguage.GetLanguage(OSiteParam, "Sửa thông tin Tiêu chí đánh giá thời lượng đào tạo trực tuyến thành công!") + "\");\r\n" +
                        "       NextPage(_currentPageIndex);\r\n" +
                        "       CloseModal();\r\n" +
                        "   }\r\n" +
                        ...
                        "           }, function () { \r\n" +
                        "           AjaxOut = OneTSQ.WebParts.TieuChiThoiLuongDaoTaoTt.ServerSideDelete(RenderInfo, id).value;\r\n" +
                        "           if(AjaxOut.Error) { \r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "               return;\r\n" +
                        "           }\r\n" +
                        "       callSweetAlert(\"" + WebLanguage.GetLanguage(OSiteParam, "Xóa thông tin Tiêu chí đánh giá thời lượng đào tạo trực tuyến thành công") + "!\");\r\n" +
                        "       NextPage(_currentPageIndex);\r\n" +
                        "       }); \r\n" +
                        "   }\r\n" +
 ...
 "   function Import()\r\n" +
                    ...
                    "               xhr.open(\"POST\", \"" + WebConfig.GetImportHandler(OSiteParam, SessionId, userId, LoginName, (int)ProcessImportHandlerUtility.eFileType.DM_TIEUCHITHOILUONGDAOTAOTT) + "\");\r\n" +
                    "               xhr.send(fd);\r\n" +
                    "           }\r\n" +
                    "       ); \r\n" +
                    "   }\r\n" +
 ...
 "</script>\r\n");
        ...
        public static AjaxOut ServerSideDrawSearchResult(RenderInfoCls ORenderInfo, string Keyword, string HieuLuc, int currentPageIndex)
        {
            ...
            try
            {
                ...
                DM_TieuChiThoiLuongDaoTaoTtFilterCls OPositionFilter = new DM_TieuChiThoiLuongDaoTaoTtFilterCls()
                {
                    Keyword = Keyword,
                    HieuLuc = !string.IsNullOrEmpty(HieuLuc) && HieuLuc != null ? int.Parse(HieuLuc) : (int)eSearch.SearchAll
                };

                DM_TieuChiThoiLuongDaoTaoTtCls[] Positions = CallBussinessUtility.CreateBussinessProcess().CreateTieuChiThoiLuongDaoTaoTtProcess().ReadingWithPaging(ORenderInfo, OPositionFilter, currentPageIndex, 18);
                var countPosition = CallBussinessUtility.CreateBussinessProcess().CreateTieuChiThoiLuongDaoTaoTtProcess().Count(ORenderInfo, OPositionFilter);
                ...
                else
                {
                    ...
                    for (int iIndex = 0; iIndex < Positions.Length; iIndex++)
                    {
                        Html.Append(
                            ...
                            "                     <td class=\"td-center\" style=\"text-align:center;\"><a title=\"" + "" + WebLanguage.GetLanguage(OSiteParam, "Sửa Tiêu chí đánh giá thời lượng đào tạo trực tuyến") + "" + "\" href=\"javascript:ServerSideDrawUpdateForm('" + Positions[iIndex].Id + "');\"><i class=\"" + WebScreen.GetEditGridIcon() + "\"></i></a> &nbsp; <a title=\"" + "Xóa Tiêu chí đánh giá thời lượng đào tạo trực tuyến" + "\" href=\"javascript:ServerSideDelete('" + Positions[iIndex].Id + "');\"><i class=\"" + WebScreen.GetDeleteGridIcon() + "\"></i></a></td> \r\n" +
                            //"                     <td class=\"td-center\"><a title=\"" + "Xóa Tiêu chí đánh giá thời lượng đào tạo trực tuyến" + "\" href=\"javascript:ServerSideDelete('" + Positions[iIndex].Id + "');\"><i class=\"" + WebScreen.GetDeleteGridIcon() + "\"></i></a></td> \r\n" +
                            "                 </tr> \r\n");
                    }
                    Html.Append(
                        "                 </tbody> \r\n" +
        ...
        public static AjaxOut ServerSideDrawAddForm(RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                string Html =
                        ...
                        "                   <label for=\"inputTo\">" + WebLanguage.GetLanguage(OSiteParam, "Mã Tiêu chí đánh giá thời lượng đào tạo trực tuyến") + " <span style='color:red'>*</span></label>\r\n" +
                        ...
                        "           <div class=\"col-xs-12 col-sm-12 col-md-12\">\r\n" +
                        "               <div class=\"form-group\">\r\n" +
                        "                   <label for=\"inputSubject\">" + WebLanguage.GetLanguage(OSiteParam, "Tên Tiêu chí đánh giá thời lượng đào tạo trực tuyến") + " <span style='color:red'>*</span></label>\r\n" +
        ...
        public static AjaxOut ServerSideDrawUpdateForm(RenderInfoCls ORenderInfo, string Id)
        {
            ...
            try
            {
                ...
                var OPosition = CallBussinessUtility.CreateBussinessProcess().CreateTieuChiThoiLuongDaoTaoTtProcess().CreateModel(ORenderInfo, Id);
                if (OPosition == null) throw new Exception(WebLanguage.GetLanguage(OSiteParam, "Tiêu chí đánh giá thời lượng đào tạo trực tuyến đã bị xóa hoặc không tìm thấy"));
                ...
                string Html =
                     "<form id=\"sendmail\" data-async  method=\"post\" onSubmit=\"return false;\" role=\"form\" class=\"contactForm\">\r\n" +
                        ...
                        "                       <label for=\"inputSubject\">" + WebLanguage.GetLanguage(OSiteParam, "Trạng thái") + "</label>\r\n" +
                        "                       <div> \r\n" +
                        "                           <label class=\"radio-inline\"><input  id = \"optradioHl0\" type = \"radio\" name=\"optradioHl\" value=\"" + (int)eHieuLuc.Co + "\"" + (OPosition.HieuLuc == (int)eHieuLuc.Co ? "checked" : string.Empty) + ">" + Model.Common.HieuLucs[OPosition.HieuLuc] + "</label> " +
                        "                           <label class=\"radio-inline\"><input  id = \"optradioHl1\" type = \"radio\" name=\"optradioHl\" value=\"" + (int)eHieuLuc.Khong + "\"" + (OPosition.HieuLuc == (int)eHieuLuc.Khong ? "checked" : string.Empty) + ">" + Model.Common.HieuLucs[OPosition.HieuLuc] + "</label> " +
                        "                       </div> " +
                        "                   </div> " +
                        "               </div>\r\n" +
        ...
        public static AjaxOut ServerSideAdd(RenderInfoCls ORenderInfo, string Ma, string Ten, int Stt, string MoTa, string HieuLuc)
        {
            ...
            try
            {
                ...
                DM_TieuChiThoiLuongDaoTaoTtCls OPosition = new DM_TieuChiThoiLuongDaoTaoTtCls();
                ...
                CallBussinessUtility.CreateBussinessProcess().CreateTieuChiThoiLuongDaoTaoTtProcess().Add(ORenderInfo, OPosition);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
        ...
        public static AjaxOut ServerSideUpdate(RenderInfoCls ORenderInfo, string Id, string Ma, string Ten, int Stt, string MoTa, string HieuLuc)
        {
            ...
            try
            {
                ...
                var OPositionOld = CallBussinessUtility.CreateBussinessProcess().CreateTieuChiThoiLuongDaoTaoTtProcess().CreateModel(ORenderInfo, Id);
                if (OPositionOld == null) throw new Exception(WebLanguage.GetLanguage(OSiteParam, "Tiêu chí đánh giá thời lượng đào tạo trực tuyến đã bị xóa hoặc không tìm thấy"));

                if (!OPositionOld.Ma.ToUpper().Equals(Ma.ToUpper()))
                    if (CallBussinessUtility.CreateBussinessProcess().CreateTieuChiThoiLuongDaoTaoTtProcess().CreateModel(ORenderInfo, Ma) != null) throw new Exception(WebLanguage.GetLanguage(OSiteParam, "Mã đã tồn tại không thể sửa được bản ghi!"));

                DM_TieuChiThoiLuongDaoTaoTtCls OPositionNew = new DM_TieuChiThoiLuongDaoTaoTtCls();
                OPositionNew.Ma = Ma;
                ...
                CallBussinessUtility.CreateBussinessProcess().CreateTieuChiThoiLuongDaoTaoTtProcess().Save(ORenderInfo, Id, OPositionNew);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
        ...
        public static AjaxOut ServerSideDelete(RenderInfoCls ORenderInfo, string Id)
        {
            ...
            try
            {
                SiteParam OSiteParam = WebEnvironments.CreateSiteParam(ORenderInfo);
                WebSession.CheckSessionTimeOut(ORenderInfo);
                CallBussinessUtility.CreateBussinessProcess().CreateTieuChiThoiLuongDaoTaoTtProcess().Delete(ORenderInfo, Id);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
        ...
        public static AjaxOut ServerSidePrint(RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                List<TieuChiThoiLuongDaoTaoTtView> Datas = new List<TieuChiThoiLuongDaoTaoTtView>();

                SiteParam
                      OSiteParam = WebEnvironments.CreateSiteParam(ORenderInfo);
                WebSession.CheckSessionTimeOut(ORenderInfo);

                DM_TieuChiThoiLuongDaoTaoTtFilterCls OTieuChiThoiLuongDaoTaoTt = new DM_TieuChiThoiLuongDaoTaoTtFilterCls() { HieuLuc = (int)eSearch.SearchAll };

                DM_TieuChiThoiLuongDaoTaoTtCls[] TieuChiThoiLuongDaoTaoTts = CallBussinessUtility.CreateBussinessProcess().CreateTieuChiThoiLuongDaoTaoTtProcess().Reading(ORenderInfo, OTieuChiThoiLuongDaoTaoTt);

                for (int i = 0; i < TieuChiThoiLuongDaoTaoTts.Length; i++)
                {

                    var view = new TieuChiThoiLuongDaoTaoTtView();
                    view.Ma = TieuChiThoiLuongDaoTaoTts[i].Ma;
                    view.Ten = TieuChiThoiLuongDaoTaoTts[i].Ten;
                    view.Stt = TieuChiThoiLuongDaoTaoTts[i].Stt;
                    view.MoTa = TieuChiThoiLuongDaoTaoTts[i].MoTa;
                    view.HieuLuc = TieuChiThoiLuongDaoTaoTts[i].HieuLuc.ToString();
                    view.NgayTao = TieuChiThoiLuongDaoTaoTts[i].NgayTao.ToString("dd/MM/yyyy");
                    view.TuNgay = TieuChiThoiLuongDaoTaoTts[i].TuNgay.Value.ToString("dd/MM/yyyy");
                    if (!string.IsNullOrEmpty(TieuChiThoiLuongDaoTaoTts[i].DenNgay.ToString()))
                    {
                        view.DenNgay = TieuChiThoiLuongDaoTaoTts[i].DenNgay.Value.ToString("dd/MM/yyyy");
                    }
                    view.GhiChu = TieuChiThoiLuongDaoTaoTts[i].GhiChu;

                    Datas.Add(view);
                }
                flexCelReport.AddTable("TieuChiThoiLuongDaoTaoTt", Datas);

                //flexCelReport.SetValue("NgayLap", DateTime.Now);

                string XmlFile = OSiteParam.PathRoot + "\\ReportTemplates\\TIEUCHITHOILUONGDAOTAOTT.xlsx";

                string Id = "DM_TieuChiThoiLuongDaoTaoTt_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xlsx";
                string LoginName = WebSessionUtility.GetCurrentLoginUser(OSiteParam).LoginName;
                ...
                RetAjaxOut = new OneTSQ.ReportUtility.FlexcelReportUtility().ExportEx(ORenderInfo, LoginName, XmlFile, "DM_TieuChiThoiLuongDaoTaoTt", flexCelReport, SaveFile);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
        ...
        public sealed class TieuChiThoiLuongDaoTaoTtView
        {
