...
{
    [ObjectReport(ID = "5CD4B233-B236-4AAF-B247-0B2FDE86523B", Type = Report.eType.Flexcel, Name = "PhieuXetNuocTieuPhanDichChocDo", Title = "Phiếu xét nghiệm nước tiểu", ReportPath = "\\ReportTemplates\\PhieuXNNuocTieuPhanDichChocDo.xlsx")]
    public class PhieuXetNuocTieuPhanDichChocDo : ObjectReport<XetNghiemDraw>
    {
        public override bool CanExecute(Model.RenderInfoCls ORenderInfo, string id)
        {
            ...
            if (xetnghiem != null)
            {
                ...
                if (dv != null)
                    return (dv.BaoCao == (byte)DanhMucDichVuCls.eBaoCao.TongPhanTichNuocTieu);
                else
                    return false;
            }
            return false;
