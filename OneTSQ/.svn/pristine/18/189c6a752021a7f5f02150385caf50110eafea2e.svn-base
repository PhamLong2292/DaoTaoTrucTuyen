       ...
       // private static readonly MemoryCache _cache = MemoryCache.Default;
        ...
        public override AjaxOut Reading(RenderInfoCls ORenderInfo, int PageIndex, string Keyword)
        {
            ...
            try
            {
                ...
                ODT_KhoaHocFilter.TrangThai = (int)DT_KhoaHocCls.eTrangThai.Duyet;
        ...
        public AjaxOut Reading(RenderInfoCls ORenderInfo, int PageIndex, string Keyword, string trangThai)
        {
            AjaxOut RetAjaxOut = new AjaxOut();
            try
            {
