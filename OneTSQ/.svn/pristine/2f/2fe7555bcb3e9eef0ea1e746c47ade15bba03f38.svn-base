...
{
    public class KyThuatChuyenGiao : WebPartTemplate
    {
        public override string WebPartId
        {
            get
            {
                return "KyThuatChuyenGiao";
            }
        }
        public override string WebPartTitle
        {
            get
            {
                return "Danh mục kỹ thuật chuyển giao";
            }
        }
        ...
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(KyThuatChuyenGiao), Page);
        }
        ...
        public override AjaxOut Draw(SiteParam OSiteParam, RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                XemPermission = user.IsSystemAdmin == 1|| PermissionUtility.CheckPermission(ORenderInfo, new KyThuatChuyenGiaoPermission().PermissionFunctionCode,
                    DM_KyThuatChuyenGiaoCls.ePermission.Xem.ToString(), new KyThuatChuyenGiaoPermission().PermissionFunctionCode,
                    KyThuatChuyenGiaoPermission.StaticPermissionFunctionId, userId, user.OwnerUserId , false);
                if (!XemPermission)
                {
                ...
                string filtemplate = WebConfig.GetWebHttpRoot() + "/temp/ImportDM_KYTHUATCHUYENGIAO.xlsx";
                RetAjaxOut.HtmlContent =
                      WebEnvironments.ProcessHtml(
                        ...
                        "         <h5>" + WebLanguage.GetLanguage(OSiteParam, "Kỹ thuật chuyển giao") + "</h5> \r\n" +
                        "     </div> \r\n" +
                        ...
                        "         <div id=\"divKyThuatChuyenGiaoContent\">" + ServerSideDrawSearchResult(ORenderInfo, "", null, 0).HtmlContent + "</div>\r\n" +
                        "     </div> \r\n" +
                      ...
                      WebEnvironments.ProcessJavascript(
                        ...
                        "       AjaxOut  = OneTSQ.WebParts.KyThuatChuyenGiao.ServerSidePrint(CreateRenderInfo()).value;\r\n" +
                        "       if(AjaxOut.Error)\r\n" +
                        "       {\r\n" +
                        ...
                        "       OneTSQ.WebParts.KyThuatChuyenGiao.ServerSideDrawSearchResult(CreateRenderInfo(), Keyword, HieuLuc, _currentPageIndex, CallBackReading);\r\n" +
                        "   }\r\n" +

                        "   function CallBackReading(res)\r\n" +
                        "   {\r\n" +
                        "       document.getElementById('divProcessing').innerHTML='';\r\n" +
                        "       document.getElementById('divKyThuatChuyenGiaoContent').innerHTML = res.value.HtmlContent;\r\n" +
                        "       $('.confirm').focus(); " +
                        "   }\r\n" +
                        ...
                        "   {\r\n" +
                        "       AjaxOut = OneTSQ.WebParts.KyThuatChuyenGiao.ServerSideDrawAddForm(CreateRenderInfo()).value;\r\n" +
                        "       if(AjaxOut.Error) { \r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "           return;\r\n" +
                        "       }\r\n" +
                        "       document.getElementById('ModalTitle').innerHTML = '<span class=\"fa fa-pencil-square-o\">" + WebLanguage.GetLanguage(OSiteParam, " Thêm mới Kỹ thuật chuyển giao") + " </span>';\r\n" +
                        ...
                        "   {\r\n" +
                        "       AjaxOut = OneTSQ.WebParts.KyThuatChuyenGiao.ServerSideDrawUpdateForm(CreateRenderInfo(), Id).value;\r\n" +
                        "       if(AjaxOut.Error) { \r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "           return;\r\n" +
                        "       }\r\n" +
                        "       document.getElementById('ModalTitle').innerHTML = '<span class=\"fa fa-pencil-square-o\">" + WebLanguage.GetLanguage(OSiteParam, " Sửa thông tin Kỹ thuật chuyển giao") + " </span>';\r\n" +
                        "       document.getElementById('divModalContent').innerHTML = AjaxOut.HtmlContent; \r\n" +
                        "       $('#divFormModal').modal('show');\r\n" +
                        "       document.getElementById('txtMa').focus();\r\n" +
                        "   }\r\n" +
                        ...
                        "       AjaxOut = OneTSQ.WebParts.KyThuatChuyenGiao.ServerSideAdd(CreateRenderInfo(), Ma, Ten, Stt, MoTa, HieuLuc).value;\r\n" +
                        "       if(AjaxOut.Error) {\r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "           return;\r\n" +
                        "       }\r\n" +
                        "       callSweetAlert(\"" + WebLanguage.GetLanguage(OSiteParam, "Thêm mới Kỹ thuật chuyển giao thành công!") + "\");\r\n" +
                        ...
                        "       AjaxOut = OneTSQ.WebParts.KyThuatChuyenGiao.ServerSideUpdate(CreateRenderInfo(), Id, Ma, Ten, Stt, MoTa, HieuLuc).value;\r\n" +
                        "       if(AjaxOut.Error) {\r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "           return;\r\n" +
                        "       }\r\n" +
                        "       callSweetAlert(\"" + WebLanguage.GetLanguage(OSiteParam, "Sửa thông tin Kỹ thuật chuyển giao thành công!") + "\");\r\n" +
                        "       NextPage(_currentPageIndex);\r\n" +
                        "       CloseModal();\r\n" +
                        "   }\r\n" +
                        ...
                        "           }, function () { \r\n" +
                        "           AjaxOut = OneTSQ.WebParts.KyThuatChuyenGiao.ServerSideDelete(RenderInfo, id).value;\r\n" +
                        "           if(AjaxOut.Error) { \r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "               return;\r\n" +
                        "           }\r\n" +
                        "       callSweetAlert(\"" + WebLanguage.GetLanguage(OSiteParam, "Xóa thông tin Kỹ thuật chuyển giao thành công") + "!\");\r\n" +
                        "       NextPage(_currentPageIndex);\r\n" +
                        "       }); \r\n" +
                        "   }\r\n" +
                ...
                #region Import
                    ...
                    "               xhr.open(\"POST\", \"" + WebConfig.GetImportHandler(OSiteParam, SessionId, userId, LoginName, (int)ProcessImportHandlerUtility.eFileType.DM_KYTHUATCHUYENGIAO) + "\");\r\n" +
                    "               xhr.send(fd);\r\n" +
                    "           }\r\n" +
                    "       ); \r\n" +
                    "   }\r\n" +
 ...
 "</script>\r\n");
        ...
        public static AjaxOut ServerSideDrawSearchResult(RenderInfoCls ORenderInfo, string Keyword, string HieuLuc, int currentPageIndex)
        {
            ...
            try
            {
                ...
                DM_KyThuatChuyenGiaoFilterCls OPositionFilter = new DM_KyThuatChuyenGiaoFilterCls()
                {
                    Keyword = Keyword,
                ...
                DM_KyThuatChuyenGiaoCls[] Positions = CallBussinessUtility.CreateBussinessProcess().CreateKyThuatChuyenGiaoProcess().ReadingWithPaging(ORenderInfo, OPositionFilter);
                var countPosition = CallBussinessUtility.CreateBussinessProcess().CreateKyThuatChuyenGiaoProcess().Count(ORenderInfo, OPositionFilter);
                ...
                else
                {
                    ...
                    for (int iIndex = 0; iIndex < Positions.Length; iIndex++)
                    {
                        Html.Append(
                            ...
                            "                     <td class=\"td-center\" style=\"text-align:center;\"><a title=\"" + "" + WebLanguage.GetLanguage(OSiteParam, "Sửa Kỹ thuật chuyển giao") + "" + "\" href=\"javascript:ServerSideDrawUpdateForm('" + Positions[iIndex].Id + "');\"><i class=\"" + WebScreen.GetEditGridIcon() + "\"></i></a> &nbsp; <a title=\"" + "Xóa Kỹ thuật chuyển giao" + "\" href=\"javascript:ServerSideDelete('" + Positions[iIndex].Id + "');\"><i class=\"" + WebScreen.GetDeleteGridIcon() + "\"></i></a></td> \r\n" +
                            "                 </tr> \r\n");
                    }
                    Html.Append(
                        "                 </tbody> \r\n" +
        ...
        public static AjaxOut ServerSideDrawAddForm(RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                string Html =
                        ...
                        "                   <label for=\"inputTo\">" + WebLanguage.GetLanguage(OSiteParam, "Mã Kỹ thuật chuyển giao") + " <span style='color:red'>*</span></label>\r\n" +
                        ...
                        "           <div class=\"col-xs-12 col-sm-12 col-md-12\">\r\n" +
                        "               <div class=\"form-group\">\r\n" +
                        "                   <label for=\"inputSubject\">" + WebLanguage.GetLanguage(OSiteParam, "Tên Kỹ thuật chuyển giao") + " <span style='color:red'>*</span></label>\r\n" +
                        ...
                        "                   <div> \r\n" +
                        "                       <label class=\"radio-inline\"><input  id = \"optradioHl0\" type = \"radio\" name=\"optradioHl\" value=\"" + (int)eHieuLuc.Co + "\" checked>" + Model.Common.HieuLucs[(int)OneTSQ.Model.eHieuLuc.Co] + "</label> " +
                        "                       <label class=\"radio-inline\"><input  id = \"optradioHl1\" type = \"radio\" name=\"optradioHl\" value=\"" + (int)eHieuLuc.Khong + "\">" + Model.Common.HieuLucs[(int)OneTSQ.Model.eHieuLuc.Khong] + "</label> " +
                        "                   </div> " +
                        "               </div> " +
                        "           </div>\r\n" +
        ...
        public static AjaxOut ServerSideDrawUpdateForm(RenderInfoCls ORenderInfo, string Id)
        {
            ...
            try
            {
                ...
                var OPosition = CallBussinessUtility.CreateBussinessProcess().CreateKyThuatChuyenGiaoProcess().CreateModel(ORenderInfo, Id);
                if (OPosition == null) throw new Exception(WebLanguage.GetLanguage(OSiteParam, "Kỹ thuật chuyển giao đã bị xóa hoặc không tìm thấy"));
                ...
                string Html =
                     "<form id=\"sendmail\" data-async  method=\"post\" onSubmit=\"return false;\" role=\"form\" class=\"contactForm\">\r\n" +
                        ...
                        "                       <label for=\"inputSubject\">" + WebLanguage.GetLanguage(OSiteParam, "Trạng thái") + "</label>\r\n" +
                        "                       <div> \r\n" +
                        "                           <label class=\"radio-inline\"><input  id = \"optradioHl0\" type = \"radio\" name=\"optradioHl\" value=\"" + (int)eHieuLuc.Co + "\"" + (OPosition.HieuLuc == (int)OneTSQ.Model.eHieuLuc.Co ? "checked" : string.Empty) + ">" + Model.Common.HieuLucs[(int)OneTSQ.Model.eHieuLuc.Co] + "</label> " +
                        "                           <label class=\"radio-inline\"><input  id = \"optradioHl1\" type = \"radio\" name=\"optradioHl\" value=\"" + (int)eHieuLuc.Khong + "\"" + (OPosition.HieuLuc == (int)OneTSQ.Model.eHieuLuc.Khong ? "checked" : string.Empty) + ">" + Model.Common.HieuLucs[(int)OneTSQ.Model.eHieuLuc.Khong] + "</label> " +
                        "                       </div> " +
                        "                   </div> " +
                        "               </div>\r\n" +
        ...
        public static AjaxOut ServerSideAdd(RenderInfoCls ORenderInfo, string Ma, string Ten, int Stt, string MoTa, string HieuLuc)
        {
            ...
            try
            {
                ...
                DM_KyThuatChuyenGiaoCls OPosition = new DM_KyThuatChuyenGiaoCls();
                ...
                if (OPosition.HieuLuc == (int)OneTSQ.Model.eHieuLuc.Co) OPosition.TuNgay = DateTime.Now;
                CallBussinessUtility.CreateBussinessProcess().CreateKyThuatChuyenGiaoProcess().Add(ORenderInfo, OPosition);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
        ...
        public static AjaxOut ServerSideUpdate(RenderInfoCls ORenderInfo, string Id, string Ma, string Ten, int Stt, string MoTa, string HieuLuc)
        {
            ...
            try
            {
                ...
                var OPositionOld = CallBussinessUtility.CreateBussinessProcess().CreateKyThuatChuyenGiaoProcess().CreateModel(ORenderInfo, Id);
                if (OPositionOld == null) throw new Exception(WebLanguage.GetLanguage(OSiteParam, "Kỹ thuật chuyển giao đã bị xóa hoặc không tìm thấy"));

                if (!OPositionOld.Ma.ToUpper().Equals(Ma.ToUpper()))
                    if (CallBussinessUtility.CreateBussinessProcess().CreateKyThuatChuyenGiaoProcess().CreateModel(ORenderInfo, Ma) != null) throw new Exception(WebLanguage.GetLanguage(OSiteParam, "Mã đã tồn tại không thể sửa được bản ghi!"));

                DM_KyThuatChuyenGiaoCls OPositionNew = new DM_KyThuatChuyenGiaoCls();
                OPositionNew.Ma = Ma;
                ...
                CallBussinessUtility.CreateBussinessProcess().CreateKyThuatChuyenGiaoProcess().Save(ORenderInfo, Id, OPositionNew);
        ...
        public static AjaxOut ServerSideDelete(RenderInfoCls ORenderInfo, string Id)
        {
            ...
            try
            {
                SiteParam OSiteParam = WebEnvironments.CreateSiteParam(ORenderInfo);
                WebSession.CheckSessionTimeOut(ORenderInfo);
                CallBussinessUtility.CreateBussinessProcess().CreateKyThuatChuyenGiaoProcess().Delete(ORenderInfo, Id);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
        ...
        public static string ConditionGhiChu(DM_KyThuatChuyenGiaoCls OPosition, string Ma, string Ten, int Stt, int HieuLuc, ref int ConditionAdd)
        {
        ...
        public static AjaxOut ServerSidePrint(RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                List<KyThuatChuyenGiaoView> Datas = new List<KyThuatChuyenGiaoView>();

                SiteParam
                      OSiteParam = WebEnvironments.CreateSiteParam(ORenderInfo);
                WebSession.CheckSessionTimeOut(ORenderInfo);

                DM_KyThuatChuyenGiaoFilterCls OKyThuatChuyenGiao = new DM_KyThuatChuyenGiaoFilterCls() { HieuLuc = (int)OneTSQ.Model.eSearch.SearchAll };
                DM_KyThuatChuyenGiaoCls[] KyThuatChuyenGiaos = CallBussinessUtility.CreateBussinessProcess().CreateKyThuatChuyenGiaoProcess().Reading(ORenderInfo, OKyThuatChuyenGiao);

                for (int i = 0; i < KyThuatChuyenGiaos.Length; i++)
                {

                    var view = new KyThuatChuyenGiaoView();
                    view.Ma = KyThuatChuyenGiaos[i].Ma;
                    view.Ten = KyThuatChuyenGiaos[i].Ten;
                    view.Stt = KyThuatChuyenGiaos[i].Stt;
                    view.MoTa = KyThuatChuyenGiaos[i].MoTa;
                    view.HieuLuc = KyThuatChuyenGiaos[i].HieuLuc.ToString();
                    view.NgayTao = KyThuatChuyenGiaos[i].NgayTao.ToString("dd/MM/yyyy");
                    view.TuNgay = KyThuatChuyenGiaos[i].TuNgay.Value.ToString("dd/MM/yyyy");
                    if (!string.IsNullOrEmpty(KyThuatChuyenGiaos[i].DenNgay.ToString()))
                    {
                        view.DenNgay = KyThuatChuyenGiaos[i].DenNgay.Value.ToString("dd/MM/yyyy");
                    }
                    view.GhiChu = KyThuatChuyenGiaos[i].GhiChu;

                    Datas.Add(view);
                }
                flexCelReport.AddTable("KyThuatChuyenGiao", Datas);

                //flexCelReport.SetValue("NgayLap", DateTime.Now);

                string XmlFile = OSiteParam.PathRoot + "\\ReportTemplates\\KyThuatChuyenGiao.xlsx";

                string Id = "DM_KyThuatChuyenGiao_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xlsx";
                string LoginName = WebSessionUtility.GetCurrentLoginUser(OSiteParam).LoginName;
                ...
                RetAjaxOut = new OneTSQ.ReportUtility.FlexcelReportUtility().ExportEx(ORenderInfo, LoginName, XmlFile, "DM_KyThuatChuyenGiao", flexCelReport, SaveFile);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
        ...
        public sealed class KyThuatChuyenGiaoView
        {
        ...
        public override string divFilter
        {
            get
            {
                return "<div class=\"col-md-3\" style=\"padding-top: 6px; padding-bottom: 6px;\">\r\n" +
                       ...
                       "        <option></option>\r\n" +
                       "        <option value=\"" + (int)eHieuLuc.Co + "\">" + Model.Common.HieuLucs[(int)OneTSQ.Model.eHieuLuc.Co] + "</option>\r\n" +
                       "        <option value=\"" + (int)eHieuLuc.Khong + "\">" + Model.Common.HieuLucs[(int)OneTSQ.Model.eHieuLuc.Khong] + "</option>\r\n" +
                       "    </select>\r\n" +
                       "</div>\r\n" +
