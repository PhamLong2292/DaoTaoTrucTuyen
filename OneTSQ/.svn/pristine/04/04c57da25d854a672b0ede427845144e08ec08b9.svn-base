...
{
    public class DM_NhomKhoaHoc : WebPartTemplate
    {
        public override string WebPartId
        {
            get
            {
                return "DM_NhomKhoaHoc";
            }
        }
        ...
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(DM_NhomKhoaHoc), Page);
        }
            ...
            try
            {
                ...
                RetAjaxOut.HtmlContent =
                      WebEnvironments.ProcessHtml(
                        ...
                        "         <h5>" + WebLanguage.GetLanguage(OSiteParam, "Nhóm khóa học") + "</h5> \r\n" +
                        "     </div> \r\n" +
                ...
                #region Import
                    ...
                    "               xhr.open(\"POST\", \"" + WebConfig.GetImportHandler(OSiteParam, SessionId, userId, LoginName, (int)ProcessImportHandlerUtility.eFileType.DM_NHOMKHOAHOC) + "\");\r\n" +
                    "               xhr.send(fd);\r\n" +
                    "           }\r\n" +
                    "       ); \r\n" +
                    "   }\r\n" +
 ...
 "</script>\r\n");
        ...
        public static AjaxOut ServerSideDrawAddForm(RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                string Html =
                        ...
                        "                   <label for=\"inputTo\">" + WebLanguage.GetLanguage(OSiteParam, "Mã Nhóm khóa học") + " <span style='color:red'>*</span></label>\r\n" +
                        ...
                        "           <div class=\"col-xs-12 col-sm-12 col-md-12\">\r\n" +
                        "               <div class=\"form-group\">\r\n" +
                        "                   <label for=\"inputSubject\">" + WebLanguage.GetLanguage(OSiteParam, "Tên Nhóm khóa học") + " <span style='color:red'>*</span></label>\r\n" +
        ...
        public static AjaxOut ServerSideDrawUpdateForm(RenderInfoCls ORenderInfo, string Id)
        {
            ...
            try
            {
                ...
                var OPosition = CallBussinessUtility.CreateBussinessProcess().CreateDM_NhomKhoaHocProcess().CreateModel(ORenderInfo, Id);
                if (OPosition == null) throw new Exception(WebLanguage.GetLanguage(OSiteParam, "Nhóm khóa học đã bị xóa hoặc không tìm thấy"));
        ...
        public static AjaxOut ServerSideAdd(RenderInfoCls ORenderInfo, string Ma, string Ten, int Stt, string MoTa, string HieuLuc)
        {
            ...
            try
            {
                ...
                DM_NhomKhoaHocCls OPosition = new DM_NhomKhoaHocCls();
                ...
                CallBussinessUtility.CreateBussinessProcess().CreateDM_NhomKhoaHocProcess().Add(ORenderInfo, OPosition);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
        ...
        public static AjaxOut ServerSideUpdate(RenderInfoCls ORenderInfo, string Id, string Ma, string Ten, int Stt, string MoTa, string HieuLuc)
        {
            ...
            try
            {
                ...
                var OPositionOld = CallBussinessUtility.CreateBussinessProcess().CreateDM_NhomKhoaHocProcess().CreateModel(ORenderInfo, Id);
                if (OPositionOld == null) throw new Exception(WebLanguage.GetLanguage(OSiteParam, "Nhóm khóa học đã bị xóa hoặc không tìm thấy"));

                if (!OPositionOld.Ma.ToUpper().Equals(Ma.ToUpper()))
                    if (CallBussinessUtility.CreateBussinessProcess().CreateDM_NhomKhoaHocProcess().CreateModel(ORenderInfo, Ma) != null) throw new Exception(WebLanguage.GetLanguage(OSiteParam, "Mã đã tồn tại không thể sửa được bản ghi!"));

                DM_NhomKhoaHocCls OPositionNew = new DM_NhomKhoaHocCls();
                OPositionNew.Ma = Ma;
                ...
                CallBussinessUtility.CreateBussinessProcess().CreateDM_NhomKhoaHocProcess().Save(ORenderInfo, Id, OPositionNew);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
        ...
        public static AjaxOut ServerSideDelete(RenderInfoCls ORenderInfo, string Id)
        {
            ...
            try
            {
                SiteParam OSiteParam = WebEnvironments.CreateSiteParam(ORenderInfo);
                WebSession.CheckSessionTimeOut(ORenderInfo);
                CallBussinessUtility.CreateBussinessProcess().CreateDM_NhomKhoaHocProcess().Delete(ORenderInfo, Id);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
        ...
        public static string ConditionGhiChu(DM_NhomKhoaHocCls OPosition, string Ma, string Ten, int Stt, int HieuLuc, ref int ConditionAdd)
        {
        ...
        public static AjaxOut ServerSidePrint(RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                List<DM_NhomKhoaHocView> Datas = new List<DM_NhomKhoaHocView>();

                SiteParam
                      OSiteParam = WebEnvironments.CreateSiteParam(ORenderInfo);
                WebSession.CheckSessionTimeOut(ORenderInfo);

                DM_NhomKhoaHocFilterCls ODM_NhomKhoaHoc = new DM_NhomKhoaHocFilterCls() { HieuLuc = (int)eSearch.SearchAll };
                DM_NhomKhoaHocCls[] DM_NhomKhoaHocs = CallBussinessUtility.CreateBussinessProcess().CreateDM_NhomKhoaHocProcess().Reading(ORenderInfo, ODM_NhomKhoaHoc);

                for (int i = 0; i < DM_NhomKhoaHocs.Length; i++)
                {

                    var view = new DM_NhomKhoaHocView();
                    view.Ma = DM_NhomKhoaHocs[i].Ma;
                    view.Ten = DM_NhomKhoaHocs[i].Ten;
                    view.Stt = DM_NhomKhoaHocs[i].Stt;
                    view.MoTa = DM_NhomKhoaHocs[i].MoTa;
                    view.HieuLuc = DM_NhomKhoaHocs[i].HieuLuc.ToString();
                    view.NgayTao = DM_NhomKhoaHocs[i].NgayTao.ToString("dd/MM/yyyy");
                    view.TuNgay = DM_NhomKhoaHocs[i].TuNgay.Value.ToString("dd/MM/yyyy");
                    if (!string.IsNullOrEmpty(DM_NhomKhoaHocs[i].DenNgay.ToString()))
                    {
                        view.DenNgay = DM_NhomKhoaHocs[i].DenNgay.Value.ToString("dd/MM/yyyy");
                    }
                    view.GhiChu = DM_NhomKhoaHocs[i].GhiChu;

                    Datas.Add(view);
                }
                flexCelReport.AddTable("NhomKhoaHoc", Datas);
                string XmlFile = OSiteParam.PathRoot + "\\ReportTemplates\\DM_NhomKhoaHoc.xlsx";

                string Id = "DM_NhomKhoaHoc_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xlsx";
                string LoginName = WebSessionUtility.GetCurrentLoginUser(OSiteParam).LoginName;
                ...
                RetAjaxOut = new OneTSQ.ReportUtility.FlexcelReportUtility().ExportEx(ORenderInfo, LoginName, XmlFile, "DM_NhomKhoaHoc", flexCelReport, SaveFile);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
        ...
        public sealed class DM_NhomKhoaHocView
        {
