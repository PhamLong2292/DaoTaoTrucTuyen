...
<script runat="server">
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string Loai = OneTSQ.Utility.WebEnvironments.Request("Loai");
        ...
        OneTSQ.Core.Model.AjaxOut
            RetAjaxOut = OneTSQ.Utility.RemoteDataUtility.Find(ServiceId).Reading(ORenderInfo, iPage, q, new object[] { Loai });
