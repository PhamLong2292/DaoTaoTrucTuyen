...
namespace OneTSQ.Call.Bussiness.Ws
{
    public class DM_TrangThietBiTruyenHinhTtProcessBll : DM_TrangThietBiTruyenHinhTtTemplate
    {
        ...
        public override DM_TrangThietBiTruyenHinhTtCls[] Reading(RenderInfoCls ORenderInfo, DM_TrangThietBiTruyenHinhTtFilterCls OTrangThietBiTruyenHinhTtFilter)
        {
        ...
        public override long Count(RenderInfoCls ORenderInfo, DM_TrangThietBiTruyenHinhTtFilterCls OTrangThietBiTruyenHinhTtFilter)
        {
            ActionSqlParamCls ActionSqlParam = WebEnvironments.CreateActionSqlParam(ORenderInfo);
        ...
        public override DM_TrangThietBiTruyenHinhTtCls[] ReadingWithPaging(RenderInfoCls ORenderInfo, DM_TrangThietBiTruyenHinhTtFilterCls OTrangThietBiTruyenHinhTtFilter, int PageIndex, int PageSize)
        {
            ActionSqlParamCls ActionSqlParam = WebEnvironments.CreateActionSqlParam(ORenderInfo);
