...
namespace OneTSQ.Bussiness.Sql
{
    public class PhieuBaoCaoPhanUngCoHaiADRProcessBll : PhieuBaoCaoPhanUngCoHaiADRTemplate
    {
        ...
        public override PhieuBaoCaoPhanUngCoHaiADRCls[] Reading(  ActionSqlParamCls ActionSqlParam, PhieuBaoCaoPhanUngCoHaiADRFilterCls OPhieuBaoCaoPhanUngCoHaiADRFilter)
        {
        ...
        public override PhieuBaoCaoPhanUngCoHaiADRCls[] PageReading(ActionSqlParamCls ActionSqlParam, PhieuBaoCaoPhanUngCoHaiADRFilterCls OPhieuBaoCaoPhanUngCoHaiADRFilter, ref long recordTotal)
        {
            ...
            try
            {
                ...
                {
                    Query += " and (upper(SOBCDONVI) like UPPER('%" + OPhieuBaoCaoPhanUngCoHaiADRFilter.Keyword + "%') OR upper(HOTEN) like UPPER(N'%" + OPhieuBaoCaoPhanUngCoHaiADRFilter.Keyword + "%')) ";
                    recordTotalQuery += " and (upper(SOBCDONVI) like UPPER('%" + OPhieuBaoCaoPhanUngCoHaiADRFilter.Keyword + "%') OR upper(HOTEN) like UPPER(N'%" + OPhieuBaoCaoPhanUngCoHaiADRFilter.Keyword + "%')) ";
                }
        ...
        public override PhieuBaoCaoPhanUngCoHaiADRCls CreateModel(ActionSqlParamCls ActionSqlParam, string ID)
        {
            ...
            {
                DataSet dsResult =
                        DBService.GetDataSet(ActionSqlParam.Trans, "select * from PhieuBaoCaoPhanUngCoHaiADR where (ID =" + ActionSqlParam.SpecialChar + "ID or SOBCDONVI =" + ActionSqlParam.SpecialChar + "ID or MABN =" + ActionSqlParam.SpecialChar + "ID)", new DbParam[]{
                    new DbParam("ID",ID)
                    });
