...
{   
    public class DanhSachPhanTichNguyenNhanSuCo : WebPartTemplate
    {
        ...
        public override AjaxOut Draw(SiteParam OSiteParam, RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                RetAjaxOut.HtmlContent =
                    ...
                    "       AjaxOut = OneTSQ.WebParts.DanhSachPhanTichNguyenNhanSuCo.DrawSearchResult(RenderInfo, CurrentPageIndex, keyword, NguoiLap, trangThai).value;\r\n" +
                ...
                #region html
                    ...
                    "           <div id=\"divnguyennhansuco\">" + DanhSachPhanTichNguyenNhanSuCo.DrawSearchResult(ORenderInfo, pageIndex, keyword, NguoiLap_ID, trangThai).HtmlContent + "</div>\r\n" +
                    "     </div> \r\n" +
                    " </div>\r\n" +
                    "</div>\r\n"
                        );
        ...
        public static AjaxOut DrawSearchResult(RenderInfoCls ORenderInfo, int PageIndex, string keyword, string NguoiLap, int? trangThai)
        {
            AjaxOut RetAjaxOut = new AjaxOut();
            try
            {
                ...
                for (int iIndex = 0; iIndex < dangKyTotal; iIndex++)
                {
                    ...
                    if (Users != null)
                    {
                        ...
                        "                     <td style='text-align: center; vertical-align: middle;'><a href='" + BaoCaoSuCoUrl + "' title='" + WebLanguage.GetLanguage(OSiteParam, "Mở phiếu") + "'>" + nguyennhansuco[iIndex].THOIGIANLAP.Value.ToString("HH:mm dd/MM/yyyy") + "</a></td> \r\n" +                      
        ...
        public override string divFilter
        {
            get
            {
                return "<div class=\"col-md-3\" style=\"padding-top: 6px; padding-bottom: 6px;\">\r\n" +
                       "    <input id=\"txtKeyword\" placeholder=\"Tìm kiếm theo mã số\" class=\"form-control valueForm\" style=\"border-radius: 4px;\">\r\n" +
                       "</div>\r\n" +
