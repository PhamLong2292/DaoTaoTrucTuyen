...
{
    public class MenuTemplate : WebPartTemplate
    {
        ...
        public override string WebPartTitle
        {
            get
            {
                return "Danh mục menu chức năng";
            }
        }
        ...
        {
           AjaxPro.Utility.RegisterTypeForAjax(typeof(MenuTemplate),Page);
        }
        ...
        public override AjaxOut Draw(SiteParam OSiteParam, RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                RetAjaxOut.HtmlContent =
                    ...
                    "       AjaxOut = OnlineTour.WebParts.MenuTemplate.ServerSideDrawAddForm(RenderInfo).value;\r\n" +
                    ...
                    "       document.getElementById('txtMenuTemplateName').focus();\r\n" +
                    "   }\r\n" +


                    "   function CallUpdateForm(MenuTemplateId)\r\n" +
                    "   {\r\n" +
                    "       RenderInfo=CreateRenderInfo();\r\n" +
                    "       AjaxOut = OnlineTour.WebParts.MenuTemplate.ServerSideDrawUpdateForm(RenderInfo, MenuTemplateId).value;\r\n" +
                    "       document.getElementById('divActionForm').innerHTML=AjaxOut.HtmlContent;\r\n" +
                    "       document.getElementById('divActionForm').style.display='block';\r\n" +
                    "       document.getElementById('divListForm').style.display='none';\r\n" +
                    "       document.getElementById('txtMenuTemplateName').focus();\r\n" +
                    ...
                    "   function CallConfig(MenuTemplateId)\r\n" +
                    "   {\r\n" +
                    "       RenderInfo=CreateRenderInfo();\r\n" +
                    "       AjaxOut = OnlineTour.WebParts.MenuTemplate.ServerSideConfig(RenderInfo, MenuTemplateId).value;\r\n" +
                    ...
                    "   {\r\n" +
                    "       RenderInfo=CreateRenderInfo();\r\n" +
                    "       MenuTemplateName = document.getElementById('txtMenuTemplateName').value;\r\n" +
                    "       SortIndex = document.getElementById('txtSortIndex').value;\r\n" +
                    "       Active = parseInt(document.getElementById('drpSelectActive').value,10);\r\n" +
                    "       AjaxOut = OnlineTour.WebParts.MenuTemplate.ServerSideAdd(RenderInfo, MenuTemplateName, SortIndex, Active).value;\r\n" +
                    "       if(AjaxOut.Error)\r\n"+
                    "       {\r\n"+
                    ...
                    "       }\r\n"+
                    "       CallReading();\r\n"+
                    "       document.getElementById('txtMenuTemplateName').value='';\r\n"+
                    "       document.getElementById('txtMenuTemplateName').focus();\r\n" +
                    "       document.getElementById('txtSortIndex').value=parseInt(SortIndex,10)+1;\r\n"+
                    "   }\r\n" +


                    "   function CallActionUpdate(MenuTemplateId)\r\n" +
                    "   {\r\n" +
                    "       RenderInfo=CreateRenderInfo();\r\n" +
                    "       MenuTemplateName = document.getElementById('txtMenuTemplateName').value;\r\n" +
                    "       SortIndex = document.getElementById('txtSortIndex').value;\r\n" +
                    "       Active = parseInt(document.getElementById('drpSelectActive').value,10);\r\n" +
                    "       AjaxOut = OnlineTour.WebParts.MenuTemplate.ServerSideUpdate(RenderInfo, MenuTemplateId, MenuTemplateName, SortIndex, Active).value;\r\n" +
                    "       if(AjaxOut.Error)\r\n" +
                    "       {\r\n" +
                    "           callSweetAlert(AjaxOut.InfoMessage);\r\n" +
                    "           return;\r\n" +
                    ...
                    "   function CallActionDelete(MenuTemplateId)\r\n" +
                    "   {\r\n" +
                    "       RenderInfo=CreateRenderInfo();\r\n" +
                    ...
                    "           AjaxOut = OnlineTour.WebParts.MenuTemplate.ServerSideDelete(RenderInfo, MenuTemplateId).value;\r\n" +
                    "           if(AjaxOut.Error)\r\n" +
                    "           {\r\n" +
                    "               callSweetAlert(AjaxOut.InfoMessage);\r\n" +
                    "               return;\r\n" +
                    ...
                    "       OnlineTour.WebParts.MenuTemplate.MenuTemplates(RenderInfo, Keyword, CallBackReading);\r\n" +
                    "   }\r\n" +
                    ...
                    "       document.getElementById('divMenuTemplateContent').innerHTML=AjaxOut.HtmlContent;\r\n" +
                    "   }\r\n" +
                    ...
                    WebEnvironments.EncryptHtml(
                        ...
                        "         <h5>" + WebLanguage.GetLanguage(OSiteParam, "Danh mục menu chức năng") + " </h5> \r\n" +
                        "     </div> \r\n" +
                        ...
                        "               <div id=\"divMenuTemplateContent\">"+  MenuTemplates(ORenderInfo,"").HtmlContent +"</div>\r\n"+
                        "         </div> \r\n" +
                        "     </div> \r\n" +
                        " </div> \r\n" +
        ...
        public static AjaxOut MenuTemplates(RenderInfoCls ORenderInfo,string Keyword)
        {
            AjaxOut RetAjaxOut = new AjaxOut();
            try
            {
                ...
                OMenuTemplateFilter.Keyword = Keyword;
                ...
                {
                    Html +=
                        "   <div class=\"search-result-info\">"+WebLanguage.GetLanguage(OSiteParam,"Tìm thấy")+" ("+MenuTemplates.Length.ToString("#,##0")+") "+WebLanguage.GetLanguage(OSiteParam,"dữ liệu theo điều kiện lọc")+"</div>\r\n"+
                        "         <div class=\"table-responsive\"> \r\n" +
                        "             <table class=\"table table-striped\"> \r\n" +
                        "                 <thead> \r\n" +
                        "                 <tr> \r\n" +
                        "                     <th class=\"th-func-20\"></th> \r\n" +
                        "                     <th>" + WebLanguage.GetLanguage(OSiteParam, "Tên menu chức năng") + " </th> \r\n" +
                    ...
                    for (int iIndex = 0; iIndex < MenuTemplates.Length; iIndex++)
                    {
                        Html +=
                            ...
                            "                     <td>" + MenuTemplates[iIndex].MenuTemplateName + "</td> \r\n" +
                            "                     <td>" + (MenuTemplates[iIndex].Active == 1 ? WebLanguage.GetLanguage(OSiteParam, "Sử dụng") : WebLanguage.GetLanguage(OSiteParam, "Ngưng sử dụng")) + "</td> \r\n" +
                            "                     <td class=\"td-center\"><a title=\"" + WebLanguage.GetLanguage(OSiteParam, "Sửa menu chức năng") + "\" href=\"javascript:CallConfig('" + MenuTemplates[iIndex].MenuTemplateId + "');\"><i class=\"" + WebScreen.GetConfigGridIcon() + "\"></i></a></td> \r\n" +
                            "                     <td class=\"td-center\"><a title=\"" + WebLanguage.GetLanguage(OSiteParam, "Sửa menu chức năng") + "\" href=\"javascript:CallUpdateForm('" + MenuTemplates[iIndex].MenuTemplateId + "');\"><i class=\""+WebScreen.GetEditGridIcon()+"\"></i></a></td> \r\n" +
                            "                     <td class=\"td-center\"><a title=\"" + WebLanguage.GetLanguage(OSiteParam, "Xóa menu chức năng") + "\" href=\"javascript:CallActionDelete('" + MenuTemplates[iIndex].MenuTemplateId + "');\"><i class=\""+WebScreen.GetDeleteGridIcon()+"\"></i></a></td> \r\n" +
                            "                 </tr> \r\n";
                    }
                    Html +=
                        "                 </tbody> \r\n" +
            ...
            try
            {
                ...
                string Html =
                    ...
                    "         <div class=\"col-sm-12\"><h3 class=\"m-t-none m-b\">" + WebLanguage.GetLanguage(OSiteParam, "Thêm mới") + "</h3> \r\n" +
                       "             <div> \r\n" +
                       "                 <div class=\"form-group\"><label>" + WebLanguage.GetLanguage(OSiteParam, "Tên menu chức năng") + "</label> <input id=\"txtMenuTemplateName\" type=\"textbox\" placeholder=\"" + WebLanguage.GetLanguage(OSiteParam, "Nhập tên menu chức năng") + "\" class=\"form-control\"></div> \r\n" +
        ...
        [AjaxPro.AjaxMethod(AjaxPro.HttpSessionStateRequirement.ReadWrite)]
        public static AjaxOut ServerSideConfig(RenderInfoCls ORenderInfo, string MenuTemplateId)
        {
            AjaxOut RetAjaxOut = new AjaxOut();
            try
            {
                ...
                RetAjaxOut.RetUrl = WebScreen.BuildUrl(OwnerCode, new MenuTemplateGroupFunction().WebPartId,
                    new WebParamCls[]
                    {
                        new WebParamCls("MenuTemplateId",MenuTemplateId)
                    });
            }
            catch (Exception ex)
            {
        ...
        [AjaxPro.AjaxMethod(AjaxPro.HttpSessionStateRequirement.ReadWrite)]
        public static AjaxOut ServerSideDrawUpdateForm(RenderInfoCls ORenderInfo, string MenuTemplateId)
        {
            AjaxOut RetAjaxOut = new AjaxOut();
            try
            {
                ...
                string Html =
                       ...
                       "             <div> \r\n" +
                       "                 <div class=\"form-group\"><label>" + WebLanguage.GetLanguage(OSiteParam, "Tên menu chức năng") + "</label> <input id=\"txtMenuTemplateName\" value=\"" + OMenuTemplate.MenuTemplateName + "\" type=\"textbox\" placeholder=\"" + WebLanguage.GetLanguage(OSiteParam, "Nhập tên menu chức năng") + "\" class=\"form-control\"></div> \r\n" +
                       "                 <div class=\"form-group\"><label>" + WebLanguage.GetLanguage(OSiteParam, "Thứ tự sắp xếp") + "</label> <input id=\"txtSortIndex\" value=\"" + OMenuTemplate.SortIndex + "\" type=\"textbox\" placeholder=\"" + WebLanguage.GetLanguage(OSiteParam, "Thứ tự sắp xếp") + "\" class=\"form-control\"></div> \r\n" +
                       "                 <div class=\"form-group\"><label>" + WebLanguage.GetLanguage(OSiteParam, "Trạng thái") + "</label> " + SelectActiveText + "</div> \r\n" +
                       "                 <div> \r\n" +
                       "                     <button class=\"btn btn-sm btn-primary m-t-n-xs mr-5px\" type=\"button\" onclick=\"javascript:CallActionUpdate('" + MenuTemplateId + "');\"><strong>" + WebLanguage.GetLanguage(OSiteParam, "Chấp nhận") + "</strong></button> \r\n" +
                       "                     <button class=\"btn btn-sm btn-primary m-t-n-xs\" type=\"button\" onclick=\"javascript:CallBack();\"><strong>" + WebLanguage.GetLanguage(OSiteParam, "Bỏ qua") + "</strong></button> \r\n" +
                       "                 </div> \r\n" +
                       "             </div> \r\n" +
                       "         </div> \r\n" +
            ...
            int Active)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(MenuTemplateName)) throw new Exception(WebLanguage.GetLanguage(OSiteParam, "Tên menu chức năng không hợp lệ"));
                ...
                MenuTemplateCls 
                    OMenuTemplate = new MenuTemplateCls();
                OMenuTemplate.MenuTemplateId = System.Guid.NewGuid().ToString();
                OMenuTemplate.MenuTemplateName = MenuTemplateName;
                OMenuTemplate.SortIndex = int.Parse(SortIndex);
                OMenuTemplate.Active = Active;

                OnlineTourBussinessUtility.CreateBussinessProcess().CreateMenuTemplateProcess().Add(OActionSqlParam, OMenuTemplate);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
            ...
            int    Active)
        {
            ...
            try
            {
                ...
                OMenuTemplate.SortIndex = int.Parse(SortIndex);
                OMenuTemplate.Active = Active;
                OnlineTourBussinessUtility.CreateBussinessProcess().CreateMenuTemplateProcess().Save(OActionSqlParam, MenuTemplateId, OMenuTemplate);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
            ...
            string MenuTemplateId)
        {
            ...
            try
            {
                ...
                OnlineTourBussinessUtility.CreateBussinessProcess().CreateMenuTemplateProcess().Delete(OActionSqlParam, MenuTemplateId);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
