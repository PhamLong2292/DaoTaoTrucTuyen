...
{
    public class ProcessingBookingList : WebPartTemplate
    {
        public override string WebPartId
        {
            get
            {
                return "ProcessingBookingList";
            }
        }
        ...
        {
           AjaxPro.Utility.RegisterTypeForAjax(typeof(ProcessingBookingList),Page);
        }
        ...
        public override AjaxOut Draw(SiteParam OSiteParam, RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                RetAjaxOut.HtmlContent =
                    ...
                    "       AjaxOut = OneTSQ.WebParts.ProcessingBookingList.ServerSiteUpdate(RenderInfo, BookingId).value;\r\n" +
                    "       if(AjaxOut.Error)\r\n"+
                    "       {\r\n"+
                    ...
                    "           AjaxOut = OneTSQ.WebParts.ProcessingBookingList.ServerSideDelete(RenderInfo, BookingId).value;\r\n" +
                    "           if(AjaxOut.Error)\r\n" +
                    "           {\r\n" +
                    "               callSweetAlert(AjaxOut.InfoMessage);\r\n" +
                    "               return;\r\n" +
                    ...
                    "       OneTSQ.WebParts.ProcessingBookingList.ServerSideDrawSearchResult(RenderInfo, Keyword, CallBackReading);\r\n" +
                    "   }\r\n" +
                    ...
                    "       document.getElementById('divProcessingBookingListContent').innerHTML=AjaxOut.HtmlContent;\r\n" +
                    "   }\r\n" +
                    ...
                    WebEnvironments.EncryptHtml(
                        ...
                        "         <h5>" + WebLanguage.GetLanguage(OSiteParam, "Booking đang mở") + " </h5> \r\n" +
                        "     </div> \r\n" +
                        ...
                        "                 <div>\r\n" +
                        "                       <button onclick=\"javascript:CallReading();\" type=\"button\" class=\"btn btn-sm btn-primary mr-5px\"> " + WebLanguage.GetLanguage(OSiteParam, "Lọc Booking đang mở") + "</button>\r\n" +
                        "                 </div> \r\n" +
                        "             </div> \r\n" +
                        "         </div> \r\n" +
                        "         <div id=\"divProcessing\" class=\"processing\"></div>\r\n"+
                        "               <div id=\"divProcessingBookingListContent\">"+  ServerSideDrawSearchResult(ORenderInfo,"").HtmlContent +"</div>\r\n"+
                        "         </div> \r\n" +
                        "     </div> \r\n" +
                        " </div> \r\n" +
        ...
        public static AjaxOut ServerSideDrawSearchResult(RenderInfoCls ORenderInfo,string Keyword)
        {
            ...
            try
            {
                ...
                OBookingFilter.BookingStatusId = "open";
