...
{
    public class ProcessingQuotationList : WebPartTemplate
    {
        public override string WebPartId
        {
            get
            {
                return "ProcessingQuotationList";
            }
        }
        ...
        {
           AjaxPro.Utility.RegisterTypeForAjax(typeof(ProcessingQuotationList),Page);
        }
        ...
        public override AjaxOut Draw(SiteParam OSiteParam, RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                RetAjaxOut.HtmlContent =
                    ...
                    "       AjaxOut = OneTSQ.WebParts.ProcessingQuotationList.ServerSiteUpdate(RenderInfo, QuotationId).value;\r\n" +
                    "       if(AjaxOut.Error)\r\n"+
                    "       {\r\n"+
                    ...
                    "           AjaxOut = OneTSQ.WebParts.ProcessingQuotationList.ServerSideDelete(RenderInfo, QuotationId).value;\r\n" +
                    "           if(AjaxOut.Error)\r\n" +
                    "           {\r\n" +
                    "               callSweetAlert(AjaxOut.InfoMessage);\r\n" +
                    "               return;\r\n" +
                    ...
                    "       OneTSQ.WebParts.ProcessingQuotationList.ServerSideDrawSearchResult(RenderInfo, Keyword, CallBackReading);\r\n" +
                    "   }\r\n" +
                    ...
                    "       document.getElementById('divProcessingQuotationListContent').innerHTML=AjaxOut.HtmlContent;\r\n" +
                    "   }\r\n" +
                    ...
                    WebEnvironments.EncryptHtml(
                        ...
                        "                 <div>\r\n" +
                        "                       <button onclick=\"javascript:CallReading();\" type=\"button\" class=\"btn btn-sm btn-primary mr-5px\"> " + WebLanguage.GetLanguage(OSiteParam, "Lọc chào giá đang mở") + "</button>\r\n" +
                        "                 </div> \r\n" +
                        "             </div> \r\n" +
                        "         </div> \r\n" +
                        "         <div id=\"divProcessing\" class=\"processing\"></div>\r\n"+
                        "               <div id=\"divProcessingQuotationListContent\">"+  ServerSideDrawSearchResult(ORenderInfo,"").HtmlContent +"</div>\r\n"+
                        "         </div> \r\n" +
                        "     </div> \r\n" +
                        " </div> \r\n" +
        ...
        public static AjaxOut ServerSideDrawSearchResult(RenderInfoCls ORenderInfo,string Keyword)
        {
            ...
            try
            {
                ...
                OQuotationFilter.QuotationStatusId = "open";
