...
{
    public class Country : WebPartTemplate
    {
        ...
        {
           AjaxPro.Utility.RegisterTypeForAjax(typeof(Country),Page);
        }
        ...
        public override AjaxOut Draw(SiteParam OSiteParam, RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                RetAjaxOut.HtmlContent =
                    ...
                    "       AjaxOut = OnlineTour.WebParts.Country.ServerSideDrawAddForm(RenderInfo).value;\r\n" +
                    ...
                    "   function CallUpdateForm(CountryId)\r\n" +
                    "   {\r\n" +
                    "       RenderInfo=CreateRenderInfo();\r\n" +
                    "       AjaxOut = OnlineTour.WebParts.Country.ServerSideDrawUpdateForm(RenderInfo, CountryId).value;\r\n" +
                    "       document.getElementById('divActionForm').innerHTML=AjaxOut.HtmlContent;\r\n" +
                    "       document.getElementById('divActionForm').style.display='block';\r\n" +
                    "       document.getElementById('divListForm').style.display='none';\r\n" +
                    "       document.getElementById('txtCountryName').focus();\r\n" +
                    ...
                    "   {\r\n" +
                    "       RenderInfo=CreateRenderInfo();\r\n" +
                    "       CountryName = document.getElementById('txtCountryName').value;\r\n" +
                    "       SortIndex = document.getElementById('txtSortIndex').value;\r\n" +
                    "       Active = parseInt(document.getElementById('drpSelectActive').value,10);\r\n" +
                    "       AjaxOut = OnlineTour.WebParts.Country.ServerSideAdd(RenderInfo, CountryName, SortIndex, Active).value;\r\n" +
                    "       if(AjaxOut.Error)\r\n"+
                    "       {\r\n"+
                    ...
                    "   function CallActionUpdate(CountryId)\r\n" +
                    "   {\r\n" +
                    "       RenderInfo=CreateRenderInfo();\r\n" +
                    "       CountryName = document.getElementById('txtCountryName').value;\r\n" +
                    "       SortIndex = document.getElementById('txtSortIndex').value;\r\n" +
                    "       Active = parseInt(document.getElementById('drpSelectActive').value,10);\r\n" +
                    "       AjaxOut = OnlineTour.WebParts.Country.ServerSideUpdate(RenderInfo, CountryId, CountryName, SortIndex, Active).value;\r\n" +
                    "       if(AjaxOut.Error)\r\n" +
                    "       {\r\n" +
                    "           callSweetAlert(AjaxOut.InfoMessage);\r\n" +
                    "           return;\r\n" +
                    ...
                    "   function CallActionDelete(CountryId)\r\n" +
                    "   {\r\n" +
                    "       RenderInfo=CreateRenderInfo();\r\n" +

                    "       swal({ \r\n"+
                    "               title: \"" + WebLanguage.GetLanguageConfirmDelete(OSiteParam) + "\", \r\n" +
                    "               text: \""+WebLanguage.GetLanguage(OSiteParam,"Đang thực hiện xóa quốc gia này ra khỏi hệ thống")+"!\", \r\n"+
                    "               type: \"warning\", \r\n"+
                    ...
                    "           AjaxOut = OnlineTour.WebParts.Country.ServerSideDelete(RenderInfo, CountryId).value;\r\n" +
                    "           if(AjaxOut.Error)\r\n" +
                    "           {\r\n" +
                    "               callSweetAlert(AjaxOut.InfoMessage);\r\n" +
                    "               return;\r\n" +
                    ...
                    "           swal(\""+WebLanguage.GetLanguage(OSiteParam,"Đã xóa")+"!\", \""+WebLanguage.GetLanguage(OSiteParam,"quốc gia đã được xóa thành công!")+".\", \"success\"); \r\n"+
                    "       }); \r\n" +
                    ...
                    "       OnlineTour.WebParts.Country.ServerSideDrawSearchResult(RenderInfo, Keyword, CallBackReading);\r\n" +
                    "   }\r\n" +
                    ...
                    "       document.getElementById('divCountryContent').innerHTML=AjaxOut.HtmlContent;\r\n" +
                    "   }\r\n" +
                    ...
                    WebEnvironments.EncryptHtml(
                        ...
                        "               <div id=\"divCountryContent\">"+  ServerSideDrawSearchResult(ORenderInfo,"").HtmlContent +"</div>\r\n"+
                        "         </div> \r\n" +
                        "     </div> \r\n" +
                        " </div> \r\n" +
        ...
        public static AjaxOut ServerSideDrawSearchResult(RenderInfoCls ORenderInfo,string Keyword)
        {
            ...
            try
            {
                ...
                OCountryFilter.Keyword = Keyword;

                string OwnerCode=WebSessionUtility.GetCurrentLoginUser(OSiteParam).OwnerCode;
                CountryCls[] 
                    Coutries = OnlineTourBussinessUtility.CreateBussinessProcess().CreateCountryProcess().Reading(OActionSqlParam, OCountryFilter);
                string Html = "";
                ...
                else
                {
                    Html +=
                        ...
                        "                     <th>" + WebLanguage.GetLanguage(OSiteParam, "Tên quốc gia") + " </th> \r\n" +
                    ...
                    for (int iIndex = 0; iIndex < Coutries.Length; iIndex++)
                    {
                        string CityUrl = WebScreen.BuildUrl(OwnerCode, new City().WebPartId,
                            new WebParamCls[]
                            {
                                new WebParamCls("CountryId",Coutries[iIndex].CountryId)
                            });
                        Html +=
                            "                 <tr> \r\n" +
                            "                     <td class=\"td-right\">" + (iIndex + 1).ToString("#,##0") + "</td> \r\n" +
                            "                     <td>" + Coutries[iIndex].CountryName + "</td> \r\n" +
                            ...
                            "                     <td class=\"td-center\"><a title=\"" + WebLanguage.GetLanguage(OSiteParam, "Sửa quốc gia") + "\" href=\"javascript:CallUpdateForm('" + Coutries[iIndex].CountryId + "');\"><i class=\""+WebScreen.GetEditGridIcon()+"\"></i></a></td> \r\n" +
                            "                     <td class=\"td-center\"><a title=\"" + WebLanguage.GetLanguage(OSiteParam, "Xóa quốc gia") + "\" href=\"javascript:CallActionDelete('" + Coutries[iIndex].CountryId + "');\"><i class=\""+WebScreen.GetDeleteGridIcon()+"\"></i></a></td> \r\n" +
            ...
            try
            {
                ...
                string Html =
                    ...
                    "         <div class=\"col-sm-12\"><h3 class=\"m-t-none m-b\">" + WebLanguage.GetLanguage(OSiteParam, "Thêm mới") + "</h3> \r\n" +
                       "             <div> \r\n" +
                       "                 <div class=\"form-group\"><label>" + WebLanguage.GetLanguage(OSiteParam, "Tên quốc gia") + "</label> <input id=\"txtCountryName\" type=\"textbox\" placeholder=\"" + WebLanguage.GetLanguage(OSiteParam, "Nhập tên quốc gia") + "\" class=\"form-control\"></div> \r\n" +
        ...
        [AjaxPro.AjaxMethod(AjaxPro.HttpSessionStateRequirement.ReadWrite)]
        public static AjaxOut ServerSideDrawUpdateForm(RenderInfoCls ORenderInfo, string CountryId)
        {
            AjaxOut RetAjaxOut = new AjaxOut();
            try
            {
                ...
                CountryCls
                    OCountry = OnlineTourBussinessUtility.CreateBussinessProcess().CreateCountryProcess().CreateModel(OActionSqlParam, CountryId);
                if (OCountry == null)
                {
                    throw new Exception(WebLanguage.GetLanguage(OSiteParam, "quốc gia đã bị xóa hoặc không tìm thấy"));
                }
                string SelectActiveText =
                 "<select id=\"drpSelectActive\" class=\"form-control\">\r\n" +
                 "   <option value=\"0\">" + WebLanguage.GetLanguage(OSiteParam, "Không sử dụng") + "</option>\r\n" +
                ...
                string Html =
                       ...
                       "             <div> \r\n" +
                       "                 <div class=\"form-group\"><label>" + WebLanguage.GetLanguage(OSiteParam, "Tên quốc gia") + "</label> <input id=\"txtCountryName\" value=\"" + OCountry.CountryName + "\" type=\"textbox\" placeholder=\"" + WebLanguage.GetLanguage(OSiteParam, "Nhập tên quốc gia") + "\" class=\"form-control\"></div> \r\n" +
                       "                 <div class=\"form-group\"><label>" + WebLanguage.GetLanguage(OSiteParam, "Thứ tự sắp xếp") + "</label> <input id=\"txtSortIndex\" value=\"" + OCountry.SortIndex + "\" type=\"textbox\" placeholder=\"" + WebLanguage.GetLanguage(OSiteParam, "Thứ tự sắp xếp") + "\" class=\"form-control\"></div> \r\n" +
                       "                 <div class=\"form-group\"><label>" + WebLanguage.GetLanguage(OSiteParam, "Trạng thái") + "</label> " + SelectActiveText + "</div> \r\n" +
                       "                 <div> \r\n" +
                       "                     <button class=\"btn btn-sm btn-primary m-t-n-xs mr-5px\" type=\"button\" onclick=\"javascript:CallActionUpdate('" + CountryId + "');\"><strong>" + WebLanguage.GetLanguage(OSiteParam, "Chấp nhận") + "</strong></button> \r\n" +
                       "                     <button class=\"btn btn-sm btn-primary m-t-n-xs\" type=\"button\" onclick=\"javascript:CallBack();\"><strong>" + WebLanguage.GetLanguage(OSiteParam, "Bỏ qua") + "</strong></button> \r\n" +
                       "                 </div> \r\n" +
                       "             </div> \r\n" +
                       "         </div> \r\n" +
            ...
            int Active)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(CountryName)) throw new Exception(WebLanguage.GetLanguage(OSiteParam, "Tên quốc gia không hợp lệ"));
                ...
                OCountry.CountryName = CountryName;
                OCountry.SortIndex = int.Parse(SortIndex);
                OCountry.Active = Active;

                OnlineTourBussinessUtility.CreateBussinessProcess().CreateCountryProcess().Add(OActionSqlParam, OCountry);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
            ...
            int    Active)
        {
            ...
            try
            {
                ...
                OCountry.SortIndex = int.Parse(SortIndex);
                OCountry.Active = Active;
                OnlineTourBussinessUtility.CreateBussinessProcess().CreateCountryProcess().Save(OActionSqlParam, CountryId, OCountry);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
            ...
            string CountryId)
        {
            ...
            try
            {
                ...
                OnlineTourBussinessUtility.CreateBussinessProcess().CreateCountryProcess().Delete(OActionSqlParam, CountryId);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
