...
namespace OneTSQ.Bussiness.Sql
{
    public class DT_HocVienProcessBll : DT_HocVienTemplate
    {
        ...
        public override DT_HocVienCls[] Reading( ActionSqlParamCls ActionSqlParam, DT_HocVienFilterCls ODT_HocVienFilter)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(ODT_HocVienFilter.KhoaHocDangKy_Id) || !string.IsNullOrEmpty(ODT_HocVienFilter.KhoaHocDuyet_Id))
                    Query = " select DT_HocVien.* from DT_HocVien join DT_KETQUADAOTAO on DT_HocVien.ID = DT_KETQUADAOTAO.HOCVIEN_ID where DT_KETQUADAOTAO.DATTIEUCHUAN = 1 ";
