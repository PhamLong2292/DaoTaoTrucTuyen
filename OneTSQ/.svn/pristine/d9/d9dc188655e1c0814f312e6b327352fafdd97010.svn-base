...
namespace OneTSQ.Call.Bussiness.Sql
{
    public class DM_ChuyenKhoaDaoTaoTtProcessBll : DM_ChuyenKhoaDaoTaoTtTemplate
    {
        ...
        public override DM_ChuyenKhoaDaoTaoTtCls[] Reading(
            RenderInfoCls ORenderInfo,
            DM_ChuyenKhoaDaoTaoTtFilterCls OChuyenKhoaDaoTaoTtFilter)
        {
            ActionSqlParamCls
        ...
        public override DM_ChuyenKhoaDaoTaoTtCls[] ReadingWithPaging(
            RenderInfoCls ORenderInfo,
            DM_ChuyenKhoaDaoTaoTtFilterCls OChuyenKhoaDaoTaoTtFilter)
        {
            ActionSqlParamCls
        ...
        public override DM_ChuyenKhoaDaoTaoTtCls CheckCode(RenderInfoCls ORenderInfo, string MaChuyenKhoaDaoTaoTt)
        {
            ActionSqlParamCls ActionSqlParam = WebEnvironments.CreateActionSqlParam(ORenderInfo);
            return OneTSQBussinessUtility.CreateBussinessProcess().CreateChuyenKhoaDaoTaoTtProcess().CheckCode(ActionSqlParam, MaChuyenKhoaDaoTaoTt);
        }
    }
}
