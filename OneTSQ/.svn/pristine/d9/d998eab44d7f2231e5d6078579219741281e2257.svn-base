...
{
    public class ClosedBookingList : WebPartTemplate
    {
        public override string WebPartId
        {
            get
            {
                return "ClosedBookingList";
            }
        }
        ...
        {
           AjaxPro.Utility.RegisterTypeForAjax(typeof(ClosedBookingList),Page);
        }
        ...
        public override AjaxOut Draw(SiteParam OSiteParam, RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                RetAjaxOut.HtmlContent =
                    ...
                    "       AjaxOut = OneTSQ.WebParts.ClosedBookingList.ServerSiteUpdate(RenderInfo, BookingId).value;\r\n" +
                    "       if(AjaxOut.Error)\r\n"+
                    "       {\r\n"+
                    ...
                    "           AjaxOut = OneTSQ.WebParts.ClosedBookingList.ServerSideDelete(RenderInfo, BookingId).value;\r\n" +
                    "           if(AjaxOut.Error)\r\n" +
                    "           {\r\n" +
                    "               callSweetAlert(AjaxOut.InfoMessage);\r\n" +
                    "               return;\r\n" +
                    ...
                    "       OneTSQ.WebParts.ClosedBookingList.ServerSideDrawSearchResult(RenderInfo, Keyword, CallBackReading);\r\n" +
                    "   }\r\n" +
                    ...
                    "       document.getElementById('divClosedBookingListContent').innerHTML=AjaxOut.HtmlContent;\r\n" +
                    "   }\r\n" +
                    ...
                    WebEnvironments.EncryptHtml(
                        ...
                        "                 <div>\r\n" +
                        "                       <button onclick=\"javascript:CallReading();\" type=\"button\" class=\"btn btn-sm btn-primary mr-5px\"> " + WebLanguage.GetLanguage(OSiteParam, "Lọc Booking đã đóng") + "</button>\r\n" +
                        "                 </div> \r\n" +
                        "             </div> \r\n" +
                        "         </div> \r\n" +
                        "         <div id=\"divProcessing\" class=\"processing\"></div>\r\n"+
                        "               <div id=\"divClosedBookingListContent\">"+  ServerSideDrawSearchResult(ORenderInfo,"").HtmlContent +"</div>\r\n"+
                        "         </div> \r\n" +
                        "     </div> \r\n" +
                        " </div> \r\n" +
        ...
        public static AjaxOut ServerSideDrawSearchResult(RenderInfoCls ORenderInfo,string Keyword)
        {
            ...
            try
            {
                ...
                OBookingFilter.BookingStatusId = "closed";
