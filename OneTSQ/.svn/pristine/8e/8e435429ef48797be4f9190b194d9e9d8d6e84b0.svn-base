...
<script runat="server">
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        OneTSQ.Core.Model.RenderInfoCls
            ORenderInfo = new OneTSQ.Core.Model.RenderInfoCls();
        ...
        OneTSQ.Core.Model.AjaxOut
            AjaxOutAutoLogin = OneTSQ.Core.Call.Bussiness.Utility.CoreCallBussinessUtility.AutoLogin(ORenderInfo, id);
