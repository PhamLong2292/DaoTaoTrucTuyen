...
<script runat="server">
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ORenderInfo.OwnerUserId = OneTSQ.Utility.WebEnvironments.GetOwnerUserId(ORenderInfo);
        ...
        OneTSQ.Core.Model.AjaxOut OAjaxOut = WebScreenRender.DrawContentPage(ORenderInfo,this);
        placeHolderContent.Controls.Clear();

        OneTSQ.Core.Model.AjaxOut OAjaxOutCss = WebScreenRender.PlugInCss(ORenderInfo);
        OneTSQ.Core.Model.AjaxOut OAjaxOutJavascript = WebScreenRender.PlugJavascript(ORenderInfo);
...
<body>
   ...
   <script src="../../../../themes/js/plugins/switchery/switchery.js"></script>
    ...
    <script type="text/javascript" src="../../../../javascript/onetsq.js"></script>
    <script>
        toastr.options = {
