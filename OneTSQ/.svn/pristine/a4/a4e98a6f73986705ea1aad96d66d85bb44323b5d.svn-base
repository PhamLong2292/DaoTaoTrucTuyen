...
{
    public class DM_TenKhoaHoc : WebPartTemplate
    {
        public override string WebPartId
        {
            get
            {
                return "DM_TenKhoaHoc";
            }
        }
        ...
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(DM_TenKhoaHoc), Page);
        }
        ...
        public override AjaxOut Draw(SiteParam OSiteParam, RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                XemPermission = user.IsSystemAdmin == 1 || PermissionUtility.CheckPermission(ORenderInfo, new DM_TenKhoaHocPermission().PermissionFunctionCode,
                    DM_TenKhoaHocCls.ePermission.Xem.ToString(), new DM_TenKhoaHocPermission().PermissionFunctionCode,
                    DM_TenKhoaHocPermission.StaticPermissionFunctionId, userId, null, false);
                if (!XemPermission)
                {
                ...
                string filtemplate = WebConfig.GetWebHttpRoot() + "/temp/ImportDM_TENKHOAHOC.xlsx";
                RetAjaxOut.HtmlContent =
                      WebEnvironments.ProcessHtml(
                        ...
                        "         <h5>" + WebLanguage.GetLanguage(OSiteParam, "Tên khóa học") + "</h5> \r\n" +
                        "     </div> \r\n" +
                        ...
                        "         <div id=\"divDM_TenKhoaHocContent\">" + ServerSideDrawSearchResult(ORenderInfo, "", null, 0).HtmlContent + "</div>\r\n" +
                        "     </div> \r\n" +
                      ...
                      WebEnvironments.ProcessJavascript(
                        ...
                        "           allowClear: true\r\n" +
                        "       });\r\n" +
                        "       CallInitSelect2('cbbNhom', '" + WebEnvironments.GetRemoteProcessDataUrl(DM_NhomKhoaHocService.StaticServiceId) + "', '" + WebLanguage.GetLanguage(OSiteParam, "Nhóm khóa học") + "');\r\n" +
                        "    });\r\n" +

                        "   function CallExPortForm()\r\n" +
                        "   {\r\n" +
                        "       RenderInfo=CreateRenderInfo();\r\n" +
                        "       AjaxOut  = OneTSQ.WebParts.DM_TenKhoaHoc.ServerSidePrint(CreateRenderInfo()).value;\r\n" +
                        "       if(AjaxOut.Error)\r\n" +
                        "       {\r\n" +
                        ...
                        "       OneTSQ.WebParts.DM_TenKhoaHoc.ServerSideDrawSearchResult(CreateRenderInfo(), Keyword, HieuLuc, _currentPageIndex, CallBackReading);\r\n" +
                        "   }\r\n" +

                        "   function CallBackReading(res)\r\n" +
                        "   {\r\n" +
                        "       document.getElementById('divProcessing').innerHTML='';\r\n" +
                        "       document.getElementById('divDM_TenKhoaHocContent').innerHTML = res.value.HtmlContent;\r\n" +
                        "       $('.confirm').focus(); " +
                        "   }\r\n" +
                        ...
                        "   {\r\n" +
                        "       AjaxOut = OneTSQ.WebParts.DM_TenKhoaHoc.ServerSideDrawAddForm(CreateRenderInfo()).value;\r\n" +
                        "       if(AjaxOut.Error) { \r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "           return;\r\n" +
                        "       }\r\n" +
                        "       document.getElementById('ModalTitle').innerHTML = '<span class=\"fa fa-pencil-square-o\">" + WebLanguage.GetLanguage(OSiteParam, " Thêm mới Tên khóa học") + " </span>';\r\n" +
                        ...
                        "   {\r\n" +
                        "       AjaxOut = OneTSQ.WebParts.DM_TenKhoaHoc.ServerSideDrawUpdateForm(CreateRenderInfo(), Id).value;\r\n" +
                        "       if(AjaxOut.Error) { \r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "           return;\r\n" +
                        "       }\r\n" +
                        ...
                        "       nhomKhoaHoc = document.getElementById('cbbNhom').value;\r\n" +
                        ...
                        "       AjaxOut = OneTSQ.WebParts.DM_TenKhoaHoc.ServerSideAdd(CreateRenderInfo(), Ma, Ten, nhomKhoaHoc, Stt, MoTa, HieuLuc).value;\r\n" +
                        "       if(AjaxOut.Error) {\r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "           return;\r\n" +
                        "       }\r\n" +
                        "       callSweetAlert(\"" + WebLanguage.GetLanguage(OSiteParam, "Thêm mới Tên khóa học thành công!") + "\");\r\n" +
                        ...
                        "       AjaxOut = OneTSQ.WebParts.DM_TenKhoaHoc.ServerSideUpdate(CreateRenderInfo(), Id, Ma, Ten, nhomKhoaHoc, Stt, MoTa, HieuLuc).value;\r\n" +
                        "       if(AjaxOut.Error) {\r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "           return;\r\n" +
                        "       }\r\n" +
                        "       callSweetAlert(\"" + WebLanguage.GetLanguage(OSiteParam, "Sửa thông tin Tên khóa học thành công!") + "\");\r\n" +
                        "       NextPage(_currentPageIndex);\r\n" +
                        "       CloseModal();\r\n" +
                        "   }\r\n" +
                        ...
                        "           }, function () { \r\n" +
                        "           AjaxOut = OneTSQ.WebParts.DM_TenKhoaHoc.ServerSideDelete(RenderInfo, id).value;\r\n" +
                        "           if(AjaxOut.Error) { \r\n" +
                        "           callGallAlert(AjaxOut.InfoMessage);\r\n" +
                        "               return;\r\n" +
                        "           }\r\n" +
                        "       callSweetAlert(\"" + WebLanguage.GetLanguage(OSiteParam, "Xóa thông tin Tên khóa học thành công") + "!\");\r\n" +
                        "       NextPage(_currentPageIndex);\r\n" +
                        "       }); \r\n" +
                        "   }\r\n" +
                    ...
                    #region Import
                        ...
                        "               xhr.open(\"POST\", \"" + WebConfig.GetImportHandler(OSiteParam, SessionId, userId, LoginName, (int)ProcessImportHandlerUtility.eFileType.DM_TENKHOAHOC) + "\");\r\n" +
                        "               xhr.send(fd);\r\n" +
                        "           }\r\n" +
                        "       ); \r\n" +
                        "   }\r\n" +
        ...
        public static AjaxOut ServerSideDrawSearchResult(RenderInfoCls ORenderInfo, string Keyword, string HieuLuc, int currentPageIndex)
        {
            ...
            try
            {
                ...
                DM_TenKhoaHocFilterCls OPositionFilter = new DM_TenKhoaHocFilterCls()
                {
                    Keyword = Keyword,
                ...
                DM_TenKhoaHocCls[] Positions = CallBussinessUtility.CreateBussinessProcess().CreateDM_TenKhoaHocProcess().ReadingWithPaging(ORenderInfo, OPositionFilter);
                var countPosition = CallBussinessUtility.CreateBussinessProcess().CreateDM_TenKhoaHocProcess().Count(ORenderInfo, OPositionFilter);
                ...
                if (Positions.Length == 0)
                {
                    Html.Append("   <div class=\"search-result-info\"></div>\r\n" +
                     ...
                     "                     <th> " + WebLanguage.GetLanguage(OSiteParam, "Nhóm") + "</th> \r\n" +
                ...
                else
                {
                    ...
                    {
                        DM_NhomKhoaHocCls nhomKhoaHoc = CallBussinessUtility.CreateBussinessProcess().CreateDM_NhomKhoaHocProcess().CreateModel(ORenderInfo, Positions[iIndex].NhomKhoaHoc_Ma);
                        Html.Append(
                            "                 <tr> \r\n" +
                            ...
                            "                     <td title=\"" + (nhomKhoaHoc == null ? Positions[iIndex].NhomKhoaHoc_Ma : nhomKhoaHoc.Ten) + "\">" + (nhomKhoaHoc == null ? Positions[iIndex].NhomKhoaHoc_Ma : nhomKhoaHoc.Ten) + "</td> \r\n" +
                            ...
                            "                     <td class=\"td-center\" style=\"text-align:center;\"><a title=\"" + "" + WebLanguage.GetLanguage(OSiteParam, "Sửa Tên khóa học") + "" + "\" href=\"javascript:ServerSideDrawUpdateForm('" + Positions[iIndex].Id + "');\"><i class=\"" + WebScreen.GetEditGridIcon() + "\"></i></a> &nbsp; <a title=\"" + "Xóa Tên khóa học" + "\" href=\"javascript:ServerSideDelete('" + Positions[iIndex].Id + "');\"><i class=\"" + WebScreen.GetDeleteGridIcon() + "\"></i></a></td> \r\n" +
                            //"                     <td class=\"td-center\"><a title=\"" + "Xóa Tên khóa học" + "\" href=\"javascript:ServerSideDelete('" + Positions[iIndex].Id + "');\"><i class=\"" + WebScreen.GetDeleteGridIcon() + "\"></i></a></td> \r\n" +
                            "                 </tr> \r\n");
                    }
                    Html.Append(
                        "                 </tbody> \r\n" +
        ...
        public static AjaxOut ServerSideDrawAddForm(RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                string Html =
                        ...
                        "           <div class=\"col-xs-12 col-sm-12 col-md-12\">\r\n" +
                        "               <div class=\"form-group\">\r\n" +
                        "                   <label>" + WebLanguage.GetLanguage(OSiteParam, "Nhóm") + " <span style='color:red'>*</span></label><br>\r\n" +
                        "                   <select class='form-control' id='cbbNhom' title = '" + WebLanguage.GetLanguage(OSiteParam, "Nhóm") + "' required></select>\r\n" +
                        "               </div>\r\n" +
                        "           </div>\r\n" +
                        ...
                        "               <button class=\"btn btn-sm btn-primary mr-5px\"  type=\"submit\"><strong>" + WebLanguage.GetLanguage(OSiteParam, "Chấp nhận") + "</strong></button> \r\n" +
        ...
        public static AjaxOut ServerSideDrawUpdateForm(RenderInfoCls ORenderInfo, string Id)
        {
            ...
            try
            {
                ...
                var OPosition = CallBussinessUtility.CreateBussinessProcess().CreateDM_TenKhoaHocProcess().CreateModel(ORenderInfo, Id);
                if (OPosition == null) throw new Exception(WebLanguage.GetLanguage(OSiteParam, "Tên khóa học đã bị xóa hoặc không tìm thấy"));
                string cbbNhom = "<select class='form-control' id='cbbNhom' required>\r\n";
                DM_NhomKhoaHocCls nhomKhoaHoc = CallBussinessUtility.CreateBussinessProcess().CreateDM_NhomKhoaHocProcess().CreateModel(ORenderInfo, OPosition.NhomKhoaHoc_Ma);
                if (nhomKhoaHoc != null)
                    cbbNhom += string.Format(" <option value='{0}' selected>{0} - {1}</option>\r\n", nhomKhoaHoc.Ma, nhomKhoaHoc.Ten);
                else cbbNhom += string.Format(" <option value='{0}' selected>{0} - {1}</option>\r\n", OPosition.NhomKhoaHoc_Ma, "N/A");
                cbbNhom += "</select>\r\n";

                string Html =
                     "<form id=\"sendmail\" data-async  method=\"post\" onSubmit=\"javascript:ServerSideUpdate('" + Id + "'); return false;\" role=\"form\" class=\"contactForm\">\r\n" +
        ...
        #region action
        [AjaxPro.AjaxMethod(AjaxPro.HttpSessionStateRequirement.ReadWrite)]
        public static AjaxOut ServerSideAdd(RenderInfoCls ORenderInfo, string Ma, string Ten, string nhomKhoaHoc, int Stt, string MoTa, string HieuLuc)
        {
            AjaxOut RetAjaxOut = new AjaxOut();
            try
            {
                SiteParam OSiteParam = WebEnvironments.CreateSiteParam(ORenderInfo);
                WebSession.CheckSessionTimeOut(ORenderInfo);
                if (CallBussinessUtility.CreateBussinessProcess().CreateDM_TenKhoaHocProcess().CheckCode(ORenderInfo, Ma) != null)
                {
                    RetAjaxOut.Error = true;
                    RetAjaxOut.InfoMessage = WebLanguage.GetLanguage(OSiteParam, "Mã khóa học đã tồn tại. Xin nhập mã khác.");
                    return RetAjaxOut;
                }

                DM_TenKhoaHocCls OPosition = new DM_TenKhoaHocCls();
                OPosition.Id = Guid.NewGuid().ToString();
                OPosition.Ma = Ma;
                OPosition.Ten = Ten;
                OPosition.NhomKhoaHoc_Ma = nhomKhoaHoc;
                OPosition.MoTa = MoTa;
                ...
                else OPosition.DenNgay = DateTime.Now;
                CallBussinessUtility.CreateBussinessProcess().CreateDM_TenKhoaHocProcess().Add(ORenderInfo, OPosition);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
        ...
        [AjaxPro.AjaxMethod(AjaxPro.HttpSessionStateRequirement.ReadWrite)]
        public static AjaxOut ServerSideUpdate(RenderInfoCls ORenderInfo, string Id, string Ma, string Ten, string nhomKhoaHoc, int Stt, string MoTa, string HieuLuc)
        {
            AjaxOut RetAjaxOut = new AjaxOut();
            try
            {
                ...
                var OPositionOld = CallBussinessUtility.CreateBussinessProcess().CreateDM_TenKhoaHocProcess().CreateModel(ORenderInfo, Id);
                if (OPositionOld == null)
                {
                    RetAjaxOut.Error = true;
                    RetAjaxOut.InfoMessage = WebLanguage.GetLanguage(OSiteParam, "Tên khóa học đã bị xóa hoặc không tìm thấy");
                    return RetAjaxOut;
                }
                DM_TenKhoaHocCls dm_TenKhoaHoc = CallBussinessUtility.CreateBussinessProcess().CreateDM_TenKhoaHocProcess().CheckCode(ORenderInfo, Ma);
                if (dm_TenKhoaHoc != null && dm_TenKhoaHoc.Id != Id)
                {
                    RetAjaxOut.Error = true;
                    RetAjaxOut.InfoMessage = WebLanguage.GetLanguage(OSiteParam, "Mã khóa học đã tồn tại. Xin nhập mã khác.");
                    return RetAjaxOut;
                ...
                DM_TenKhoaHocCls OPositionNew = new DM_TenKhoaHocCls();
                OPositionNew.Ma = Ma;
                OPositionNew.Ten = Ten;
                OPositionNew.NhomKhoaHoc_Ma = nhomKhoaHoc;
                ...
                if (OPositionOld.HieuLuc == (int)eHieuLuc.Co && int.Parse(HieuLuc) == (int)eHieuLuc.Khong)
                {
                    OPositionNew.DenNgay = DateTime.Now;
                }
                OPositionNew.GhiChu = OPositionOld.GhiChu;
                OPositionNew.ChaId = OPositionOld.ChaId;
                CallBussinessUtility.CreateBussinessProcess().CreateDM_TenKhoaHocProcess().Save(ORenderInfo, Id, OPositionNew);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
        ...
        public static AjaxOut ServerSideDelete(RenderInfoCls ORenderInfo, string Id)
        {
            ...
            try
            {
                SiteParam OSiteParam = WebEnvironments.CreateSiteParam(ORenderInfo);
                WebSession.CheckSessionTimeOut(ORenderInfo);
                CallBussinessUtility.CreateBussinessProcess().CreateDM_TenKhoaHocProcess().Delete(ORenderInfo, Id);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
        ...
        public static string ConditionGhiChu(DM_TenKhoaHocCls OPosition, string Ma, string Ten, int Stt, int HieuLuc, ref int ConditionAdd)
        {
        ...
        public static AjaxOut ServerSidePrint(RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                List<DM_TenKhoaHocView> Datas = new List<DM_TenKhoaHocView>();

                SiteParam
                      OSiteParam = WebEnvironments.CreateSiteParam(ORenderInfo);
                WebSession.CheckSessionTimeOut(ORenderInfo);

                DM_TenKhoaHocFilterCls ODM_TenKhoaHoc = new DM_TenKhoaHocFilterCls() { HieuLuc = (int)eSearch.SearchAll };
                DM_TenKhoaHocCls[] DM_TenKhoaHocs = CallBussinessUtility.CreateBussinessProcess().CreateDM_TenKhoaHocProcess().Reading(ORenderInfo, ODM_TenKhoaHoc);

                for (int i = 0; i < DM_TenKhoaHocs.Length; i++)
                {
                    DM_NhomKhoaHocCls nhomKhoaHoc = CallBussinessUtility.CreateBussinessProcess().CreateDM_NhomKhoaHocProcess().CreateModel(ORenderInfo, DM_TenKhoaHocs[i].NhomKhoaHoc_Ma);
                    var view = new DM_TenKhoaHocView();
                    view.Ma = DM_TenKhoaHocs[i].Ma;
                    view.Ten = DM_TenKhoaHocs[i].Ten;
                    view.NhomKhoaHoc = nhomKhoaHoc == null ? DM_TenKhoaHocs[i].NhomKhoaHoc_Ma : nhomKhoaHoc.Ten;
                    view.Stt = DM_TenKhoaHocs[i].Stt;
                    view.MoTa = DM_TenKhoaHocs[i].MoTa;
                    view.HieuLuc = DM_TenKhoaHocs[i].HieuLuc.ToString();
                    view.NgayTao = DM_TenKhoaHocs[i].NgayTao.ToString("dd/MM/yyyy");
                    if (!string.IsNullOrEmpty(DM_TenKhoaHocs[i].TuNgay.ToString()))
                    {
                        view.TuNgay = DM_TenKhoaHocs[i].TuNgay.Value.ToString("dd/MM/yyyy");
                    }
                    if (!string.IsNullOrEmpty(DM_TenKhoaHocs[i].DenNgay.ToString()))
                    {
                        view.DenNgay = DM_TenKhoaHocs[i].DenNgay.Value.ToString("dd/MM/yyyy");
                    }
                    view.GhiChu = DM_TenKhoaHocs[i].GhiChu;

                    Datas.Add(view);
                }
                flexCelReport.AddTable("TenKhoaHoc", Datas);

                //flexCelReport.SetValue("NgayLap", DateTime.Now);

                string XmlFile = OSiteParam.PathRoot + "\\ReportTemplates\\DM_TenKhoaHoc.xlsx";

                string Id = "DM_TenKhoaHoc_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xlsx";
                string LoginName = WebSessionUtility.GetCurrentLoginUser(OSiteParam).LoginName;
                ...
                RetAjaxOut = new OneTSQ.ReportUtility.FlexcelReportUtility().ExportEx(ORenderInfo, LoginName, XmlFile, "DM_TenKhoaHoc", flexCelReport, SaveFile);
            }
            catch (Exception ex)
            {
                RetAjaxOut.Error = true;
        ...
        public sealed class DM_TenKhoaHocView
        {
            public string Ma { get; set; }
            public string Ten { get; set; }
            public string NhomKhoaHoc { get; set; }
